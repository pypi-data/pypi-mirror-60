...
def usage():
    ...
    print("  ./atenc.py -e -f logo.png -t logo.png.aoe")
    print("2. decrypt logo.png.aoe to logo.png.aoe.png")
    print("  ./atenc.py -d -f logo.png.aoe -t logo.png.aoe.png")
    print("Options:")
...
def args_analysis():
    ...
    if options.__len__() == 0:
        print("Error: No arguments found, please see the help document by \"./atenc.py -h\"")
        sys.exit()
