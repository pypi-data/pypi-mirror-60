...
setup(
    ...
    description='An example package. Geo Distributed LRU (Least Recently Used) cache with',
    long_description='%s\n%s' % (
    ...
    url='https://github.com/pcu4dros/pedro_cuadros_test/python-distributed-lru-cache',
