    ...
    def getDevice(self, id, filter='?embed=timeframes', retry=0):
        ...
        try:
            ...
            if (xMattersAPI.statusCodeSuccess(response.status_code)):
                ...
                self.log.debug(defName + 'Error occured while retrieving Device: ' + id + ' Response: ' + str(response.content))
                jsonStr = None
    ...
    def getDevices(self, filter='?embed=timeframes', retry=0):
        ...
        try:
            ...
            if (xMattersAPI.statusCodeSuccess(response.status_code)):
                ...
                self.log.debug(defName + 'Error occured while retrieving Devices. Response: ' + str(response.content))
                jsonStr = None
        except Exception as e:
            self.log.error(defName + 'Unexpected exception:' + str(e))
            jsonStr = None
    ...
    def createDevice(self, data, retry=0):
        ...
        try:
            ...
            if (xMattersAPI.statusCodeSuccess(response.status_code)):
                ...
                self.log.debug(defName + 'Error occured while creating Device: ' + name + ' Response: ' + str(response.content))
                jsonStr = None
        except Exception as e:
            self.log.error(defName + 'Unexpected exception:' + str(e))
            jsonStr = None
    ...
    def modifyDevice(self, data, retry=0):
        ...
        try:
            ...
            if (xMattersAPI.statusCodeSuccess(response.status_code)):
                ...
                self.log.debug(defName + 'Error occured while Modifying Device: ' + name + ' Response: ' + str(response.content))
                jsonStr = None
        except Exception as e:
    ...
    def removeDevice(self, id, retry=0):
        ...
        try:
            ...
            if (xMattersAPI.statusCodeSuccess(response.status_code)):
                ...
                self.log.debug(defName + 'Error occured while removing Device: ' + id + ' Response: ' + str(response.content))
                jsonStr = None
        except Exception as e:
            self.log.error(defName + 'Unexpected exception:' + str(e))
            jsonStr = None
