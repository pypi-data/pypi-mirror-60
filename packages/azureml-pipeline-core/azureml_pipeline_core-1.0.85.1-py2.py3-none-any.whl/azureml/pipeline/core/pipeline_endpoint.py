...
class PipelineEndpoint(object):
    ...
    def pipeline_version_list(self):
        ...
        :return: The list of :class:`azureml.pipeline.core.pipeline_endpoint.PipelineIdVersion` object.
        :rtype: builtin.list
        """
    ...
    def get_pipeline(self, version=None):
        """
        Get the pipeline of given version or the default; throws an exception if the given version is not found.
    ...
    def list_pipelines(self, active_only=True, _workflow_provider=None, _service_endpoint=None):
        """
        Get a list of pipelines in the PipelineEndpoint.
    ...
    def set_default_version(self, version):
        """
        Set the default version of PipelineEndpoint, throws exception if the specified version is not found.

        :param version: The version to set for default version in PipelineEndpoint.
        :type version: str
        """
        set_flag = False
    ...
    def set_default(self, pipeline):
        """
        Set the default version of PipelineEndpoint, throws exception if the version is not found.
