...
class Parameters:
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("-blp", dest = 'bedgraph_label_position', choices=['left', 'right', 'center', None], default= None )
        ...
        parser.add_argument("--version", "-v", action='version', version='%(prog)s 1.2.17',
