...
class TAS(AppForm):
    ...
    def create_main_frame(self):
        ...
        self.switch_button = QPushButton('&Switch to Single Group')
        ...
        for w in [self.load_data_button,self.switch_button,self.save_button, self.result_button, self.save_predict_button_selected,self.slider_left_label, self.slider,self.slider_right_label]:
        ...
        if ( self.switched== False):
            ...
            self.single_selecter.setFixedWidth(self.width()/10)
        ...
        self.slider_left_label.setFixedWidth(self.width()/10)

        self.slider.setFixedWidth(self.width()/10)

        self.slider_right_label.setFixedWidth(self.width()/10)
        ...
        if (self._changed):
            ...
            for i in range(len(df)):
                ...
                if (self.switched == False):
                    ...
                    if df.at[i, 'Label'] == self.LabelList[b]:
                        self.axes.scatter(df.at[i, 'SiO2'], (df.at[i, 'Na2O'] + df.at[i, 'K2O']),
                                          marker=df.at[i, 'Marker'],
                                          s=df.at[i, 'Size'], color=df.at[i, 'Color'], alpha=df.at[i, 'Alpha'],
                                          label=TmpLabel)
                        # edgecolors='black')

                    self.title='TAS of '+ self.LabelList[b]
