...
The sources for CLT Calculation for Python can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/axelschmidt91/clt_py
.. _tarball: https://github.com/axelschmidt91/clt_py/tarball/master
