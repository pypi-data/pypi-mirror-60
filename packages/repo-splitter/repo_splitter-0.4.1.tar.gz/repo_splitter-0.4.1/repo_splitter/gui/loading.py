...
def loading_gui(func: Callable, message: str, *args, **kwargs):
    ...
    layout = [[sg.Text(message)],
              [sg.Image(data=LINE_BOXES_GIF_BASE64, key='-IMAGE-')],
              [sg.Button('Cancel')] ]
    ...
    while True:
        ...
        # window.Refresh()
        window['-IMAGE-'].update_animation(LINE_BOXES_GIF_BASE64, time_between_frames=150)
