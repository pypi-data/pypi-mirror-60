...
class ExonumMessage:
    ...
    def sign(self, chain_id: int, keys: KeyPair) -> None:
        ...
        sign_stream = SignStream.init()
        sign_stream.update(signed_message.chain_id_bytes)
        sign_stream.update(signed_message.payload)
        signature = sign_stream.finalize(secret_key)
    ...
    def validate(self) -> bool:
        ...
        try:
            ...
            return SignStream.init()\
                .update(signed_msg.chain_id_bytes)\
                .update(signed_msg.payload)\
                .verify(self._signature, self._author)
