...
class ConstError:
    ...
    def to_exception(self) -> HyperException:
        ...
        ex = HyperException(
            ...
            message=self.get_string_field(hapi.HYPER_ERROR_FIELD_MESSAGE) or None,
            hint_message=self.get_string_field(hapi.HYPER_ERROR_FIELD_HINT_MESSAGE) or None)
...
class Error(ConstError):
    ...
    def create(context_id):
        return Error(hapi.hyper_error_create(context_id))
