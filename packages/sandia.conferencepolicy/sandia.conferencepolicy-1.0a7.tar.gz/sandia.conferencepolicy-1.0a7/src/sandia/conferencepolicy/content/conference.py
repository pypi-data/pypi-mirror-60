...
def create_conference_content(conference, event):
    ...
    new_registration_form = api.content.copy(source=template_registration_form, target=conference)
    # make sure it's visible
    behavior_data = IExcludeFromNavigation(new_registration_form)
    if behavior_data:
        behavior_data.exclude_from_nav = False
