...
def search_basic_subjects(
    ...
    """Returns the basic subjects matching the query (PUBLIC)
    :param list domain: Specifies the domain(s) to search in. Can be the name or id (default Current user domain)
    :param list subject: Specifies the id(s) to search in. Can be the name or id 
    :param list customer: Specifies the id(s) to search in. Can be the name or id 
    :param str type: Limit search to one type of subject 
    :param list sortBy: What elements to sort by (default name)
    :param list includeFlags: Flags to include in the search 
    :param list excludeFlags: Flags to exclude from the search 
    :param list permissions: Limit search to users with one of the given permissions 
