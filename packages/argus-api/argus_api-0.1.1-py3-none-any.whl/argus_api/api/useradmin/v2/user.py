...
def add_user(
    ...
    :param bool daemonAccount: Is the user a daemon? (default false)
...
def search_users(
    ...
    :param list subject: Specifies the subject(s) to search for. Can be the name or id 
    :param list customer: Specifies the customer(s) to search in. Can be the name or id 
