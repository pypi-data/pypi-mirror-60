...
def list_n_i_d_s_events(
    ...
    url = "{}/events/v1/nids".format(settings["api"]["api_url"], limit=limit, customerID=customerID, signature=signature, ip=ip, startTimestamp=startTimestamp, endTimestamp=endTimestamp, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
