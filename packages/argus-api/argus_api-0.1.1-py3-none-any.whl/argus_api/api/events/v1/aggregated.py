...
def list_aggregated_events(
    ...
    url = "{}/events/v1/aggregated".format(settings["api"]["api_url"], limit=limit, customerID=customerID, signature=signature, ip=ip, startTimestamp=startTimestamp, endTimestamp=endTimestamp, offset=offset)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
