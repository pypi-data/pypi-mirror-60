...
def update_metric_descriptor(
    ...
    :param int timeFrameSize: Time period in milliseconds used for setting up time frames. For each time frame, deduplicationFunction property is used to determine value(s) of metric record. 
