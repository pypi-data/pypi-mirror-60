...
def get_token(
    ...
    if redirectURI is not None:
        body.update({ "redirectURI": redirectURI })
    # Only send grantType if the argument was provided, dont send null values
    if grantType is not None:
        body.update({ "grantType": grantType })
    # Only send code if the argument was provided, dont send null values
    if code is not None:
        body.update({ "code": code })
    # Only send refreshToken if the argument was provided, dont send null values
    if refreshToken is not None:
        body.update({ "refreshToken": refreshToken })
