...
def constrain_1(
    ...
    :param list customerID: Set of customers the session should be valid for. If not specified, customers will be inherited from active permissions. 
    ...
    # Only send functionID if the argument was provided, dont send null values
