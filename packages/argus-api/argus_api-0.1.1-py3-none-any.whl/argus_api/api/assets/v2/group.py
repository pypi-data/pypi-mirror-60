...
def list_asset_groups(
    ...
    url = "{}/assets/v2/group".format(settings["api"]["api_url"], limit=limit, customer=customer, group=group, keywords=keywords, offset=offset, includeDeleted=includeDeleted, startTimestamp=startTimestamp, endTimestamp=endTimestamp, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def search_asset_groups(
    ...
    :param list group: Restrict the search to these assets' group IDs or short names 
    :param list owner: Restrict the search to these owner IDs or short names 
    :param list parent: Restrict the search to these parent IDs or short names 
    :param list children: Restrict the search to these children IDs or short names 
    :param float minimumTotalCvss: Restrict the search to these groups with at least this CVSS score 
    :param float maximumTotalCvss: Restrict the search to these groups with at most this CVSS score 
