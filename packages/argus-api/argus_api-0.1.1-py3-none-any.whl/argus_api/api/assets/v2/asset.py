...
def list_assets(
    ...
    url = "{}/assets/v2/asset".format(settings["api"]["api_url"], limit=limit, customer=customer, asset=asset, keywords=keywords, offset=offset, includeDeleted=includeDeleted, startTimestamp=startTimestamp, endTimestamp=endTimestamp, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def search_asset_definitions_simplified(
    ...
    :param int startTimestamp: Start timestamp for time range search
    :param int endTimestamp: End timestamp for time range search
    :raises AuthenticationFailedException: on 401
    :raises AccessDeniedException: on 403
    :raises ValidationErrorException: on 412
    :returns: A requests object or JSON object
    ...
    url = "{}/assets/v2/asset/definition".format(settings["api"]["api_url"], limit=limit, keywordMatch=keywordMatch, timeMatch=timeMatch, offset=offset, keywords=keywords, keywordField=keywordField, startTimestamp=startTimestamp, endTimestamp=endTimestamp, timeField=timeField, definition=definition, domain=domain, sortBy=sortBy)
    headers = {
        'User-Agent': 'ArgusToolbelt/',
    }
...
def search_assets(
    ...
    :param str timeMatchStrategy: Defines how strict to match against different timestamps (all/any) using start and end timestamp (default any) (default any)
    :param list customer: Restrict the search to these customer IDs or short names 
    :param list asset: Restrict the search to these asset IDs or short names 
    :param list includeFlags: Filter by assets that contain these flags 
    :param list excludeFlags: Filter by assets that do not contain these flags 
