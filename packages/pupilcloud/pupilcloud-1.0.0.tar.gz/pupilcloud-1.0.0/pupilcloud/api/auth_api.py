...
class AuthApi(object):
    ...
    def get_profile(self, **kwargs):  # noqa: E501
        """Returns the current logged in user based on auth token  # noqa: E501
    ...
    def get_profile_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ProfileGetResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='ProfileGetResponse',  # noqa: E501
