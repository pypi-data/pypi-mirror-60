...
class vinex (Exchange):
    ...
    def fetch_markets(self, params={}):
        markets = self.publicGetMarkets().get('data', {})
    ...
    #     self.load_markets()
    #     tickers = self.publicGetTickers(params).get('data', {})['markets']
    #     result = {}
    ...
    def fetch_balance(self, params={}):
        ...
        balances = self.privateGetBalances(params).get('data', {})
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        data = self.privatePostPlaceOrder(self.extend(request, params)).get('data', {})
    ...
    def _fetch_orders(self, symbol=None, since=None, limit=None, params={}, status=None):
        ...
        raw_orders = self.privateGetGetMyOrders(self.extend(request, params)).get('data', {})
    ...
    def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        trades = self.privateGetGetMyTrading(self.extend(request, params)).get('data', {})
