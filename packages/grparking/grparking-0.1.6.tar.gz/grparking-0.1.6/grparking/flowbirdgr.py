...
def flowbird_transforms(flowbird_data, meter_data, zone_data):
    ...
    flowbird_data['space_coordinates'] = flowbird_data['space_coordinates'].astype(str).str.replace('POLYGON \(\(','MULTIPOLYGON (((')
    flowbird_data['space_coordinates'] = flowbird_data['space_coordinates'].astype(str).str.replace('\)\)', ')))')
