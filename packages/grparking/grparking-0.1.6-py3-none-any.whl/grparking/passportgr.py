...
def passport_transforms(passport_data, space_data):
    ...
    passport_data['space_coordinates'] = passport_data['space_coordinates'].astype(str).str.replace('POLYGON \(\(','MULTIPOLYGON (((')
    passport_data['space_coordinates'] = passport_data['space_coordinates'].astype(str).str.replace('\)\)', ')))')
