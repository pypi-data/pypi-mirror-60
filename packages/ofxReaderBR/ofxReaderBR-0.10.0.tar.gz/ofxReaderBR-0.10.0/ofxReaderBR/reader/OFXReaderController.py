...
from ofxReaderBR.reader.readercontroller import BaseReaderController
...
class OFXReaderController(BaseReaderController):
    ...
    def read(self, factory, files=None) -> List[BankStatement]:
        bank_statements = []
        for file in files:
            try:
                ...
                file.seek(0)
                xml_factory = factory.create_xml_factory()
                xml_controller = xml_factory.create_reader_controller()
