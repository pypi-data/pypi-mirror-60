        ...
        if self.fParams:
            ...
            if (self.shape == 'Circular') |\
                ...
                if self.fParams == 'ASCE 41-13':
                    ...
                    rho_s = self.Agcx/(self.bx*self.s)
                    rho_t = self.Agcy/(self.by*self.s)
                    # Determine shear constant
                    vC_s = self.Vedx * 1000 / \
                    ...
                    rho_t_s = min(max(self.Aswx / self.Agcx, 0.0005), 0.0175)
                    # Note e and general requirement
                    rho_t_t = min(max(self.Aswy / self.Agcy, 0.0005), 0.0175)
