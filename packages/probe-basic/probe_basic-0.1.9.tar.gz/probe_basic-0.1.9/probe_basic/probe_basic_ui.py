...
"}")
        ...
        self.tool_diameter_probe = QtWidgets.QPushButton(self.widget_38)
        self.tool_diameter_probe.setGeometry(QtCore.QRect(265, 290, 125, 38))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tool_diameter_probe.sizePolicy().hasHeightForWidth())
        self.tool_diameter_probe.setSizePolicy(sizePolicy)
        self.tool_diameter_probe.setMinimumSize(QtCore.QSize(125, 38))
        self.tool_diameter_probe.setMaximumSize(QtCore.QSize(125, 38))
        self.tool_diameter_probe.setFocusPolicy(QtCore.Qt.NoFocus)
        self.tool_diameter_probe.setStyleSheet("QPushButton{\n"
"    font: 14pt \"Bebas Kai\";\n"
"}")
        self.tool_diameter_probe.setCheckable(True)
        self.tool_diameter_probe.setObjectName("tool_diameter_probe")
...
"}")
        ...
        self.frame_21.setGeometry(QtCore.QRect(1340, 26, 271, 231))
...
"USB"))
        ...
        self.m6_button_atc.setText(_translate("Form", "M6 G43"))
        self.m6_button_atc.setProperty("MDICommand", _translate("Form", "T#<atc_tool_number_entry_box> M6 G43 H#<atc_tool_number_entry_box>"))
        ...
        self.m6_button_atc_2.setText(_translate("Form", "M6 G43"))
        self.m6_button_atc_2.setProperty("MDICommand", _translate("Form", "T#<atc_tool_number_entry_box> M6 G43 H#<atc_tool_number_entry_box_2>"))
...
"]"))
        ...
        self.tool_diameter_probe.setText(_translate("Form", "TOOL DIAM PROBE"))
        self.tool_diameter_probe.setProperty("checkedAction", _translate("Form", "1"))
        ...
        self.m6_button_main.setText(_translate("Form", "M6 G43"))
        self.m6_button_main.setProperty("MDICommand", _translate("Form", "T#<main_tool_number_entry_box> M6 G43 H#<main_tool_number_entry_box>"))
...
"]"))
        ...
        self.statuslabel_5.setProperty("rules", _translate("Form", "[{\"channels\": [{\"url\": \"status:spindle.0.speed\", \"trigger\": true}], \"property\": \"Text\", \"expression\": \"\\\"{:.0f}\\\".format(ch[0])\", \"name\": \"Speed\"}]"))
