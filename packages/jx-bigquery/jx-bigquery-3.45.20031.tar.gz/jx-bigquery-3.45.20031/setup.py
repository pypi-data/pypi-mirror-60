...
setup(
    ...
    install_requires=["google-cloud-bigquery","jx-python>=3.43.20031","jx-python>=3.43.20031","mo-dots>=3.41.20031","mo-future>=3.45.20031","mo-json>=3.38.20029","mo-kwargs>=3.38.20029","mo-logs>=3.38.20029","mo-sql>=3.38.20031","mo-times>=3.38.20029","mo-times>=3.38.20029"],
    license='MPL 2.0',
