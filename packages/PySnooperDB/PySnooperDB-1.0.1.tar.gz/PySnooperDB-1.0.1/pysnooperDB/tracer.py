...
import threading
import traceback
from .DataBaseFunc import DB,create_table,insert_table,delete_table,show_tablename,show_table
...
class Tracer:
    ...
    def __init__(self, output=None, watch=(), watch_explode=(), depth=1,
        ...
        Tracer.__tablename = tablename 
        Tracer.__observelist = observelist 
        Tracer.__user = user
        Tracer.__passwd = passwd
        Tracer.__databasename = databasename

        create_table(tablename, user = user, passwd = passwd, databasename= databasename)
    ...
    def trace(self, frame, event, arg):
        ...
        for name, value_repr in local_reprs.items():
            ...
            if name not in old_local_reprs:
                insert_table(Tracer.__tablename, Tracer.__observelist, name, value_repr, source[Tracer.__line_no_past],\
                    Tracer.__line_no_past, user = Tracer.__user, passwd = Tracer.__passwd, databasename= Tracer.__databasename)
