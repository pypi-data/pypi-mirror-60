...
from qumulo.rest.nfs import NFSExportRestriction, NFSRestriction
...
class NFSListSharesCommand(Subcommand):
...
class NFSAddShareCommand(Subcommand):
    NAME = "nfs_add_share"
    ...
    def options(parser):
        ...
        parser.add_argument("--fs-path", type=str_decode, default=None,
            required=True, help="File system path")
...
class NFSListShareCommand(Subcommand):
    NAME = "nfs_list_share"
    ...
    def options(parser):
        parser.add_argument("--id", type=str_decode, default=None,
            required=True, help="ID of share to list")
...
class NFSModShareCommand(Subcommand):
    NAME = "nfs_mod_share"
    ...
    def options(parser):
        parser.add_argument("--id", type=str_decode, default=None,
            required=True, help="ID of share to modify")
        parser.add_argument("--export-path", type=str_decode, default=None,
...
class NFSDeleteShareCommand(Subcommand):
    ...
    def options(parser):
        parser.add_argument("--id", type=str_decode, default=None,
            required=True, help="ID of share to delete")
