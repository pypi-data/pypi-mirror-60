...
def _copy_and_replace_placeholder_dir(src      , dst      ,
                                      replace_dict                  )        :
...
def _copy_and_replace_placeholder_file(src      , dst      ,
                                       replace_dict                  )        :
...
def _sanitize_pipeline_name(name      )        :
