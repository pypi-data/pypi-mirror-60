...
class RequestBuilder(object):
  ...
  def __init__(self, max_examples     , model_name      ):
    if max_examples <= 0:
  ...
  def SetSignatureName(self, signature_name      ):
  ...
  def ReadFromExamplesArtifact(self, examples                ,
                               split_name                 = None):
  ...
  def BuildRegressionRequests(self)                                          :
