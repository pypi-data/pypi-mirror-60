...
class Metadata(object):
  ...
  def _upsert_artifacts(self, tfx_artifact_list                ,
                        state      )        :
  ...
  def publish_artifacts(self, tfx_artifact_list                )        :
  ...
  def _get_outputs_of_execution(
      self, desired_input_ids          , execution_id     ,
      events                                
  )                                        :
  ...
  def _register_context_if_not_exist(
      self, context_type_name      , context_name      ,
      properties                                     
  )                              :
