...
class Packager:
    ...
    def main():
        pass
Packager._hx_class = Packager
_hx_classes["Packager"] = Packager
        ...
        if self.prepareRequestAndOpenLogSection(model):
            if self.processSetup():
                ...
                def _hx_local_0(step,prev):
                    if (prev is not None):
                        return _gthis.processStep(step,(stepData.firstIndex + prev.nextIndex),prev.lastRequestStr,prev.lastDataStr)
                    else:
                        return None
                Lambda.fold(steps,_hx_local_0,_hx_AnonObject({'nextIndex': 0, 'lastRequestStr': "", 'lastDataStr': "{}"}))
            connect_Env.getLogger().closeSection()
...
class connect_api_Query(connect_Base):
    ...
    _hx_methods = ["in_", "out", "limit", "orderBy", "offset", "ordering", "like", "ilike", "select", "equal", "notEqual", "greater", "greaterOrEqual", "lesser", "lesserOrEqual", "toString", "toPlain", "addRelOp"]
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = connect_Base
            ...
            if ((field != "fieldClassNames") and ((value is not None))):
                ...
                if (tmp == 5):
                    ...
                    if (_g12 == str):
                        ...
                        className = Type.getClassName(class_)
                        startIndex = None
                        if (((className.find("connect.Collection") if ((startIndex is None)) else className.find("connect.Collection", startIndex))) == 0):
                            def _hx_local_2():
                                _hx_local_1 = value
    ...
    def __init__(self,firstIndex,data,storage):
        ...
        if Std._hx_is(data,connect_util_Dictionary):
            ...
            while (_g < len(_g1)):
                ...
                fieldClass = python_internal_ArrayImpl._get(fieldSplit[-1:None], 0)
                value1 = haxe_format_JsonPrinter.print(Reflect.field(data,field),None,None)
                parsedValue = (connect_models_Model.parse(Type.resolveClass(fieldClass),value1) if ((fieldClass != "")) else value1)
...
class connect_util_Collection(connect_Base):
    ...
    __slots__ = ("_array",)
    _hx_fields = ["_array"]
    _hx_methods = ["length", "get", "set", "toArray", "concat", "copy", "indexOf", "insert", "iterator", "join", "lastIndexOf", "pop", "push", "remove", "reverse", "shift", "slice", "splice", "toString", "unshift"]
...
class connect_util_DateTime:
    ...
    _hx_methods = ["getYear", "getMonth", "getDay", "getHours", "getMinutes", "getSeconds", "toString"]
...
class connect_util_Diff:
    ...
    __slots__ = ("a", "d", "c")
    _hx_fields = ["a", "d", "c"]
    _hx_methods = ["apply", "swap", "toString"]
    _hx_statics = ["applyArray", "swapArray", "parse", "parseArray", "compareArrays", "areEqual", "isSupported", "checkStructs"]
    ...
    def toString(self):
        return haxe_format_JsonPrinter.print(_hx_AnonObject({'a': self.a, 'd': self.d, 'c': self.c}),None,None)
    ...
    def swapArray(arr):
        ...
        def _hx_local_0(change):
            i = (change[0] if 0 < len(change) else None)
            if (len(change) == 3):
                return [i, (change[2] if 2 < len(change) else None), (change[1] if 1 < len(change) else None)]
            elif Std._hx_is((change[1] if 1 < len(change) else None),list):
                return [i, connect_util_Diff.swapArray((change[1] if 1 < len(change) else None))]
            else:
                return [i, Reflect.field((change[1] if 1 < len(change) else None),"swap")()]
