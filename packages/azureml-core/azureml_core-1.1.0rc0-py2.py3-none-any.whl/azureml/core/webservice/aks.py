...
class AksWebservice(Webservice):
    ...
    def get_access_token(self):
        ...
        :rtype: :class:`azureml.core.webservice.aks.AksServiceAccessToken`
        :raises: :class:`azureml.exceptions.WebserviceException`
        """
...
class AksServiceAccessToken(object):
    ...
    def __init__(self, access_token, token_type, refresh_after, expiry_on):
        """Create a new instance of AksServiceAccessToken.
    ...
    def serialize(self):
        """Convert this AksServiceAccessToken object into a JSON serialized dictionary.

        :return: The JSON representation of this AksServiceAccessToken object.
        :rtype: dict
        """
        return {
    ...
    def deserialize(payload_obj):
        """Convert a JSON object into a AksServiceAccessToken object.

        :param payload_obj: A JSON object to convert to a AksServiceAccessToken object.
        :type payload_obj: dict
        :return: The AksServiceAccessToken representation of the provided JSON object.
        :rtype: :class:`azureml.core.webservice.aks.AksServiceAccessToken`
        """
        for payload_key in AksServiceAccessToken._expected_payload_keys:
            if payload_key not in payload_obj:
                raise WebserviceException('Invalid webservice payload, missing {} for AksServiceAccessToken:\n'
                                          '{}'.format(payload_key, payload_obj), logger=module_logger)

        return AksServiceAccessToken(payload_obj['accessToken'], payload_obj['tokenType'], payload_obj['refreshAfter'],
