...
class Run(_RunBase):
    ...
    * `How to manage runs <https://docs.microsoft.com/azure/machine-learning/service/how-to-manage-runs>`_
    ...
    def __init__(self, experiment, run_id, outputs=None, **kwargs):
        ...
        self._input_datasets = InputDatasets(experiment.workspace)
    ...
    def _load_scope(cls):
        ...
        try:
            ...
            workspace = Workspace(subscription_id, resource_group, workspace_name,
                                  auth=auth, _location=location,
                                  _disable_service_check=True, _workspace_id=workspace_id)
    ...
    def get_secret(self, name):
        ...
        runs <https://docs.microsoft.com/azure/machine-learning/service/how-to-use-secrets-in-runs>`_.
    ...
    def set_tags(self, tags):
        ...
        <https://docs.microsoft.com/azure/machine-learning/service/how-to-manage-runs#tag-and-find-runs>`_.
    ...
    def get_properties(self):
        ...
        .. remarks::
            ...
            Properties include immutable system-generated information such as
            duration, date of execution, user, etc. For more information, see `Tag and find runs
            <https://docs.microsoft.com/azure/machine-learning/service/how-to-manage-runs#tag-and-find-runs>`_.
            ...
            for pair in dataset_environment_var_list:
                ...
                if len(pair_list) == 2:
                    ...
                    if var_value and dataset_consumption_type.lower() == 'direct':
                        super().__setitem__(var_name.lower(), _Dataset._get_by_id(self.workspace, var_value))
                    else:
                        super().__setitem__(var_name.lower(), var_value)

    def __getitem__(self, key):
        """Get the materialized data for the given name.

        :param key: The name of the dataset for this run.
        :type key: str
        :return: The materialized data.
        :rtype: str or azureml.data.TabularDataset or azureml.data.FileDataset
        """
        if not self._initialized:
            self._load_input_datasets()
