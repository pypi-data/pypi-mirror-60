...
def initialize(cache_dir=None):
    ...
    # Python 2
    python_grammar = driver.load_packaged_grammar("_oitnb_lib2to3", _GRAMMAR_FILE,
                                                  cache_dir)
    ...
    pattern_grammar = driver.load_packaged_grammar("_oitnb_lib2to3", _PATTERN_GRAMMAR_FILE,
                                                   cache_dir)
