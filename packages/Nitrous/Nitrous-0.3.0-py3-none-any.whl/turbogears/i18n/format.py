...
def get_countries(locale=None):
    ...
    """
    countries = list(get(locale, 'countries', {}).items())
...
def get_languages(locale=None):
    ...
    """
    languages = list(get(locale, 'languages', {}).items())
...
def format_decimal(value, num_places, locale=None):
    ...
    return format_number(num, locale) + str(
...
def parse_number(value, locale=None):
    ...
    """
    return int(value.replace(get_group_format(locale), ""))
