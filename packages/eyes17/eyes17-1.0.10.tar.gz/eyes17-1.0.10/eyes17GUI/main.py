...
testEquipment = [ 
[QT_TRANSLATE_NOOP('MainWindow','Oscilloscope'),('3.0', '.scope',package='eyes17GUI')]
...
class MainWindow(QMainWindow):
	...
	def scope_help(self,e):
		self.hlpName = e[1]
		if self.expName != '.scope',package='eyes17GUI':
			...
			try:
				...
				self.expWidget = w
				self.expName = '.scope',package='eyes17GUI'
			except:
				self.expName = ''
	...
	def callExpt(self, e):
		...
		"""	
		'.'+module_name,package='eyes17GUI' =  e[1] if type(e[1]) is str else e[1][-1]
