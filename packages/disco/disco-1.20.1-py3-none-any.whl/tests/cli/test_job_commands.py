...
class TestJobCommands(BaseTest):
        ...
        with runner.isolated_filesystem():
            with open('script_file.py', 'w') as f:
                ...
                job_create_mock.assert_called_with('file_id', ['file_id'], [],
                                                   'job_name',
                                                   's', None, auto_start=False, upload_requirements_file=True)
    ...
    def test_create_job_without_req_file(self, asset_upload_mock, path_is_dir_mock,
        ...
        with runner.isolated_filesystem():
            with open('script_file.py', 'w') as f:
                ...
                job_create_mock.assert_called_with('file_id', ['file_id'], [],
                                                   'job_name',
                                                   's', None, auto_start=False, upload_requirements_file=False)
    ...
    def test_create_job_script_file_in_home_dir(self, asset_upload_mock, job_create_mock, is_logged_in_mock):
        ...
        try:
            ...
            job_create_mock.assert_called_with(script_file_id, [input_file_id1, input_file_id2], [constant_file_id],
                                               'job_name', 's', None, auto_start=False,
    ...
    def test_create_job_script_file_from_git_repository(self, asset_upload_mock, path_is_dir_mock,
        ...
        with runner.isolated_filesystem():
            ...
            job_create_mock.assert_called_with(input_file_ids=[input_file_id], constants_file_ids=[], job_name=job_name,
                                               cluster_instance_type='s', cluster_id=None, script_repo_id=repository_id,
                                               script_file_path_in_repo=file_path, auto_start=False, upload_requirements_file=True)
