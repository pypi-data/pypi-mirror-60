...
class TestJobCommands(BaseTest):
    ...
    def test_create_job_with_bucket_input_files(self, input_files_from_bucket_mock, asset_upload_mock,
    ...
    @patch('disco.asset.Asset.upload')
    @patch('disco.asset.Asset.input_files_from_bucket')
    def test_create_job_with_bucket_input_files_no_files_found(self, input_files_from_bucket_mock, asset_upload_mock,
                                                               job_create_mock, is_logged_in_mock):
        """
    ...
    @patch('disco.asset.Asset.upload')
    @patch('disco.asset.Asset.input_files_from_bucket')
    def test_create_job_with_bucket_input_files_error_bucket_path(self, input_files_from_bucket_mock, asset_upload_mock,
                                                                  job_create_mock, is_logged_in_mock):
        """
        Create job with input files from bucket paths - no files found
        """
    ...
    @patch('disco.Job.create')
    @patch('disco.asset.Asset.input_files_from_bucket')
    def test_create_job_with_bucket_input_files_error_unauthorized_cluster(self, input_files_from_bucket_mock,
                                                                           job_create_mock, is_logged_in_mock):
        """
        Create job with input files from bucket paths - no files found
        """
    ...
    @patch('pathlib.Path.exists')
    @patch('pathlib.Path.is_dir')
    def test_create_job_with_bucket_and_local_input_files(self, path_is_dir_mock, path_exists_mock,
        ...
        with runner.isolated_filesystem():
            with open('script_file.py', 'w') as f, open("input_file1.txt", 'w') as i1:
                ...
                asset_upload_mock.assert_has_calls([
                    call('script_file.py', Path('script_file.py'), cluster_id=None, show_progress_bar=True),
                    call('input_file1.txt', Path('input_file1.txt'), cluster_id=None, show_progress_bar=True),
                    call('input_file2.txt', Path('input_file2.txt'), cluster_id=None, show_progress_bar=True),
                ], any_order=True)
