...
def process_weights(w=None, df=None, s=None, n=None, low_bound=None, up_bound=None, weight_cutting_rate = 0.7, normalize = True , display=False, max_iteration = 50):
    ...
    for t in range(n, T, s):
        ...
        local_up_bound = min(1./assets.sum(),up_bound)
        ...
        if normalize:
            ...
            weight_vect=weight_vect/weight_vect.sum()
