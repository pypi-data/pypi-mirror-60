...
class AbstractAssembler(ABC):
    def __init__(self, drop_token=None, dropbox_backup = True, features_pkl_file_name='features.pkl', returns_pkl_file_name='returns.pkl', local_root_directory='../data/', user='napoleon',
