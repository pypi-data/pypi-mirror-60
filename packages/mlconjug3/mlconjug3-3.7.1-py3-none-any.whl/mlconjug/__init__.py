...
Usage example:
    $ mlconjug3.mlconjug manger

    $ mlconjug3.mlconjug bring -l en

    $ mlconjug3.mlconjug gallofar --language es
...
from .mlconjug3.mlconjug import *
...
if _user_locale in _TRANSLATED_LANGUAGES:
    _MLCONJUG_TRANSLATIONS = gettext.translation(domain='mlconjug3.mlconjug',
