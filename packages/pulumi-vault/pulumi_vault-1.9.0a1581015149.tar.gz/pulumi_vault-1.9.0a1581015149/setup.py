...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.9.0-alpha.1581015149+g4a4ded1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.9.0-alpha.1581015149+g4a4ded1`
                """)
            else:
                raise
