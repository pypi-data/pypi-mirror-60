...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.8.0-alpha.1579862073+gc6bf0a5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.8.0-alpha.1579862073+gc6bf0a5`
                """)
            else:
                raise
