...
export class ParallelPlot extends React.Component {
    ...
    render() {
        return (React.createElement(ResizableH, { initialHeight: this.state.height, onResize: this.onResizeH.bind(this) },
            React.createElement("div", { ref: this.root_ref, className: style["parallel-plot-chart"], style: { "height": this.state.height } },
                React.createElement("canvas", { ref: this.foreground_ref, className: style["background-canvas"] }),
                React.createElement("canvas", { ref: this.background_ref, className: style["foreground-canvas"] }),
    ...
    componentDidMount() {
        ...
        var dragging = {}, dimensions_dom = null, render_speed = 10, brush_count = 0;
        ...
        function path(d, ctx, color) {
            ...
            me.dimensions.map(function (p, i) {
                ...
                var x = me.xscale(p), y = me.yscale[p](d[p]);
                if (isNaN(y)) {
                    err = true;
                }
                if (err) {
