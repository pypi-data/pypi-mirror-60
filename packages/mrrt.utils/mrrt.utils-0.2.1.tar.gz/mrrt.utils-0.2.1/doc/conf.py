...
# -*- coding: utf-8 -*-
#
# mrrt.utils documentation build configuration file, created by
...
project = 'mrrt.utils'
copyright = '2013-2019, Gregory Lee'
...
version = re.sub(r'\.dev-.*$', r'.dev', source_version)
...
htmlhelp_basename = 'mrrtutilsdoc'
...
latex_documents = [
  ('index', 'mrrt.utils.tex', 'mrrt.utils Documentation',
...
man_pages = [
    ('index', 'mrrt.utils', 'mrrt.utils Documentation',
     ['Gregory R. Lee'], 1)
]
...
texinfo_documents = [
  ('index', 'mrrt.utils', 'mrrt.utils Documentation',
   'Gregory R. Lee', 'mrrt.utils', 'One line description of project.',
   'Miscellaneous'),
]
