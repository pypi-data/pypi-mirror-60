...
class DynamoController(object):
    ...
    def filter(self, key, value, order_by=None, order_by_value=None, limit=500, next=None, index=None, order_type=ORDER_DESC, filter_expression=None, invert_result=False, condition_expression=None):
