...
# ASN.1 source http://mibs.snmplabs.com:80/asn1/FORTINET-FORTIGATE-MIB
...
FnBoolState, fnSysSerial, fnAdminEntry, fortinet, FnIndex = mibBuilder.importSymbols("FORTINET-CORE-MIB", "FnBoolState", "fnSysSerial", "fnAdminEntry", "fortinet", "FnIndex")
...
DisplayString, PhysAddress, TextualConvention, AutonomousType, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "PhysAddress", "TextualConvention", "AutonomousType", "DateAndTime")
...
class FgAdminPermLevel(TextualConvention, Integer32):
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + SingleValueConstraint(0, 1, 15, 255)
...
fgHwSensorEntAlarmStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 4, 3, 2, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1)).clone(namedValues=NamedValues(("false", 0), ("true", 1)))).setMaxAccess("readonly")
...
fgUsbportPlugged = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 4, 7, 2, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1)).clone(namedValues=NamedValues(("unplugged", 0), ("plugged", 1)))).setMaxAccess("readonly")
...
fgUsbportClass = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 4, 7, 2, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1, 2, 3, 5, 6, 7, 8, 9, 10, 11, 13, 254, 255)).clone(namedValues=NamedValues(("ifc", 0), ("audio", 1), ("comm", 2), ("hid", 3), ("physical", 5), ("image", 6), ("printer", 7), ("storage", 8), ("hub", 9), ("cdcData", 10), ("chipSmartCard", 11), ("contentSecurity", 13), ("appSpec", 254), ("vendorSpec", 255)))).setMaxAccess("readonly")
...
fgLinkMonitorState = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 4, 8, 2, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1)).clone(namedValues=NamedValues(("alive", 0), ("dead", 1)))).setMaxAccess("readonly")
...
fgIntfVrrpEntState = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 7, 3, 2, 1, 5), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2)).clone(namedValues=NamedValues(("backup", 1), ("master", 2)))).setMaxAccess("readonly")
...
fgIntfVlanHbEntState = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 7, 4, 2, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2)).clone(namedValues=NamedValues(("active", 1), ("inactive", 2)))).setMaxAccess("readonly")
...
fgVpnTunEntStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 12, 2, 2, 1, 20), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2)).clone(namedValues=NamedValues(("down", 1), ("up", 2)))).setMaxAccess("readonly")
...
fgWcWtpConfigWtpAdmin = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 14, 4, 3, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1, 2, 3)).clone(namedValues=NamedValues(("other", 0), ("discovered", 1), ("disable", 2), ("enable", 3)))).setMaxAccess("readonly")
...
fgWcWtpSessionConnectionState = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 14, 4, 4, 1, 7), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1, 2, 3, 4)).clone(namedValues=NamedValues(("other", 0), ("offLine", 1), ("onLine", 2), ("downloadingImage", 3), ("connectedImage", 4)))).setMaxAccess("readonly")
...
fgWcStaOnline = MibTableColumn((1, 3, 6, 1, 4, 1, 12356, 101, 14, 5, 1, 21), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2)).clone(namedValues=NamedValues(("yes", 1), ("no", 2)))).setMaxAccess("readonly")
...
fgUsbModemSignalStrength = MibScalar((1, 3, 6, 1, 4, 1, 12356, 101, 17, 1, 1), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1, 2, 3, 4)).clone(namedValues=NamedValues(("level0", 0), ("level1", 1), ("level2", 2), ("level3", 3), ("level4", 4)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: fgUsbModemSignalStrength.setStatus('current')
fgUsbModemStatus = MibScalar((1, 3, 6, 1, 4, 1, 12356, 101, 17, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1)).clone(namedValues=NamedValues(("disconnected", 0), ("connected", 1)))).setMaxAccess("readonly")
if mibBuilder.loadTexts: fgUsbModemStatus.setStatus('current')
fgUsbModemSimState = MibScalar((1, 3, 6, 1, 4, 1, 12356, 101, 17, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1)).clone(namedValues=NamedValues(("invalid", 0), ("valid", 1)))).setMaxAccess("readonly")
...
fgUsbModemNetwork = MibScalar((1, 3, 6, 1, 4, 1, 12356, 101, 17, 1, 6), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1)).clone(namedValues=NamedValues(("network3G", 0), ("networkLTE", 1)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgHaStatsMemUsage=fgHaStatsMemUsage, fgHaStatsEntry=fgHaStatsEntry, fgWanOptDisk=fgWanOptDisk, fgWebCacheInfo=fgWebCacheInfo, fgSIAdvMemCacheActive=fgSIAdvMemCacheActive, fgSIAdvSesNoListenerCount=fgSIAdvSesNoListenerCount, FgWcWtpRadioChannelNumber=FgWcWtpRadioChannelNumber, fgWcWtpProfileRadioProfileName=fgWcWtpProfileRadioProfileName, fgProcessorPktTxCount=fgProcessorPktTxCount, fgtVM64HV=fgtVM64HV, fgUsbports=fgUsbports, fgFwUserEntry=fgFwUserEntry, fgt240DP=fgt240DP, fgIntfVlanHbs=fgIntfVlanHbs, fgExplicitProxyArchSize=fgExplicitProxyArchSize, fgWcWtpSessionWtpSessionUpTime=fgWcWtpSessionWtpSessionUpTime, fgWcInfoLocation=fgWcInfoLocation, fgApplications=fgApplications, fgWcWtpSessionWtpLocalIpAddressType=fgWcWtpSessionWtpLocalIpAddressType, fwf60D=fwf60D, fgLinkMonitorVdom=fgLinkMonitorVdom, fgExplicitProxyScriptStatsTable=fgExplicitProxyScriptStatsTable, fwf92D=fwf92D, fgProcModMemCapacity=fgProcModMemCapacity, fgExplicitProxyFilteredJS=fgExplicitProxyFilteredJS, fgHaStatsIndex=fgHaStatsIndex, fgVirtualDomainObjectGroup=fgVirtualDomainObjectGroup, fgVpnSslState=fgVpnSslState, fgWcTrapObjects=fgWcTrapObjects, fgFwPol6StatsEntry=fgFwPol6StatsEntry, fgVpnTunEntOutOctets=fgVpnTunEntOutOctets, fgt70DPOE=fgt70DPOE, fgWcStaBandwidthRx=fgWcStaBandwidthRx, fgWcStaUser=fgWcStaUser, fgVpnTrapLocalGateway=fgVpnTrapLocalGateway, fgWcStaIpAddressType=fgWcStaIpAddressType, fgUsbportProduct=fgUsbportProduct, fgHaSchedule=fgHaSchedule, fgIntfVrrpEntIfName=fgIntfVrrpEntIfName, fgWfHTTPURLBlocked=fgWfHTTPURLBlocked, fgWcWtpSessionEntry=fgWcWtpSessionEntry, fgWebCacheDiskStatsEntry=fgWebCacheDiskStatsEntry, fgProcessorTypes=fgProcessorTypes, fgTrapHaHBFail=fgTrapHaHBFail, fgAppIMMessages=fgAppIMMessages, fwf51E=fwf51E, fgt3700D=fgt3700D, fgHaGroupName=fgHaGroupName, fgApFTPStatsEntry=fgApFTPStatsEntry, fgWcWtpProfileEntry=fgWcWtpProfileEntry, FgWcWlanEncryptionType=FgWcWlanEncryptionType, fgExplicitProxyFilterStatsEntry=fgExplicitProxyFilterStatsEntry, fgIpsInfoSevDetections=fgIpsInfoSevDetections, fgUsbportsObjectGroup=fgUsbportsObjectGroup, fgt5001D=fgt5001D, fgHwSensorEntry=fgHwSensorEntry, fgt51E=fgt51E, fgt600C=fgt600C, fgAntivirusObjectGroup=fgAntivirusObjectGroup, fgHwSensorTable=fgHwSensorTable, fgHaStatsPktCount=fgHaStatsPktCount, fgLinkMonitorID=fgLinkMonitorID, fgProcModType=fgProcModType, fgVpnTunEntSelectorSrcPort=fgVpnTunEntSelectorSrcPort, fgAvPOP3VirusBlocked=fgAvPOP3VirusBlocked, fgLinkMonitor=fgLinkMonitor, fgIpsTables=fgIpsTables, fgIntfVrrpTable=fgIntfVrrpTable, fgSystemInfoAdvanced=fgSystemInfoAdvanced, fgtVM64VMX=fgtVM64VMX, fgApPOP3MemUsage=fgApPOP3MemUsage, fgTrapVpnTunUp=fgTrapVpnTunUp, fgWcApVdom=fgWcApVdom, fgAppProxyHTTP=fgAppProxyHTTP, fgVpnSslTunnelUpTime=fgVpnSslTunnelUpTime, fgVdEntName=fgVdEntName, fgIntfVrrpCount=fgIntfVrrpCount, fgApNNTPMemUsage=fgApNNTPMemUsage, fgWcInfoName=fgWcInfoName, fgExplicitProxyObjectGroup=fgExplicitProxyObjectGroup, fgHaAutoSync=fgHaAutoSync, fgWcWtpProfileDataChannelDtlsPolicy=fgWcWtpProfileDataChannelDtlsPolicy, fwf30DPOE=fwf30DPOE, fgProcModFnXG2=fgProcModFnXG2, fgt500D=fgt500D, fgHaStatsTable=fgHaStatsTable, fgFwUserTables=fgFwUserTables, fgVpnTunEntInOctets=fgVpnTunEntInOctets, fwf50E=fwf50E, fgFwPol6LastUsed=fgFwPol6LastUsed, fgFirewall=fgFirewall, fgManIfIp6=fgManIfIp6, fgWcObjectGroup=fgWcObjectGroup, fgAppP2PConnBlocked=fgAppP2PConnBlocked, fgLinkMonitorEntry=fgLinkMonitorEntry, fgVdTpTable=fgVdTpTable, fgWcWlanSsid=fgWcWlanSsid, fgIntfVlanHbTable=fgIntfVlanHbTable, fgTrapAvFragmented=fgTrapAvFragmented, fgExplicitProxyBlockedURLs=fgExplicitProxyBlockedURLs, fgWebfilterStatsTable=fgWebfilterStatsTable, fgProcessorOther=fgProcessorOther, fgApSIPMemUsage=fgApSIPMemUsage, fgWcInfoStationCount=fgWcInfoStationCount, fgtVM64XEN=fgtVM64XEN, fgLinkMonitorState=fgLinkMonitorState, fgManIfIp=fgManIfIp, fgAdminObjectGroup=fgAdminObjectGroup, fgApSMTPStatsTable=fgApSMTPStatsTable, fgWanOptLanTraffic=fgWanOptLanTraffic, fgExplicitProxyBlockedConType=fgExplicitProxyBlockedConType, fgWanOptStatsEntry=fgWanOptStatsEntry, fgVdMaxVdoms=fgVdMaxVdoms, fgHaStatsSyncDatimeUnsucc=fgHaStatsSyncDatimeUnsucc, fgIntfVrrpEntry=fgIntfVrrpEntry, fgAppSuNumber=fgAppSuNumber, fgVpnTunEntLifeBytes=fgVpnTunEntLifeBytes, fgAppScanUnit=fgAppScanUnit, fgServerLoadBalanceRealServerAddress=fgServerLoadBalanceRealServerAddress, fgProcModIndex=fgProcModIndex, fgHaStatsSyncDatimeSucc=fgHaStatsSyncDatimeSucc, fgSysSesCount=fgSysSesCount, fgVpnSslStatsTable=fgVpnSslStatsTable, fgLinkMonitorTable=fgLinkMonitorTable, fgIpsMedSevDetections=fgIpsMedSevDetections, fgTrapFcSwDown=fgTrapFcSwDown, fgExplicitProxyVirus=fgExplicitProxyVirus, fgFmTrapDeployInProgress=fgFmTrapDeployInProgress, fgFwPolicies=fgFwPolicies, fgSIAdvMemCacheInactive=fgSIAdvMemCacheInactive, fgWcWtpProfileRadioAutoTxPowerLow=fgWcWtpProfileRadioAutoTxPowerLow, fgWcStaEntry=fgWcStaEntry, fgWanOptTrafficStatsEntry=fgWanOptTrafficStatsEntry, FgWanOptHistPeriods=FgWanOptHistPeriods, fgApSIPClientReg=fgApSIPClientReg, fgExplicitProxyOversized=fgExplicitProxyOversized, fgAppP2PProtEntProto=fgAppP2PProtEntProto, fgWcWtpSessionVapWtpId=fgWcWtpSessionVapWtpId, fgt80D=fgt80D, fgVpnDialupSrcEnd=fgVpnDialupSrcEnd, fgWcInfoWtpSessions=fgWcInfoWtpSessions, fgTrapHaMemberDown=fgTrapHaMemberDown, fgVpnTunEntSelectorSrcEndIp=fgVpnTunEntSelectorSrcEndIp, fgAppSuStatsEntry=fgAppSuStatsEntry, fgTrapServerLoadBalanceRealServerDown=fgTrapServerLoadBalanceRealServerDown, fgApNNTPMaxConnections=fgApNNTPMaxConnections, fgWcWtpConfigVaps=fgWcWtpConfigVaps, fgExplicitProxyExaminedURLs=fgExplicitProxyExaminedURLs, fgWcWtpSessionRadioRadioId=fgWcWtpSessionRadioRadioId, fgObsoleteNotificationsGroup=fgObsoleteNotificationsGroup, fgObsolteMIBCompliance=fgObsolteMIBCompliance, fgApHTTPUpTime=fgApHTTPUpTime, fgAvTables=fgAvTables, fgAppP2PProtoTable=fgAppP2PProtoTable, fgIpSessIndex=fgIpSessIndex, fgFmTrapDeployComplete=fgFmTrapDeployComplete, fgUsbportEntry=fgUsbportEntry, fgFortiGuardStatsTable=fgFortiGuardStatsTable, fgt1500D=fgt1500D, fgWebCacheRAMUsage=fgWebCacheRAMUsage, fgIpsTrapSigMsg=fgIpsTrapSigMsg, fgVdEntSesCount=fgVdEntSesCount, fgInetProtoTables=fgInetProtoTables, fgt3600C=fgt3600C, fgWcWtpProfileTable=fgWcWtpProfileTable, fgVpnDialupEntry=fgVpnDialupEntry, fgt92D=fgt92D, fgDeviceMacAddress=fgDeviceMacAddress, fgUsbModemSimState=fgUsbModemSimState, fgVpnTunEntStatus=fgVpnTunEntStatus, fgMemCacheHits=fgMemCacheHits, fgt60DPOE=fgt60DPOE, fgWcWtpProfileRadioTxPowerLevel=fgWcWtpProfileRadioTxPowerLevel, fosVM64KVM=fosVM64KVM, fgVpnTunEntRemGwyPort=fgVpnTunEntRemGwyPort, fgExplicitProxyFilterStatsTable=fgExplicitProxyFilterStatsTable, fgSystemAdvancedObjectGroup=fgSystemAdvancedObjectGroup, fgProcessorPktRxCount=fgProcessorPktRxCount, fgApPOP3SpamDetected=fgApPOP3SpamDetected, fgExplicitProxySessions=fgExplicitProxySessions, fgWcWtpSessionWtpProfileName=fgWcWtpSessionWtpProfileName, fgWcWtpConfigRadioAutoTxPowerLow=fgWcWtpConfigRadioAutoTxPowerLow, fg900D=fg900D, fgAvNNTPVirusDetected=fgAvNNTPVirusDetected, FgSessProto=FgSessProto, fgWcStaSignal=fgWcStaSignal, fgProcessorFnNP6=fgProcessorFnNP6, fgTrapAvPattern=fgTrapAvPattern, fgWcWtpSessionWtpByteTxCount=fgWcWtpSessionWtpByteTxCount, fgWanOptUpTime=fgWanOptUpTime, fgIpsCritSevDetections=fgIpsCritSevDetections, fgMemCacheUsage=fgMemCacheUsage, fgAvPOP3VirusDetected=fgAvPOP3VirusDetected, fgUsbportClass=fgUsbportClass, fgFgWfHTTPSAllowed=fgFgWfHTTPSAllowed, fgWcWtpProfileRadioWidsProfile=fgWcWtpProfileRadioWidsProfile, fgWanOptWanOutTraffic=fgWanOptWanOutTraffic, fgWanOptProtocol=fgWanOptProtocol, fgWcStaRadioType=fgWcStaRadioType, fgProcModFnXD2=fgProcModFnXD2, fgAppVoIPCallBlocked=fgAppVoIPCallBlocked, fgAvOversizedBlocked=fgAvOversizedBlocked, fgVpnSslTunnelUserName=fgVpnSslTunnelUserName, fgVdEntOpMode=fgVdEntOpMode, fgApFTPMemUsage=fgApFTPMemUsage, fgWcStaIpAddress=fgWcStaIpAddress, fgt1000C=fgt1000C, fgSystemInfo=fgSystemInfo, fgWcWtpSessionVapByteTxCount=fgWcWtpSessionVapByteTxCount, fgServerLoadBalanceVirtualServerName=fgServerLoadBalanceVirtualServerName, fgApNNTPConnections=fgApNNTPConnections, fgWcInfo=fgWcInfo, fgHaTrapObjects=fgHaTrapObjects, fgWfActiveXBlocked=fgWfActiveXBlocked, fgVpnSslTunnelTable=fgVpnSslTunnelTable, fgr60D=fgr60D, fgProcessorUsage=fgProcessorUsage, fwf80CM=fwf80CM, fgWcWlanLocalBridging=fgWcWlanLocalBridging, fw60DP=fw60DP, fgFwUserNumber=fgFwUserNumber, fgWcWtpProfileName=fgWcWtpProfileName, fgWcWtpSessionVapByteRxCount=fgWcWtpSessionVapByteRxCount, fgTrapAvVirus=fgTrapAvVirus, fgSIAdvMemEnterProxyConsThrsh=fgSIAdvMemEnterProxyConsThrsh, fgFmTrapIfChange=fgFmTrapIfChange, fgIpSessNumber=fgIpSessNumber, fgAppServicesObjectGroup=fgAppServicesObjectGroup, fgApIMAPConnections=fgApIMAPConnections, fgAppIMFileTxBlocked=fgAppIMFileTxBlocked, fgHaStatsSyncStatus=fgHaStatsSyncStatus, fgFwUserInfo=fgFwUserInfo, fgAppIMStatsTable=fgAppIMStatsTable, fgServerLoadBalanceTrapObjects=fgServerLoadBalanceTrapObjects, fgIpSessToAddr=fgIpSessToAddr, fgHighAvailabilityObjectGroup=fgHighAvailabilityObjectGroup, fgWcWtpSessionWtpBaseMacAddress=fgWcWtpSessionWtpBaseMacAddress, fgProcessorUsage5sec=fgProcessorUsage5sec, fgSysVersionAv=fgSysVersionAv, fgWcWtpProfileRadioDtimPeriod=fgWcWtpProfileRadioDtimPeriod, fgWcApName=fgWcApName, fgt3HD=fgt3HD, fgApSMTPReqProcessed=fgApSMTPReqProcessed, fgIntfVlanHbEntry=fgIntfVlanHbEntry, FgVdIndex=FgVdIndex, fgExplicitProxyLoggedURLs=fgExplicitProxyLoggedURLs, fgAvSMTPVirusBlocked=fgAvSMTPVirusBlocked, fgIntfInfo=fgIntfInfo, fgt3810D=fgt3810D, fgHaInfo=fgHaInfo, fgt240D=fgt240D, fgAvIMVirusBlocked=fgAvIMVirusBlocked, fgFwPolStatsEntry=fgFwPolStatsEntry, fgWcWtpSessionWtpStationCount=fgWcWtpSessionWtpStationCount)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgWcWtpSessionVapEntry=fgWcWtpSessionVapEntry, fgTrapAvOversize=fgTrapAvOversize, fgAppP2P=fgAppP2P, fgFwUsers=fgFwUsers, fgVpnSslTunnelIndex=fgVpnSslTunnelIndex, fgHaTrapMemberSerial=fgHaTrapMemberSerial, fgSIAdvMemLeaveProxyConsThrsh=fgSIAdvMemLeaveProxyConsThrsh, fgIpSessEntry=fgIpSessEntry, fgFwUserState=fgFwUserState, fgWcStaRadioId=fgWcStaRadioId, fgt200DP=fgt200DP, fgWcWlanEntry=fgWcWlanEntry, fgWfCookieBlocked=fgWfCookieBlocked, fgByteCacheRAMLimit=fgByteCacheRAMLimit, fgWcWtpConfigWtpId=fgWcWtpConfigWtpId, fgWcStaWtpId=fgWcStaWtpId, fgWcWtpSessionWtpHwVersion=fgWcWtpSessionWtpHwVersion, fgFcTrapObjects=fgFcTrapObjects, fgSysVersion=fgSysVersion, fgProcessorsObjectGroup=fgProcessorsObjectGroup, fgFmTrapPrefix=fgFmTrapPrefix, fgWcWlanBroadcastSsid=fgWcWlanBroadcastSsid, fgLinkMonitorNumber=fgLinkMonitorNumber, fgLinkMonitorGroup=fgLinkMonitorGroup, fgWcWtpProfileRadioRadioId=fgWcWtpProfileRadioRadioId, fgMgmtTrapObjects=fgMgmtTrapObjects, fgSIAdvSesEphemeralCount=fgSIAdvSesEphemeralCount, fgAntivirus=fgAntivirus, fgApSMTPMaxConnections=fgApSMTPMaxConnections, fgWcWtpProfileCountryString=fgWcWtpProfileCountryString, fgVpnObjectGroup=fgVpnObjectGroup, fgMemCacheMisses=fgMemCacheMisses, fgExplicitProxyFilteredApplets=fgExplicitProxyFilteredApplets, fgWcWlanAuthentication=fgWcWlanAuthentication, fgVpnSslStatsMaxTunnels=fgVpnSslStatsMaxTunnels, fgWcWtpConfigWtpLocation=fgWcWtpConfigWtpLocation, fgVpnTunEntPhase1Name=fgVpnTunEntPhase1Name, fgUsbModemSignalStrength=fgUsbModemSignalStrength, fgHwSensorEntName=fgHwSensorEntName, fgVpnSslStatsActiveWebSessions=fgVpnSslStatsActiveWebSessions, fgWcWtpProfileRadioDarrp=fgWcWtpProfileRadioDarrp, fgIntfEntry=fgIntfEntry, fgWcWtpSessionWtpModelNumber=fgWcWtpSessionWtpModelNumber, fgIntfVlanHbEntIfName=fgIntfVlanHbEntIfName, fgExplicitProxyUpTime=fgExplicitProxyUpTime, fgWcWtpSessionVapStationCount=fgWcWtpSessionVapStationCount, FgWcWtpRadioBandType=FgWcWtpRadioBandType, fgWcWtpProfilePlatform=fgWcWtpProfilePlatform, fgtsoc3=fgtsoc3, fgMibConformance=fgMibConformance, fgUsbModemInfoObjects=fgUsbModemInfoObjects, fgApSMTPMemUsage=fgApSMTPMemUsage, fgUsbportPlugged=fgUsbportPlugged, fgWebFilterObjectGroup=fgWebFilterObjectGroup, fgWcWtpProfileRadioBeaconInterval=fgWcWtpProfileRadioBeaconInterval, fgSysDiskUsage=fgSysDiskUsage, fgProcModFnFE8=fgProcModFnFE8, fgApSMTPSpamDetected=fgApSMTPSpamDetected, fgtVM64AWSONDEMAND=fgtVM64AWSONDEMAND, fgWcWlanEncryption=fgWcWlanEncryption, fgSIAdvSesAcceptQFCount=fgSIAdvSesAcceptQFCount, fnFortiGateMib=fnFortiGateMib, fgFwPol6ByteCount=fgFwPol6ByteCount, FgWcWtpChannelWidthType=FgWcWtpChannelWidthType, fgProcModFnFB4=fgProcModFnFB4, FgHaStatsSyncStatusType=FgHaStatsSyncStatusType, fgWcStaEncrypt=fgWcStaEncrypt, fgt1500DT=fgt1500DT, fgExplicitProxyStatsTable=fgExplicitProxyStatsTable, fgt90DPOE=fgt90DPOE, fgWanOptHistoryStatsTable=fgWanOptHistoryStatsTable, fgWcWtpSessionWtpMemoryCapacity=fgWcWtpSessionWtpMemoryCapacity, fgTrapWcApUp=fgTrapWcApUp, fgIpsHighSevDetections=fgIpsHighSevDetections, fgWebfilter=fgWebfilter, fgIpsLowSevDetections=fgIpsLowSevDetections, fgAppProxyIMAP=fgAppProxyIMAP, fgt70D=fgt70D, fgWebCacheRAMHits=fgWebCacheRAMHits, fgWcWtpSessionWtpCpuUsage=fgWcWtpSessionWtpCpuUsage, fgVdNumber=fgVdNumber, fgProcessorModuleCount=fgProcessorModuleCount, fgProcessorEntIndex=fgProcessorEntIndex, fgWcWtpConfigRadioAutoTxPowerHigh=fgWcWtpConfigRadioAutoTxPowerHigh, fgIntfVrrpEntIndex=fgIntfVrrpEntIndex, fgAdmin=fgAdmin, fgAppVoIPStatsEntry=fgAppVoIPStatsEntry, fgAdminVdom=fgAdminVdom, fgUsbportCount=fgUsbportCount, fgDeviceObjectGroup=fgDeviceObjectGroup, fgVpnTunEntPhase2Name=fgVpnTunEntPhase2Name, fgUsbportRevision=fgUsbportRevision, fgVpnDialupVdom=fgVpnDialupVdom, fgHighAvailability=fgHighAvailability, fgSysSesRate60=fgSysSesRate60, fgIpsTrapSigId=fgIpsTrapSigId, fgApSIPUpTime=fgApSIPUpTime, FgWcCountryString=FgWcCountryString, fgApNNTPStatsTable=fgApNNTPStatsTable, fgAppProxyNNTP=fgAppProxyNNTP, fgVpnSslTunnelEntry=fgVpnSslTunnelEntry, fgProcessorFnNP4=fgProcessorFnNP4, fgVpnDialupSrcBegin=fgVpnDialupSrcBegin, fgIp6SessStatsEntry=fgIp6SessStatsEntry, fgVpnTunEntSelectorDstPort=fgVpnTunEntSelectorDstPort, fgHwSensorCount=fgHwSensorCount, fgWcWtpProfileRadioApScan=fgWcWtpProfileRadioApScan, fgHaStatsIdsCount=fgHaStatsIdsCount, fgIntrusionPrevtObjectGroup=fgIntrusionPrevtObjectGroup, fgApIMAPStatsEntry=fgApIMAPStatsEntry, fgSystemObjectGroup=fgSystemObjectGroup, fgVpnSslStatsMaxWebSessions=fgVpnSslStatsMaxWebSessions, fgt400D=fgt400D, fgProcessorFnNP2=fgProcessorFnNP2, fgSysUpTime=fgSysUpTime, fgWebfilterTables=fgWebfilterTables, fgUsbModemInfo=fgUsbModemInfo, fgExplicitProxyBlockedDLP=fgExplicitProxyBlockedDLP, fgt30DPOE=fgt30DPOE, fgWcWlanStationCount=fgWcWlanStationCount, fgSoftwareObjectGroup=fgSoftwareObjectGroup, fgAppIMStatsEntry=fgAppIMStatsEntry, fgAppProxySMTP=fgAppProxySMTP, fgAvVirusDetected=fgAvVirusDetected, fgFc=fgFc, fgAdminTable=fgAdminTable, fgVpn=fgVpn, fgWcWtpConfigRadioApScan=fgWcWtpConfigRadioApScan, fgApHTTPStatsEntry=fgApHTTPStatsEntry, fgFwPol6ID=fgFwPol6ID, fgAvTrapObjects=fgAvTrapObjects, fgProcModOther=fgProcModOther, fgWanOptTunnels=fgWanOptTunnels, fgt3240C=fgt3240C, fgIntfTables=fgIntfTables, fgUsbportProdId=fgUsbportProdId, fgLinkMonitorPacketSend=fgLinkMonitorPacketSend, fgWcWtpProfileRadioFrequencyHandoff=fgWcWtpProfileRadioFrequencyHandoff, fgt60D=fgt60D, fgFwPolInfo=fgFwPolInfo, fgInetProto=fgInetProto, fgWanOptDiskUsage=fgWanOptDiskUsage, fgWcWtpSessionWtpIpAddressType=fgWcWtpSessionWtpIpAddressType, fgVpnSslTunnelVdom=fgVpnSslTunnelVdom, fgWfHTTPSBlocked=fgWfHTTPSBlocked, fgSysSes6Rate10=fgSysSes6Rate10, fgWcWlanSecurity=fgWcWlanSecurity, fgHaStatsSesCount=fgHaStatsSesCount, fgSysSes6Rate60=fgSysSes6Rate60, fgApHTTPMaxConnections=fgApHTTPMaxConnections, fgWcWtpConfigWtpProfile=fgWcWtpConfigWtpProfile, fgServerLoadBalance=fgServerLoadBalance, fgWanOptWanTraffic=fgWanOptWanTraffic, fgWanOptDiskLimit=fgWanOptDiskLimit, fgApIMAPMaxConnections=fgApIMAPMaxConnections, fgVdEntCpuUsage=fgVdEntCpuUsage, fgProcessorModules=fgProcessorModules, fgIntfVrrpEntVrIp=fgIntfVrrpEntVrIp, fgAppP2PStatsEntry=fgAppP2PStatsEntry, fgIntfVlanHbCount=fgIntfVlanHbCount, fgWanOptReductionRate=fgWanOptReductionRate, fgVpnSslStatsActiveTunnels=fgVpnSslStatsActiveTunnels, fgProcModSACount=fgProcModSACount, fgVpnTunEntSelectorDstBeginIp=fgVpnTunEntSelectorDstBeginIp, fgVdTable=fgVdTable, fgWanOptWANBytesOut=fgWanOptWANBytesOut, fgSIAdvSesEphemeralLimit=fgSIAdvSesEphemeralLimit, FgHaLBSchedule=FgHaLBSchedule, fwf30D=fwf30D, fgSysInfoAdvMem=fgSysInfoAdvMem, fgWebCacheRequests=fgWebCacheRequests, fgVpnTunEntSelectorProto=fgVpnTunEntSelectorProto, fgHaStatsMasterSerial=fgHaStatsMasterSerial, fgLinkMonitorPacketLoss=fgLinkMonitorPacketLoss, fgTrapHaMemberUp=fgTrapHaMemberUp, fgApSMTPStatsEntry=fgApSMTPStatsEntry, fgApIMAPStatsTable=fgApIMAPStatsTable, fgWcWtpProfileRadioEntry=fgWcWtpProfileRadioEntry, fgFcSwSerial=fgFcSwSerial, fgProcessorModuleTable=fgProcessorModuleTable, fgNotificationGroup=fgNotificationGroup, fgTrapHaStateChange=fgTrapHaStateChange, fgWcStaHost=fgWcStaHost, fgIpsTrapSrcIp=fgIpsTrapSrcIp, fgSIAdvSesClashCount=fgSIAdvSesClashCount, fgWebfilterInfo=fgWebfilterInfo, fgIpSessTable=fgIpSessTable, fgProcModName=fgProcModName, fgSIAdvSesExpCount=fgSIAdvSesExpCount, fgTrapFazDisconnect=fgTrapFazDisconnect, fgWcWtpSessionVapRadioId=fgWcWtpSessionVapRadioId, fgFwPolStatsTable=fgFwPolStatsTable, fgAvIMAPVirusDetected=fgAvIMAPVirusDetected, fgVdEntSesRate=fgVdEntSesRate, fgHaSystemMode=fgHaSystemMode, fgIp6SessStatsTable=fgIp6SessStatsTable, fgProcModIntegrated=fgProcModIntegrated, fgVpnTunEntLocGwyIp=fgVpnTunEntLocGwyIp, fgWcWtpConfigWtpName=fgWcWtpConfigWtpName, fgApPOP3StatsEntry=fgApPOP3StatsEntry, fgUsbModemStatus=fgUsbModemStatus, fgFwPolByteCount=fgFwPolByteCount, fwf90D=fwf90D, fgVdTpMgmtAddrType=fgVdTpMgmtAddrType, fgWcWtpSessionWtpMemoryUsage=fgWcWtpSessionWtpMemoryUsage, fgApPOP3Connections=fgApPOP3Connections, fgExplicitProxyArchNest=fgExplicitProxyArchNest, fgAvIMAPVirusBlocked=fgAvIMAPVirusBlocked, fgWfHTTPBlocked=fgWfHTTPBlocked, fgAppIMFileTransfered=fgAppIMFileTransfered, fgt3000D=fgt3000D, fgAvHTTPVirusDetected=fgAvHTTPVirusDetected, fgTrapIpsFailOpen=fgTrapIpsFailOpen, fgAvSMTPVirusDetected=fgAvSMTPVirusDetected, fgSIAdvSesSyncQFCount=fgSIAdvSesSyncQFCount, fgWcWtpSessionRadioTable=fgWcWtpSessionRadioTable, fgUsbModemId=fgUsbModemId, fgWebCacheUpTime=fgWebCacheUpTime, fgWcWtpConfigVapAll=fgWcWtpConfigVapAll, fgHwSensorEntAlarmStatus=fgHwSensorEntAlarmStatus, fgtVM64AWS=fgtVM64AWS, fgt5001C=fgt5001C, fgFmTrapGroup=fgFmTrapGroup, fgWcWtpConfigRadioTxPowerLevel=fgWcWtpConfigRadioTxPowerLevel, fgProcessorAMD=fgProcessorAMD, fgVpnInfo=fgVpnInfo, fgFwUserName=fgFwUserName, fgDevice=fgDevice, fgIntfVrrps=fgIntfVrrps, fgApFTPReqProcessed=fgApFTPReqProcessed, fgt140P=fgt140P, fgTrapIpsPkgUpdate=fgTrapIpsPkgUpdate, FgWcWtpRadioType=FgWcWtpRadioType, fgWebCacheDiskStatsTable=fgWebCacheDiskStatsTable, fgSystem=fgSystem, fgApNNTPReqProcessed=fgApNNTPReqProcessed, fgVdEntMemUsage=fgVdEntMemUsage, fgExplicitProxyScriptStatsEntry=fgExplicitProxyScriptStatsEntry, fgAppVoIP=fgAppVoIP, fgAvTrapVirName=fgAvTrapVirName, fgWcWtpSessionWtpDaemonUpTime=fgWcWtpSessionWtpDaemonUpTime, fgWcWlanTable=fgWcWlanTable, fgt80CM=fgt80CM, fgt30E=fgt30E, fgUsbportManufacturer=fgUsbportManufacturer, fgWcStaOnline=fgWcStaOnline, fgWanOptWANBytesIn=fgWanOptWANBytesIn, fgtVM64=fgtVM64, fgAdminLcdProtection=fgAdminLcdProtection, fgExplicitProxyAllowedURLs=fgExplicitProxyAllowedURLs, fgVpnTunEntLocGwyPort=fgVpnTunEntLocGwyPort, fgApIMAPReqProcessed=fgApIMAPReqProcessed, fgExplicitProxyArchCorrupt=fgExplicitProxyArchCorrupt, fgApFTPConnections=fgApFTPConnections)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgSysDiskCapacity=fgSysDiskCapacity, FgOpMode=FgOpMode, fgProcessorPktDroppedCount=fgProcessorPktDroppedCount, fgExplicitProxyPolicy=fgExplicitProxyPolicy, FgFwUserAuthType=FgFwUserAuthType, fgMgmt=fgMgmt, fgt3815D=fgt3815D, fgWcWtpProfileRadioChannelWidth=fgWcWtpProfileRadioChannelWidth, fgt200D=fgt200D, FgScanAvDisposition=FgScanAvDisposition, fgUsbModemInfoGroup=fgUsbModemInfoGroup, fgVpnSslStatsEntry=fgVpnSslStatsEntry, fgWcWtpConfigWtpAdmin=fgWcWtpConfigWtpAdmin, fgExplicitProxyRequests=fgExplicitProxyRequests, fgt100D=fgt100D, fgWcWtpConfigRadioAutoTxPowerControl=fgWcWtpConfigRadioAutoTxPowerControl, fgExplicitProxyArchBomb=fgExplicitProxyArchBomb, fgAppIM=fgAppIM, fgWcApSerial=fgWcApSerial, fgFgWfHTTPAllowed=fgFgWfHTTPAllowed, fgExplicitProxyScanStatsTable=fgExplicitProxyScanStatsTable, fgWebCacheRAMLimit=fgWebCacheRAMLimit, fgWcWtpSessionRadioOperatingPower=fgWcWtpSessionRadioOperatingPower, fgProcessorEntry=fgProcessorEntry, fgLinkMonitorLatency=fgLinkMonitorLatency, fgWcWlanStationCapacity=fgWcWlanStationCapacity, fgApNNTPUpTime=fgApNNTPUpTime, fgWcInfoWtpManaged=fgWcInfoWtpManaged, fgt94DPOE=fgt94DPOE, fgApIMStatsEntry=fgApIMStatsEntry, fgWcWtpProfileRadioTable=fgWcWtpProfileRadioTable, fgIp6SessNumber=fgIp6SessNumber, fgExplicitProxyFilteredVBS=fgExplicitProxyFilteredVBS, fgWcWtpTables=fgWcWtpTables, fgWanOptLANBytesOut=fgWanOptLANBytesOut, fgObsoleteAppServicesObjectGroup=fgObsoleteAppServicesObjectGroup, fgWanOptLanInTraffic=fgWanOptLanInTraffic, fgDeviceLastSeen=fgDeviceLastSeen, fgAppProxyIM=fgAppProxyIM, fgIntfVrrpEntVrId=fgIntfVrrpEntVrId, fgAvFTPVirusDetected=fgAvFTPVirusDetected, fgExplicitProxyInfo=fgExplicitProxyInfo, fgMIBCompliance=fgMIBCompliance, fgAdminTables=fgAdminTables, fgProcessorTable=fgProcessorTable, fgt600D=fgt600D, fgProcModProcessorCount=fgProcModProcessorCount, fgHwSensorEntValue=fgHwSensorEntValue, fgHaStatsByteCount=fgHaStatsByteCount, fgt1000D=fgt1000D, fgVpnDialupOutOctets=fgVpnDialupOutOctets, fgAdminIdleTimeout=fgAdminIdleTimeout, fgVpnDialupGateway=fgVpnDialupGateway, fgProcessorModuleTypes=fgProcessorModuleTypes, fgApFTPMaxConnections=fgApFTPMaxConnections, fgFcSwName=fgFcSwName, fgWcWtpProfileRadioChannelBonding=fgWcWtpProfileRadioChannelBonding, fgIntfVrrpEntState=fgIntfVrrpEntState, fgApSIPOtherReq=fgApSIPOtherReq, fgt3200D=fgt3200D, fgWcWtpProfileRadioStationCapacity=fgWcWtpProfileRadioStationCapacity, fgTrapFcSwUp=fgTrapFcSwUp, fgProcessorUserUsage=fgProcessorUserUsage, fgWcWtpProfileRadioAutoTxPowerHigh=fgWcWtpProfileRadioAutoTxPowerHigh, fgVpnTrapObjects=fgVpnTrapObjects, fgExplicitProxyOverriddenURLs=fgExplicitProxyOverriddenURLs, fgVdTables=fgVdTables, fgUsbportVendId=fgUsbportVendId, fgWcStaGroup=fgWcStaGroup, fgHaStatsHostname=fgHaStatsHostname, fgLinkMonitorPacketRecv=fgLinkMonitorPacketRecv, fgFgWfHTTPLogged=fgFgWfHTTPLogged, fgApHTTPConnections=fgApHTTPConnections, fgTrapAvOversizePass=fgTrapAvOversizePass, fgSysVersionIps=fgSysVersionIps, fgFgWfHTTPSExamined=fgFgWfHTTPSExamined, fgWcStaVci=fgWcStaVci, fgFcSwVdom=fgFcSwVdom, fgApIMUpTime=fgApIMUpTime, fgAppVoIPConn=fgAppVoIPConn, fgAdministrationObjectGroup=fgAdministrationObjectGroup, fgProcessorType=fgProcessorType, fgApSIPStatsEntry=fgApSIPStatsEntry, fgt50E=fgt50E, fgFwPolByteCountHc=fgFwPolByteCountHc, fgWanOptWanInTraffic=fgWanOptWanInTraffic, fgWcWtpSessionConnectionState=fgWcWtpSessionConnectionState, fgIps=fgIps, fgHaStatsAvCount=fgHaStatsAvCount, fgUsbportTable=fgUsbportTable, fgApPOP3ReqProcessed=fgApPOP3ReqProcessed, fgVirtualDomain=fgVirtualDomain, fgVdInfo=fgVdInfo, fgExplicitProxyScanStatsEntry=fgExplicitProxyScanStatsEntry, fgWcStaMacAddress=fgWcStaMacAddress, fgWcStaWlan=fgWcStaWlan, fgAvHTTPVirusBlocked=fgAvHTTPVirusBlocked, fgFmTrapConfChange=fgFmTrapConfChange, fgLinkMonitorName=fgLinkMonitorName, fgApIMStatsTable=fgApIMStatsTable, fgWcWtpProfileRadioVaps=fgWcWtpProfileRadioVaps, fgAppSuStatsTable=fgAppSuStatsTable, fgWebCacheBypass=fgWebCacheBypass, fgIpSessToPort=fgIpSessToPort, fgUsbModemNetwork=fgUsbModemNetwork, fgt98DPOE=fgt98DPOE, fgIpsInfo=fgIpsInfo, fgTrapWcApDown=fgTrapWcApDown, fgVpnTunEntVdom=fgVpnTunEntVdom, fgSysSes6Rate1=fgSysSes6Rate1, fgApHTTPStatsTable=fgApHTTPStatsTable, fgt1200D=fgt1200D, fgApNNTPStatsEntry=fgApNNTPStatsEntry, fgWebCacheDisk=fgWebCacheDisk, fgWcWtpSessionWtpLocalIpAddress=fgWcWtpSessionWtpLocalIpAddress, fgVpnSslTunnelBytesOut=fgVpnSslTunnelBytesOut, fgExplicitProxyFilteredOthScript=fgExplicitProxyFilteredOthScript, fgWcStaNoise=fgWcStaNoise, fgVpnSslTunnelIp=fgVpnSslTunnelIp, fgAppProxyFTP=fgAppProxyFTP, fgVpnDialupTimeout=fgVpnDialupTimeout, fgExplicitProxyFilteredJScript=fgExplicitProxyFilteredJScript, fgWcWtpProfileRadioBand=fgWcWtpProfileRadioBand, fgIpSessExp=fgIpSessExp, fgVpnTunTable=fgVpnTunTable, fgWcWlanMeshBackhaul=fgWcWlanMeshBackhaul, fgVpnTunEntRemGwyIp=fgVpnTunEntRemGwyIp, fgIpsIntrusionsDetected=fgIpsIntrusionsDetected, fgHaTables=fgHaTables, fgIntfObjectGroup=fgIntfObjectGroup, fgWcInfoStationCapacity=fgWcInfoStationCapacity, fgManIfMask=fgManIfMask, fgApSIPCallHandling=fgApSIPCallHandling, fgIpSessStatsEntry=fgIpSessStatsEntry, fgVpnSslTunnelSrcIp=fgVpnSslTunnelSrcIp, fgModel=fgModel, fgFcObjectGroup=fgFcObjectGroup, fgVdTpEntry=fgVdTpEntry, fgUsbportVersion=fgUsbportVersion, fgWcStaTable=fgWcStaTable, fgServerLoadBalanceObjectGroup=fgServerLoadBalanceObjectGroup, fgFirewallObjectGroup=fgFirewallObjectGroup, fgAvOversizedDetected=fgAvOversizedDetected, fgProcessorModuleEntry=fgProcessorModuleEntry, fgIpsStatsTable=fgIpsStatsTable, fgExplicitProxyStatsEntry=fgExplicitProxyStatsEntry, fgSysCpuUsage=fgSysCpuUsage, fgWcWtpConfigTable=fgWcWtpConfigTable, fgApIMMemUsage=fgApIMMemUsage, fgApSIPStatsTable=fgApSIPStatsTable, fgAvIMVirusDetected=fgAvIMVirusDetected, fgVpnDialupIndex=fgVpnDialupIndex, fgFwPolLastUsed=fgFwPolLastUsed, fgUsbModemVendor=fgUsbModemVendor, fgWcWtpProfileRadioMode=fgWcWtpProfileRadioMode, fgProcModFnXB2=fgProcModFnXB2, fgDeviceCreated=fgDeviceCreated, fgIntfVlanHbEntState=fgIntfVlanHbEntState, fgAvNNTPVirusBlocked=fgAvNNTPVirusBlocked, fgWcWtpSessionTable=fgWcWtpSessionTable, fgExplicitProxyScanStatsDisp=fgExplicitProxyScanStatsDisp, fgUsbModemSimId=fgUsbModemSimId, fgWcWlanRadiusServer=fgWcWlanRadiusServer, fgWcWtpSessionWtpRegionCode=fgWcWtpSessionWtpRegionCode, fgFgWfHTTPSOverridden=fgFgWfHTTPSOverridden, fgWfHTTPSURLBlocked=fgWfHTTPSURLBlocked, fgWanOptDiskStatsEntry=fgWanOptDiskStatsEntry, fgTrapAvBypass=fgTrapAvBypass, fgIpsStatsEntry=fgIpsStatsEntry, fgVdTpMgmtMask=fgVdTpMgmtMask, fgt280D=fgt280D, fgFgWfHTTPExamined=fgFgWfHTTPExamined, fgProcModDescr=fgProcModDescr, fgWcStaVlanId=fgWcStaVlanId, fgVpnTrapRemoteGateway=fgVpnTrapRemoteGateway, fgFwPolTables=fgFwPolTables, fgHaStatsCpuUsage=fgHaStatsCpuUsage, fgApIMReqProcessed=fgApIMReqProcessed, fgWcInfoWtpCapacity=fgWcInfoWtpCapacity, fgWcWtpProfileRadioAutoTxPowerControl=fgWcWtpProfileRadioAutoTxPowerControl, fgAvStatsEntry=fgAvStatsEntry, fgSysLowMemCapacity=fgSysLowMemCapacity, fgApPOP3MaxConnections=fgApPOP3MaxConnections, fgApIMAPMemUsage=fgApIMAPMemUsage, fgWebCacheDiskHits=fgWebCacheDiskHits, fgFwPolID=fgFwPolID, fgWebCacheRAMMisses=fgWebCacheRAMMisses, fgVdEntHaState=fgVdEntHaState, fgWcWtpSessionWtpBootVersion=fgWcWtpSessionWtpBootVersion, fgSysSes6Count=fgSysSes6Count, fgProcessorCount=fgProcessorCount, fgAvStatsTable=fgAvStatsTable, fgWanOptInfo=fgWanOptInfo, fgIpSessFromPort=fgIpSessFromPort, fgFwUserIndex=fgFwUserIndex, fgVpnTunEntLifeSecs=fgVpnTunEntLifeSecs, fgAppSuFileScanned=fgAppSuFileScanned, fgt800C=fgt800C, fgProcModFnC20=fgProcModFnC20, fgProcModIntegratedNPU=fgProcModIntegratedNPU, fgAppProxyPOP3=fgAppProxyPOP3, fgIpSessVdom=fgIpSessVdom, FgP2PProto=FgP2PProto, fgApSMTPConnections=fgApSMTPConnections, fgFgWfHTTPSLogged=fgFgWfHTTPSLogged, fgSysMemCapacity=fgSysMemCapacity, fgProcessorSysUsage=fgProcessorSysUsage, fgAppP2PProtoEntLastReset=fgAppP2PProtoEntLastReset, fgFwUserAuth=fgFwUserAuth, fgVpnTunEntIndex=fgVpnTunEntIndex, fgIpsAnomalyDetections=fgIpsAnomalyDetections, fgInetProtoInfo=fgInetProtoInfo, fg300MibCompliance=fg300MibCompliance, fgExplicitProxyArchEncrypted=fgExplicitProxyArchEncrypted, fgSIAdvMemEnterKerConsThrsh=fgSIAdvMemEnterKerConsThrsh, fgWanOptObjectGroup=fgWanOptObjectGroup, fgTrapVpnTunDown=fgTrapVpnTunDown, fgAvInfo=fgAvInfo, FgWcWlanSecurityType=FgWcWlanSecurityType, fgSysSesRate10=fgSysSesRate10, fgExplicitProxyBannedWords=fgExplicitProxyBannedWords, fgExplicitProxyMemUsage=fgExplicitProxyMemUsage, fgAppExplicitProxy=fgAppExplicitProxy, FgWanOptProtocols=FgWanOptProtocols, fgAppP2PProtEntBytes=fgAppP2PProtEntBytes, fgVpnDialupInOctets=fgVpnDialupInOctets, fgFwPol6PktCount=fgFwPol6PktCount, fgVpnTunEntSelectorSrcBeginIp=fgVpnTunEntSelectorSrcBeginIp, fgt30D=fgt30D, fgWebCacheDiskLimit=fgWebCacheDiskLimit, fgExplicitProxyUsers=fgExplicitProxyUsers, fgExplicitProxyArchUnsupported=fgExplicitProxyArchUnsupported, fgHaStatsNetUsage=fgHaStatsNetUsage, fgSysSesRate30=fgSysSesRate30, fgVdTpMgmtAddr=fgVdTpMgmtAddr, fgWcStaIdle=fgWcStaIdle, FgWcWlanAuthenticationType=FgWcWlanAuthenticationType, fgHaGroupId=fgHaGroupId, FgAdminPermLevel=FgAdminPermLevel, FgHaState=FgHaState, fgMemCacheLimit=fgMemCacheLimit, fgWcWtpProfileRadioApHandoff=fgWcWtpProfileRadioApHandoff, fgVpnDialupLifetime=fgVpnDialupLifetime, fosVM64=fosVM64, fgApFTPUpTime=fgApFTPUpTime, FgHaMode=FgHaMode, fgSysMgmtVdom=fgSysMgmtVdom, fgHaPriority=fgHaPriority, fgFgWfHTTPBlocked=fgFgWfHTTPBlocked, fgUsbportSerial=fgUsbportSerial, fgWanOptStatsTable=fgWanOptStatsTable, fgSysLowMemUsage=fgSysLowMemUsage, fgAppVoIPStatsTable=fgAppVoIPStatsTable, fgWanOptHistPeriod=fgWanOptHistPeriod)
mibBuilder.exportSymbols("FORTINET-FORTIGATE-MIB", fgt90D=fgt90D, fgHaOverride=fgHaOverride, fgWanOptDiskMisses=fgWanOptDiskMisses, fgIpsIntrusionsBlocked=fgIpsIntrusionsBlocked, fgAvFTPVirusBlocked=fgAvFTPVirusBlocked, FgWcWtpRadioMode=FgWcWtpRadioMode, fgWcWtpSessionRadioBaseBssid=fgWcWtpSessionRadioBaseBssid, fgExplicitProxyFilteredActiveX=fgExplicitProxyFilteredActiveX, fgProcModFnXD4=fgProcModFnXD4, fgSIAdvMemLeaveKerConsThrsh=fgSIAdvMemLeaveKerConsThrsh, fgWcWtpSessionVapTable=fgWcWtpSessionVapTable, fgWcWlanUserGroup=fgWcWlanUserGroup, fgAdminOptions=fgAdminOptions, fgLinkMonitorJitter=fgLinkMonitorJitter, fgProcessorXlr=fgProcessorXlr, fgProcessorIntel=fgProcessorIntel, fgVpnDialupDstAddr=fgVpnDialupDstAddr, fgIntfVrrpEntGrpId=fgIntfVrrpEntGrpId, fgSysSes6Rate30=fgSysSes6Rate30, fgProcModFnFB8=fgProcModFnFB8, fgFmTrapObjectGroup=fgFmTrapObjectGroup, fgVdEntIndex=fgVdEntIndex, fgVpnTrapPhase1Name=fgVpnTrapPhase1Name, fgProcModFnXE2=fgProcModFnXE2, fgSysSesRate1=fgSysSesRate1, fgFwUserTable=fgFwUserTable, fgt80C=fgt80C, fwf81CM=fwf81CM, fgTrapPrefix=fgTrapPrefix, fgWc=fgWc, fgAdminEntry=fgAdminEntry, fgAppIMConnBlocked=fgAppIMConnBlocked, fgApHTTPReqProcessed=fgApHTTPReqProcessed, fgUsbportEntIndex=fgUsbportEntIndex, fgWcWtpSessionRadioCountryString=fgWcWtpSessionRadioCountryString, fgApHTTPMemUsage=fgApHTTPMemUsage, fgTraps=fgTraps, fgUsbModemProduct=fgUsbModemProduct, fgWcWtpProfileRadioChannel=fgWcWtpProfileRadioChannel, fgWanOptDiskHits=fgWanOptDiskHits, fgTrapAvEnterConserve=fgTrapAvEnterConserve, fgWcWtpSessionRadioMode=fgWcWtpSessionRadioMode, fgtVM64KVm=fgtVM64KVm, fgTrapIpsAnomaly=fgTrapIpsAnomaly, fgFgWfHTTPOverridden=fgFgWfHTTPOverridden, fgWcWtpSessionVapSsid=fgWcWtpSessionVapSsid, fgIntfEntVdom=fgIntfEntVdom, fgWcWtpConfigEntry=fgWcWtpConfigEntry, fgApSMTPUpTime=fgApSMTPUpTime, fgSysMemUsage=fgSysMemUsage, fgAppSuIndex=fgAppSuIndex, fgFwPolPktCount=fgFwPolPktCount, fgWcWtpSessionRadioStationCount=fgWcWtpSessionRadioStationCount, fgWcWtpSessionWtpSwVersion=fgWcWtpSessionWtpSwVersion, fgApPOP3UpTime=fgApPOP3UpTime, fgWanOptTrafficStatsTable=fgWanOptTrafficStatsTable, fgSIAdvMemBuffer=fgSIAdvMemBuffer, fgHwSensors=fgHwSensors, fgHwSensorsObjectGroup=fgHwSensorsObjectGroup, fgWanOptLANBytesIn=fgWanOptLANBytesIn, fgDeviceTrapObjects=fgDeviceTrapObjects, fgWcWtpSessionWtpUpTime=fgWcWtpSessionWtpUpTime, fgApFTPStatsTable=fgApFTPStatsTable, fgProcModSessionCount=fgProcModSessionCount, fgWcWtpSessionRadioWtpId=fgWcWtpSessionRadioWtpId, fgt140D=fgt140D, fgIpSessFromAddr=fgIpSessFromAddr, fgAppWanOpt=fgAppWanOpt, fgWcStaSecurity=fgWcStaSecurity, fgApSIPServices=fgApSIPServices, fgAvVirusBlocked=fgAvVirusBlocked, fgVpnSslStatsMaxUsers=fgVpnSslStatsMaxUsers, fgProcModFnF20=fgProcModFnF20, fgApPOP3StatsTable=fgApPOP3StatsTable, fgIntf=fgIntf, fgSoftware=fgSoftware, fgWanOptHistoryStatsEntry=fgWanOptHistoryStatsEntry, fgWcWtpSessionWtpId=fgWcWtpSessionWtpId, fgFortiGuardStatsEntry=fgFortiGuardStatsEntry, fgWcStaChannel=fgWcStaChannel, fgTrapHaSwitch=fgTrapHaSwitch, fgWcWtpConfigRadioEnable=fgWcWtpConfigRadioEnable, fgIntfVlanHbEntIndex=fgIntfVlanHbEntIndex, fgAppP2PProtoEntry=fgAppP2PProtoEntry, fgVpnTunEntry=fgVpnTunEntry, fgVpnTables=fgVpnTables, fgFwPolPktCountHc=fgFwPolPktCountHc, fgWfAppletBlocked=fgWfAppletBlocked, fgWebCacheObjectGroup=fgWebCacheObjectGroup, fgWcWtpSessionWtpIpAddress=fgWcWtpSessionWtpIpAddress, fwf90DPOE=fwf90DPOE, fgVdEntry=fgVdEntry, fgWcWtpConfigRadioBand=fgWcWtpConfigRadioBand, fgAppProxySIP=fgAppProxySIP, fgt3100D=fgt3100D, fgHaStatsSerial=fgHaStatsSerial, fgVpnDialupTable=fgVpnDialupTable, fgIpSessStatsTable=fgIpSessStatsTable, fgProcessors=fgProcessors, fgIntfVlanHbEntSerial=fgIntfVlanHbEntSerial, fgTrapIpsSignature=fgTrapIpsSignature, fgProcModFnCE4=fgProcModFnCE4, fgAppWebCache=fgAppWebCache, fgTrapAvOversizeBlock=fgTrapAvOversizeBlock, fgAppP2PStatsTable=fgAppP2PStatsTable, fgByteCacheRAMUsage=fgByteCacheRAMUsage, fgr90D=fgr90D, fgProcessorContainedIn=fgProcessorContainedIn, fgWcWtpSessionRadioCountryCode=fgWcWtpSessionRadioCountryCode, fgWanOptDiskStatsTable=fgWanOptDiskStatsTable, fgWebCacheDiskMisses=fgWebCacheDiskMisses, fgApIMAPSpamDetected=fgApIMAPSpamDetected, fgWcWtpSessionRadioEntry=fgWcWtpSessionRadioEntry, fgWcStaBandwidthTx=fgWcStaBandwidthTx, fgWebCacheDiskUsage=fgWebCacheDiskUsage, fgTrapDeviceNew=fgTrapDeviceNew, fgHwSensorEntIndex=fgHwSensorEntIndex, fgWebfilterStatsEntry=fgWebfilterStatsEntry, fgIntfTable=fgIntfTable, fgWcWtpSessionRadioOperatingChannel=fgWcWtpSessionRadioOperatingChannel, FgWcWtpRadioId=FgWcWtpRadioId, fgtVM64SVM=fgtVM64SVM, fgIpSessProto=fgIpSessProto, fgt800D=fgt800D, fgHaStatsGlobalChecksum=fgHaStatsGlobalChecksum, fgVpnSslStatsLoginUsers=fgVpnSslStatsLoginUsers, fgExplicitProxyArchMultiPart=fgExplicitProxyArchMultiPart, fgVdEnabled=fgVdEnabled, fgSIAdvMemPageCache=fgSIAdvMemPageCache, PYSNMP_MODULE_ID=fnFortiGateMib, fgt3700DX=fgt3700DX, fgVpnTunEntTimeout=fgVpnTunEntTimeout, fgApIMAPUpTime=fgApIMAPUpTime, fgVpnTunEntSelectorDstEndIp=fgVpnTunEntSelectorDstEndIp, fgSysInfoAdvSessions=fgSysInfoAdvSessions, fgIpsSignatureDetections=fgIpsSignatureDetections, fgFwUserAuthTimeout=fgFwUserAuthTimeout, fgWanOptLanOutTraffic=fgWanOptLanOutTraffic, fgProcessorFnSoc=fgProcessorFnSoc, fwf30E=fwf30E, fgFwPol6StatsTable=fgFwPol6StatsTable, fgFwUserVdom=fgFwUserVdom, fgIpsTrapObjects=fgIpsTrapObjects, fgWcWtpSessionWtpByteRxCount=fgWcWtpSessionWtpByteRxCount, fgFgWfHTTPSBlocked=fgFgWfHTTPSBlocked, fgVpnSslTunnelBytesIn=fgVpnSslTunnelBytesIn, fgWcWlanVlanId=fgWcWlanVlanId, fgProcModMemUsage=fgProcModMemUsage, fgVpnTunnelUpCount=fgVpnTunnelUpCount)
