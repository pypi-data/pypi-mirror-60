...
def pages_for_category(category_name):
    ...
    json_response = requests.get("https://dota2-zh.gamepedia.com/api.php?action=query&list=categorymembers&cmlimit=max&cmprop=title&format=json&cmtitle=Category:%E5%8F%B0%E8%AF%8D").text
