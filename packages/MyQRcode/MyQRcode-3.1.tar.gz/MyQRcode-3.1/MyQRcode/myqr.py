...
import os
from MyQRcode.mylibs import theqrmodule
...
def run(words, version=12, level='H', color=(100, 0, 0), background=False, picture=None, colorized=False, contrast=1.0, brightness=1.0, save_name=None, save_dir=os.getcwd()):
    ...
    def combine(ver, qr_name, bg_name, colorized, contrast, brightness, save_dir, save_name=None):
        from MyQRcode.mylibs.constant import alig_location
    ...
    try:
        ...
        ver, qr_name = theqrmodule.get_qrcode(
            version, level, words, color, background, tempdir)
