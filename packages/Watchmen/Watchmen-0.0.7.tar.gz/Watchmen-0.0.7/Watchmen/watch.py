...
def compare_making_rescreens(*resolution):
    ...
    if leng_reso % 2 == 0:
        ...
        while i < x:
            ...
            time.sleep(1)
            seleniumlib.capture_page_screenshot('../Create rescreens/rescreen_' + str(width) + 'x' + str(height)+'.png')
...
def compare_screen_without_areas(path1, *args):
    ...
    if os.path.exists('../Save Image areas/test_screen.png'):
        os.remove('../Save Image areas/test_screen.png')
