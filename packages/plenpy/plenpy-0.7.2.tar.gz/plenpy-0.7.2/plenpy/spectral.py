...
class SpectralImage(SpectralArray):
    ...
    def get_decimated(self, q: int, **kwargs) -> 'SpectralImage':
        ...
        Returns:
            The downsampled SpectralImage.

        """
        return SpectralImage.from_spectral_array(super().get_decimated(q, **kwargs))

    def get_resampled(self, num: int, **kwargs) -> 'SpectralImage':
        """Resample the SpectralImage using FFT.
        ...
        """
        return SpectralImage.from_spectral_array(super().get_resampled(num, **kwargs))
