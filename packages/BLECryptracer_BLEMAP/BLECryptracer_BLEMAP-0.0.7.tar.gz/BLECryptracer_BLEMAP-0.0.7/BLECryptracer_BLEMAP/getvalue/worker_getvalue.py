...
from ..common.constants import FILENAME,PACKAGE,GETVALUE_CALL,CRYPTO_USE,CRYPTO_IN_GETVALUE,CONFIDENCE_LEVEL_GETVALUE, NET_USE,LOCATION_GETVALUE ,LOCATION_CRYPTO_GETVALUE , NUM_GETVALUE_METHODS, ALL_GETVALUE_METHODS, TIME_TAKEN_GETVALUE
...
class WorkerGetvalue:
    ...
    def analyse_apk(self,filename):    
        ...
        try:
            ...
            output = {FILENAME:filename,PACKAGE:"Error",GETVALUE_CALL:"Error",
                        CRYPTO_USE:"Error", CRYPTO_IN_GETVALUE:"Error",
                         CONFIDENCE_LEVEL_GETVALUE: "Error" , 'NET_USE': "Error" ,LOCATION_GETVALUE: "Error" ,LOCATION_CRYPTO_GETVALUE: "Error" , NUM_GETVALUE_METHODS: "Error" , ALL_GETVALUE_METHODS: "Error", TIME_TAKEN_GETVALUE: str(runtime) }
        ...
        if ((self.androguard_a == None) or 
                ...
                (self.androguard_dx == None)):
            print("Androguard objects were empty")
            runtime = self.elapsed_time()
            output = {FILENAME:filename,PACKAGE:"Error",GETVALUE_CALL:"Error",
                        CRYPTO_USE:"Error", CRYPTO_IN_GETVALUE:"Error",
                         CONFIDENCE_LEVEL_GETVALUE: "Error" , 'NET_USE': "Error" ,LOCATION_GETVALUE: "Error" ,LOCATION_CRYPTO_GETVALUE: "Error" , NUM_GETVALUE_METHODS: "Error" , ALL_GETVALUE_METHODS: "Error", TIME_TAKEN_GETVALUE: str(runtime) }
        ...
        try:
            ...
            if self.found_crypto != True:
                pass
            runtime = self.elapsed_time()
            output = {FILENAME:filename,PACKAGE:apk_package,GETVALUE_CALL:str(self.getvalue),
                        CRYPTO_USE:str(self.crypto), CRYPTO_IN_GETVALUE:str(self.found_crypto),
                         CONFIDENCE_LEVEL_GETVALUE: self.confidence_level ,LOCATION_GETVALUE: str(self.location_getvalue) ,LOCATION_CRYPTO_GETVALUE: str(self.location_ble_crypto)  , NUM_GETVALUE_METHODS: str(self.num_ble_methods) , ALL_GETVALUE_METHODS: str(self.all_ble_methods), TIME_TAKEN_GETVALUE: str(runtime) }
            sess.reset()
            sleep(0.1)
            return output
        except Exception as e:
            print("Exception during initial checks")
            print(sys.exc_info()[2])
            runtime = self.elapsed_time()
            output = {FILENAME:filename,PACKAGE:apk_package,GETVALUE_CALL:"Error",
                        CRYPTO_USE:"Error", CRYPTO_IN_GETVALUE:"Error",
                         CONFIDENCE_LEVEL_GETVALUE: "Error" , 'NET_USE': "Error" ,LOCATION_GETVALUE: "Error" ,LOCATION_CRYPTO_GETVALUE: "Error" , NUM_GETVALUE_METHODS: "Error" , ALL_GETVALUE_METHODS: "Error", TIME_TAKEN_GETVALUE: str(runtime) }
            sess.reset()
            sleep(0.1)
