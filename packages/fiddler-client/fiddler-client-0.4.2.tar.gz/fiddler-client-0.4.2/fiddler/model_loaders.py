...
class TFSavedModel:
    def __init__(
        ...
        :param input_transformation [optional]: This function transforms
            ...
            NOTE: The default input_transformation assumed the model has a
        ...
        sig_def = saved_model.signature_def[
        ...
        with self.sess.as_default():
            for batch_slice in batch_slice_gen:
                feed_dict = {
                    ...
                    for model_input, input_values_tensor
                    in zip(self.input_tensors, input_values_sequence)
                }
