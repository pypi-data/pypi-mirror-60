...
class Stroke(Callback):
    ...
    def __init__(self, model, minweight=-.05, maxweight=.05, volatility_ratio=.05, decay=0.0, index=None, verbose=False):
        self.model = model
    ...
    def on_epoch_end(self, batch, logs=None):
        ...
        if(self.decay > 0.0 and self.vratio > .01 and self.vratio < 1.0):
