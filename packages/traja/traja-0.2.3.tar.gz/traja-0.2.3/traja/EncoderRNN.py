...
#             embedded = nn.datasets.rnn.pack_padded_sequence(embedded, input_lengths, batch_first=True)
#         output, hidden = self.rnn(embedded)
#         if self.variable_lengths:
#             output, _ = nn.datasets.rnn.pad_packed_sequence(output, batch_first=True)
