...
file(GLOB ALL_FILES $ENV{HOME}/ciavelli_packages/*)
foreach(whatever ${ALL_FILES})
    message("Added ${whatever} to prefix path")
    if(IS_DIRECTORY ${whatever})
	list(APPEND CMAKE_PREFIX_PATH ${whatever}/install)
    endif()
endforeach()
...
function(add_git_cmake_project)
    ...
    if(PARSED_ARGS_BRANCH)
	add_custom_target(${PARSED_ARGS_NAME}_dep COMMAND cia -i ${PARSED_ARGS_URL} --branch ${PARSED_ARGS_BRANCH})
    elseif(PARSED_ARGS_COMMIT)
	add_custom_target(${PARSED_ARGS_NAME}_dep COMMAND cia -i ${PARSED_ARGS_URL} --commit ${PARSED_ARGS_COMMIT})
    else()
	add_custom_target(${PARSED_ARGS_NAME}_dep COMMAND cia -i ${PARSED_ARGS_URL})
    endif()
