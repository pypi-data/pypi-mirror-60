...
import numpy as np
from jina.indexer.base import JointIndexer
...
class TestJointIndexer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.exec_yaml_path = os.path.join(dirname, 'yaml', 'base-indexer.yml')
    ...
    def test_add(self):
        mhi = JointIndexer.load_yaml(self.exec_yaml_path)
