...
from jina.encoder.image.onnx import BaseONNXImageEncoder
from jina.preprocessor.base import UnaryPreprocessor, PipelinePreprocessor
from jina.preprocessor.image.resize import ResizeChunkPreprocessor
from jina.preprocessor.image.sliding_window import VanillaSlidingPreprocessor
from jina.proto import jina_pb2, blob2array
...
def img_process_for_test(dirname):
    ...
    pipline_prep1.components = lambda: [UnaryPreprocessor(doc_type=jina_pb2.Document.IMAGE),
