...
def txt_file2pb_docs(fp: TextIO, start_id: int = 0) -> List['jina_pb2.Document']:
...
def line2pb_doc(line: str, doc_id: int = 0, deliminator: str = r'[.。！？!?]+') -> 'jina_pb2.Document':
    doc = jina_pb2.Document()
    doc.doc_id = doc_id
    doc.doc_type = jina_pb2.Document.TEXT
...
for k, v in env_dict[os.environ.get('JINA_ENV_SET', 'idc-165')].items():
