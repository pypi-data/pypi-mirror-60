...
from jina.encoder.base import PipelineEncoder

from jina.executors.base import ExecutorType
from jina.legacy.numeric import PCALocalEncoder
from jina.legacy.numeric import PQEncoder
from jina.legacy.numeric import TFPQEncoder


class foo(metaclass=ExecutorType):
...
class TestYaml(unittest.TestCase):
    ...
    def test_NES_yaml_dump(self):
        self._test_different_encoder_yamlize(JINA, num_bytes=8,
                                             pca_output_dim=32,
                                             cluster_per_byte=8,
                                             port=1,
                                             port_out=2,
    ...
    def test_double_dump(self):
        ...
        b = JINA.load_yaml(self.dump_path)
