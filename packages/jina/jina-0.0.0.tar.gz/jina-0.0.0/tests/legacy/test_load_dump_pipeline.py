...
from jina.encoder.base import BaseEncoder, PipelineEncoder
...
class TestLoadDumpPipeline(unittest.TestCase):
    def setUp(self):
        ...
        self.exec_yaml_path = os.path.join(self.dirname, 'yaml', 'dummy-pipeline.yml')
    ...
    def test_base(self):
        ...
        b = BaseEncoder.load_yaml(self.exec_yaml_path)
