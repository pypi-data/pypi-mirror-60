...
from jina.main.parser import set_grpc_service_parser, set_frontend_parser
from jina.peapods.frontend import FrontendService
from jina.peapods.grpc import GRPCService
...
class DummyServer:
    def __init__(self, bind_address):
        ...
        dummy_pb2_grpc.add_DummyGRPCServiceServicer_to_server(self.JINAServicer(), self.server)
    ...
    class JINAServicer(dummy_pb2_grpc.DummyGRPCServiceServicer):
