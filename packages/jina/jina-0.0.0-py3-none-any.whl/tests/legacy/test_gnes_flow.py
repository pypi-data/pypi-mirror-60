...
from jina.legacy.old_flow import Flow, FlowBuildLevelMismatch
from jina.legacy.old_flow import BaseIndexFlow, BaseQueryFlow


class TestJINAFlow(unittest.TestCase):
