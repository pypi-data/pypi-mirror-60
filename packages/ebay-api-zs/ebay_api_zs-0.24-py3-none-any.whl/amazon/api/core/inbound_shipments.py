...
class InboundShipments(MWS):
    ...
    def get_prep_instructions_for_sku(self, skus=None, country_code=None):
        ...
        data = dict(Action="GetPrepInstructionsForSKU", ShipToCountryCode=country_code,)
    ...
    def get_prep_instructions_for_asin(self, asins=None, country_code=None):
        ...
        data = dict(
            Action="GetPrepInstructionsForASIN", ShipToCountryCode=country_code,
        )
    ...
    def estimate_transport_request(self, shipment_id):
        ...
        """
        data = dict(Action="EstimateTransportRequest", ShipmentId=shipment_id,)
        return self.make_request(data, method="POST")
    ...
    def get_bill_of_lading(self, shipment_id):
        ...
        """
        data = dict(Action="GetBillOfLading", ShipmentId=shipment_id,)
    ...
    def list_inbound_shipment_items(
        self, shipment_id=None, last_updated_after=None, last_updated_before=None,
    ):
        """
