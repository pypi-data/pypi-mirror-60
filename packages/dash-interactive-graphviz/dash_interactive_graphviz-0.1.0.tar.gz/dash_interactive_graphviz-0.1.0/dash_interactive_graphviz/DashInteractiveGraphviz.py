...
- persisted_props (list of a value equal to: 'selected's; default ['selected']): Properties whose user interactions will persist after refreshing the
...
session: window.sessionStorage, data is cleared once the browser quit."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, selected=Component.UNDEFINED, dot_source=Component.UNDEFINED, style=Component.UNDEFINED, fit_button_style=Component.UNDEFINED, fit_button_content=Component.UNDEFINED, persistence=Component.UNDEFINED, persisted_props=Component.UNDEFINED, persistence_type=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'selected', 'dot_source', 'style', 'fit_button_style', 'fit_button_content', 'persistence', 'persisted_props', 'persistence_type']
        self._type = 'DashInteractiveGraphviz'
        self._namespace = 'dash_interactive_graphviz'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'selected', 'dot_source', 'style', 'fit_button_style', 'fit_button_content', 'persistence', 'persisted_props', 'persistence_type']
