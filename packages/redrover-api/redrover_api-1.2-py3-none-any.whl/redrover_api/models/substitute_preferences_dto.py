...
class SubstitutePreferencesDto(object):
    ...
    def __init__(self, favorite_substitutes=None, favorite_substitute_ids=None, blocked_substitutes=None, blocked_substitute_ids=None, local_vars_configuration=None):  # noqa: E501
