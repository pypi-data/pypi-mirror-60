...
class PositionScheduleItemDto(object):
    ...
    def __init__(self, location=None, location_id=None, bell_schedule=None, bell_schedule_id=None, start_period=None, start_period_id=None, end_period=None, end_period_id=None, start_time=None, end_time=None, local_vars_configuration=None):  # noqa: E501
