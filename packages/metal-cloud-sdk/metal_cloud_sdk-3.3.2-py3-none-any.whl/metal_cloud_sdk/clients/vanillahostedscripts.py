...
class VanillaHostedScripts(Client):
	...
	def scripts(self, nUserID, arrScriptsIDs = Non):
	...
	def createScript(self, nUserID, objScrip):
	...
	def updateScript(self, nScriptID, objScrip):
	...
	def deleteScript(self, nScriptI):
	...
	def ownerScriptsIDs(self, nUserI):
