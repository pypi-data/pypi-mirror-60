...
class Guacamole(Client):
	...
	def remote_console_credentials_get(self, strProductType, nInstanceID, strProtocol, objCookies, strAuthenticatorCode, useBSICredential):
	...
	def remote_console_user_cookie_authorize(self, objCookie):
	...
	def remote_console_event_log(self, strProductType, nProductID, nUserI):
	...
	def remote_console_instance_connectivity_check(self, nInstanceI):
	...
	def remote_console_container_hostnames(self, nContainerI):
	...
	def remote_console_container_connectivity_check(self, nContainerI):
