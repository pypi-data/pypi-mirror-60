...
class IPCOrdering2(Client):
	...
	def user_jwt_create_cookie(self, strJWTCookieType, nUserID = None, bIsLoggedIn = False, bJWTRememberLogin = Fals):
	...
	def user_infrastructure_ids_cached(self, nUserID, bRecreateCache = Fals):
