...
class ExtendedAPI(Client):
	...
	def os_asset_create(self, strUserID, objOSAsse):
	...
	def os_assets(self, strUserID, strUserIDOwner = Non):
	...
	def os_asset_get(self, nOSAssetI):
	...
	def os_asset_update(self, nOSAssetID, objOSAsse):
	...
	def os_asset_delete(self, nOSAssetI):
	...
	def os_asset_get_stored_content(self, nOSAssetI):
	...
	def public_api_export_not_authorized_assert_with_params(self, strUnknownResourceTypePara):
	...
	def public_api_export_not_authorized_assert_with_nullable_param(self, strInfrastructureID = Non):
