...
class HealthCheck(Client):
	...
	def instance_debug_all_check(self, nInstanceI):
	...
	def instance_networking_check(self, nInstanceI):
	...
	def instance_networking_san_check(self, nInstanceI):
	...
	def instance_networking_wan_check(self, nInstanceI):
	...
	def instance_iscsi_check(self, nInstanceI):
	...
	def instance_ipmi_check(self, nInstanceI):
	...
	def instance_ssh_and_filesystem_check(self, nInstanceI):
