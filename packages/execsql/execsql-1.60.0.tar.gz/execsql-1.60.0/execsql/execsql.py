...
class AccessDatabase(Database):
	...
	connection_strings = (
						"DRIVER={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=%s;ExtendedAnsiSQL=1;",
...
class CommandList(object):
	...
	def run_and_increment(self):
		...
		if compiling_loop:
			# Don't run this, but save the command or complete the loop and add its commands to the stack.
