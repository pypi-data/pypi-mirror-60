...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.5.0-alpha.1580989437+g8918d6a4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.5.0-alpha.1580989437+g8918d6a4`
                """)
            else:
                raise
