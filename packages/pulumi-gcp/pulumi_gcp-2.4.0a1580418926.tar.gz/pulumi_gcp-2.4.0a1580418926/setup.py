...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.4.0-alpha.1580418926+g765b6fe5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.4.0-alpha.1580418926+g765b6fe5`
                """)
            else:
                raise
