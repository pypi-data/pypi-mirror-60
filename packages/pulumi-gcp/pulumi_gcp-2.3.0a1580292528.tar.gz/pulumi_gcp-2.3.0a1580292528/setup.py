...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.3.0-alpha.1580292528+g75fcb4ca'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.3.0-alpha.1580292528+g75fcb4ca`
                """)
            else:
                raise
