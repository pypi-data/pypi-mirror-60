...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v2.4.0-alpha.1580416413+gafcdb2ad'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v2.4.0-alpha.1580416413+gafcdb2ad`
                """)
            else:
                raise
