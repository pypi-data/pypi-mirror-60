...
class KerasResponse(object):
    ...
    def __init__(self, success=None, error=None, dependencies=None, trained=None, name=None, script=None, minimum_confidence_rating=None, mode=None, visual_layers=None, training_cycles=None, learning_rate=None, local_vars_configuration=None):  # noqa: E501
