...
class Updater:
    ...
    def get_update_information(self, desired_version: str = "latest") -> UpdateInfo:
        ...
        :return:
        """
        response = requests.get(self.config.api_base_url + "/versions/" + self.package['template_version'] + "/updates/" + desired_version,
                                 headers=self.headers)
    ...
    def get_file_list(self, desired_version: str = "latest") -> UpdateFiles:
        ...
        response = requests.get(self.config.api_base_url + "/versions/" + self.package['template_version'] + "/updates/" + desired_version + "/files",
                                 headers=self.headers)
    ...
    def get_updated_file(self, file: FileMeta, desired_version: str = "latest") -> File:
        ...
        :return:
        """
        response = requests.get(self.config.api_base_url + "/versions/" + self.package['template_version'] + "/updates/" + desired_version + "/files/" + file.name,
