...
setup(
    name='jliang-mlflow-transformers-flavor',
    version=version,
    ...
    zip_safe=False,
    author='Jason Liang',
    description='MLflow with Transformers custom flavor',
    ...
    keywords='ml ai transformers serving',
    url='https://github.pie.apple.com/jason-liang4/MLFlow-Transformers-Custom-Flavor'
)
