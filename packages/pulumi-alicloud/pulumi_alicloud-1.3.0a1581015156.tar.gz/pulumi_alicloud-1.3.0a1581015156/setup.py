...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.3.0-alpha.1581015156+gbfa4db4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.3.0-alpha.1581015156+gbfa4db4`
                """)
            else:
                raise
