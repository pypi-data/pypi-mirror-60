...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.2.0-alpha.1580369438+gcc0acf6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.2.0-alpha.1580369438+gcc0acf6`
                """)
            else:
                raise
