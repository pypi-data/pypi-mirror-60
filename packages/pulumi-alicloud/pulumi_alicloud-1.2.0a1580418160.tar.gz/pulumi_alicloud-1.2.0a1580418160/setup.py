...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v1.2.0-alpha.1580418160+g7d3ff55'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v1.2.0-alpha.1580418160+g7d3ff55`
                """)
            else:
                raise
