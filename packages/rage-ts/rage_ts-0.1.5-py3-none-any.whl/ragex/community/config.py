...
rage_x_password = os.environ.get("RAGE_X_PASSWORD")
rage_x_token = os.environ.get("RAGE_X_TOKEN") or uuid.uuid4().hex
...
rage_model_dir = os.environ.get("RAGE_MODEL_DIR", "/app/models")
...
# Stack variables
rage_token = os.environ.get("RAGE_TOKEN", "")
