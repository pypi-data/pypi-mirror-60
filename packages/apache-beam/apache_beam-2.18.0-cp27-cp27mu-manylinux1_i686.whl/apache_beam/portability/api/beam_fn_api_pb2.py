...
_DELAYEDBUNDLEAPPLICATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='requested_time_delay', full_name='org.apache.beam.model.fn_execution.v1.DelayedBundleApplication.requested_time_delay', index=2,
