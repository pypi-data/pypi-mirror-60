...
_STANDARDCODERS_ENUM = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='STATE_BACKED_ITERABLE', index=12, number=9,
