...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        ...
        'db autonomous-database' = 'change-compartment create create-from-backup-id create-from-backup-timestamp create-from-clone data-safe delete generate-wallet get list restore start stop update'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database create-from-backup-id' = 'admin-password autonomous-container-database-id autonomous-database-backup-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-backup-timestamp' = 'admin-password autonomous-container-database-id autonomous-database-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds timestamp wait-for-state wait-interval-seconds whitelisted-ips'
