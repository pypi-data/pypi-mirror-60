...
for data_resolution in ["hst_up"]:
    ...
    aplt_array.array(array=true_deflections_y_2d)
    aplt_array.array(array=difference_y_2d)

    aplt_array.array(array=true_deflections_x_2d)
    aplt_array.array(array=difference_x_2d)
