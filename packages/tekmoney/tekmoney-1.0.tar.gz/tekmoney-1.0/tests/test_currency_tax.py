...
def test_init():
    ...
    assert (currency.net == Currency(1, 'USD')) and (currency.gross == Currency(1, 'USD'))
...
def test_add():
    ...
    assert currency2 + currency1 == CurrencyWithTax(Currency(30, 'USD'), Currency(45, 'USD'))
...
def test_sub():
    ...
    assert currency2 - currency1 == CurrencyWithTax(Currency(20, 'USD'), Currency(30, 'USD'))
    currency3 = currency1 - Currency(5, 'USD')
