...
dumper_0 = dictdumper.JSON(os.path.join(ROOT, 'json', 'test_0.py2.json'))
...
dumper_1 = dictdumper.JSON(os.path.join(ROOT, 'json', 'test_1.py2.json'))
...
dumper_2 = dictdumper.JSON(os.path.join(ROOT, 'json', 'test_2.py2.json'))
...
dumper_3 = dictdumper.JSON(os.path.join(ROOT, 'json', 'test_3.py2.json'))
