...
var responseTimeChart = new LocustLineChart($(".charts-container"), "Response Times (ms)", ["Median Response Time", "95% percentile", "Average Response Time"], "ms");
...
function updateStats() {
    $.get('./stats/requests', function (report) {
        ...
        if (report.state !== "stopped"){
            ...
            responseTimeChart.addValue([report.current_response_time_percentile_50, report.current_response_time_percentile_95, report.current_response_time_average]);
