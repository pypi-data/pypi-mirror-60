...
from pyloopkit.pyloop_parser import (
    parse_report_and_run_with_name, parse_dictionary_from_previous_run
)

# %% CODE DESCRIPTION
codeDescription = (
    "Python implementation of the algorithm used within Tidepool loop"
)
...
#name = "LoopReport3.json"
path = "pyloopkit/example_files/"



def main(args):
    input_file = args.file_path_name
    recommendations=parse_report_and_run_with_name(input_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="The full path including name of the input json file"
    )
