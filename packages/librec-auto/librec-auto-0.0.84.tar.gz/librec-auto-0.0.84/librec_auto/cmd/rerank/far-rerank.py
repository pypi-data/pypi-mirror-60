...
def score_prot(user_profile, helper):
    ...
    # print(helper.protected_set)

    # print("*****************\n")
    # print("user_items="+str(user_items))
    # print("helper.num_prot(user_items)="+str(helper.num_prot(user_items))+"\n")
...
def rerank(userid, user_recs_df, user_profile, helper):
    ...
    #
    #     # print("********************************"+str(user_recs_df.iloc[0:10]))
    #     # if(userid==88):
    #
    #     # if(item not in list(user_recs_df.iloc[0:10].itemid)):
    #     #     print("********************************" + "\n" + str(list(user_recs_df.iloc[0:10].itemid))+"\n")
    #     #     print(str(userid)+","+str(item)+","+str(score)+"\n")
    #
    ...
    # for i in range(10):
    #     output_data.append((userid, int(user_recs_df.iloc[i+40].itemid), user_recs_df.iloc[i+40].score))
...
if __name__ == '__main__':
    ...
    helper = FarHelper()
    helper.protected="new"
    # print(item_feature_df)
