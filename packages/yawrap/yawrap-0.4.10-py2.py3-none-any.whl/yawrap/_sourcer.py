...
from .six import str_types, urlopen, urlparse
from .utils import form_css, is_url, make_place
...
class _DocumentVisitor(_Resource):
    ...
    @classmethod
    def act(cls, page_doc, yawrap_instance):
...
class _ExportToTargetFs(_DocumentVisitor):
    ...
    def _save_as_file(str_content, target_file_path):
        if not os.path.exists(target_file_path):
            ...
            warn_("File: %s already exists, not overwriting." % target_file_path)
