...
def invoke():
    ...
    if static_site_domain is not None:
        create_static_site(project_name, static_site_domain)
...
def create_static_site(project_name: str, domain_name: str):
    ...
    # Deploy the stack.
    create_infrastructure(project_name, domain_name, aws_account, aws_region)
...
def create_infrastructure(project_name: str, static_domain: str, aws_account: str, aws_region: str):
    ...
    assembly = build(project_name, static_domain, aws_account, aws_region)
    result = os.system(f"cdk deploy --app {assembly.directory} --require-approval never")
