...
INTRODUCTION:
    ...
    repeatedly until you have achieve the desired goals.  The same thing is
    true of modern deep learning networks.  When you are working with a new
    data domain, it is likely that you would want to experiment with
    different network layouts that may be a product of your own mind or
    that you may have seen elsewhere in some publication or at some
    webpage.
...
PUBLIC METHODS:
    ...
    (11) show_network_summary()
         ...
         output of each layer in your network. The method has one input
         parameter which is set to the network.
...
INNER CLASSES OF THE MODULE:
    ...
    you can create a custom class for your own network and test within the
    framework provided by the DLStudio module.
