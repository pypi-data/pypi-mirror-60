...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n@cogneed-protos/cogneed-waveform/services/audio_to_waveform.proto\x12\x1a\x61i.cogneed.cloud.speech.v1\".\n\x0fWaveformRequest\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0f\n\x07\x63ontent\x18\x02 \x01(\x0c\"\"\n\x10WaveformResponse\x12\x0e\n\x06return\x18\x01 \x01(\x05\x32|\n\x16WaveformStoringService\x12\x62\n\x05store\x12+.ai.cogneed.cloud.speech.v1.WaveformRequest\x1a,.ai.cogneed.cloud.speech.v1.WaveformResponseB\x1e\n\x1a\x61i.cogneed.cloud.speech.v1P\x01\x62\x06proto3')
)
...
_WAVEFORMRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='return', full_name='ai.cogneed.cloud.speech.v1.WaveformResponse.return', index=0,
