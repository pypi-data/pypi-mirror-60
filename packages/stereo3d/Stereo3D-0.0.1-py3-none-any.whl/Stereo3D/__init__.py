...
class Stereo3D():
    ...
    def __init__(self,left_cal_file,right_cal_file,stereo_camera=None):
        ...
        cv2.createTrackbar("Min disparity", self.cv_window_name_3D , default_min_disp, 1000, self.on_min_disparity_trackbar)
        cv2.createTrackbar("Disparities", self.cv_window_name_3D , default_num_disparities, 30, self.on_num_disparities_trackbar)
        cv2.createTrackbar("Block size", self.cv_window_name_3D , default_block_size, 100, self.on_block_size_trackbar)
        ...
        self.matcher.setSpeckleRange(500)
        self.matcher.setSpeckleWindowSize(0)
