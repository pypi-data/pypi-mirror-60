...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancingv2-targets", "1.22.0", __name__, "aws-elasticloadbalancingv2-targets@1.22.0.jsii.tgz")
