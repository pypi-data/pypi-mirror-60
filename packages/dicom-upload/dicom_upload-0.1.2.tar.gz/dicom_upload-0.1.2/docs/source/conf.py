...
# -*- coding: utf-8 -*-
#
# dicom_upload documentation build configuration file
#
...
_version_py = os.path.join(repo, 'dicom_upload', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'dicom_uploaddoc'
...
latex_documents = [
    (master_doc, 'dicom_upload.tex', 'dicom_upload Documentation',
     'Alice Grosch', 'manual'),
]
