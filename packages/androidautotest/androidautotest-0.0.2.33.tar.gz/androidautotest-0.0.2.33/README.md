...
1.If you connect one Android Phone with your PC, and run for once time, simple wirte as following
```bash
...
<tbody>
<tr><td>log_case001_XXX.txt</td><td>all log output</td></tr>
<tr><td>serial_log_case001_XXX.txt</td><td>adb log output </td></tr>
<tr><td>report_case001_XXX.html</td><td>report of case run</td></tr>
</tbody>
</table>
