...
class PraperClassified:
    ...
    def leave_group_out(self, groups):
        ...
        self.pos_num_ = pos_num
        self.neg_num_ = neg_num
    ...
    def train_test_split_mean_median(self, test_size=0.3, itirations_rate=0.97):
        """ return plot of roc curvs for 12 classifiers
        X: data as nump
        y: labels (binary:{0,1})
        """
    ...
    def train_test_split_mean_median_outliers_drop(self, test_size=0.30, itirations_rate=0.97, contam_post=0.05, contam_neg=0.05):
        """ return plot of roc curvs for 12 classifiers
        X: data as nump
        y: labels (binary:{0,1})
        """
