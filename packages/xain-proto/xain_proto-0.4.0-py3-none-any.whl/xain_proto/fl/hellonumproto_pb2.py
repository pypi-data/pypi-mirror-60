...
# source: xain_proto/fl/hellonumproto.proto
...
NumProtoRequest = _reflection.GeneratedProtocolMessageType('NumProtoRequest', (_message.Message,), {
  ...
  '__module__' : 'xain_proto.fl.hellonumproto_pb2'
