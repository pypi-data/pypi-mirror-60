...
enum : int {
    ...
    SBK_QSYSINFO_SIZES_IDX                                   = 264,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 262,
    SBK_QSYSINFO_MACVERSION_IDX                              = 263,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 265,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 266,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 267,
    SBK_QTEMPORARYDIR_IDX                                    = 268,
    SBK_QTEMPORARYFILE_IDX                                   = 269,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 270,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 272,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 271,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 110,
    SBK_QTEXTCODEC_IDX                                       = 273,
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 274,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 111,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 275,
    SBK_QTEXTDECODER_IDX                                     = 276,
    SBK_QTEXTENCODER_IDX                                     = 277,
    SBK_QTEXTSTREAM_IDX                                      = 278,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 281,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 279,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 282,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 280,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 112,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 283,
    SBK_QTHREAD_IDX                                          = 284,
    SBK_QTHREAD_PRIORITY_IDX                                 = 285,
    SBK_QTHREADPOOL_IDX                                      = 286,
    SBK_QTIME_IDX                                            = 287,
    SBK_QTIMELINE_IDX                                        = 288,
    SBK_QTIMELINE_STATE_IDX                                  = 291,
    SBK_QTIMELINE_DIRECTION_IDX                              = 290,
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 289,
    ...
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 315,
    ...
    SBK_QT_SIZEMODE_IDX                                      = 389,
    SBK_QT_UIEFFECT_IDX                                      = 405,
    SBK_QT_CURSORSHAPE_IDX                                   = 343,
    SBK_QT_TEXTFORMAT_IDX                                    = 395,
    ...
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 404,
    SBK_QT_AXIS_IDX                                          = 332,
    ...
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 402,
    ...
    SBK_QT_WINDOWMODALITY_IDX                                = 409,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 396,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 134,
    SBK_QT_EVENTPRIORITY_IDX                                 = 351,
    SBK_QT_SIZEHINT_IDX                                      = 388,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 408,
    SBK_QT_COORDINATESYSTEM_IDX                              = 341,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 403,
    ...
    SBK_QT_TIMERTYPE_IDX                                     = 399,
    SBK_QT_SCROLLPHASE_IDX                                   = 386,
