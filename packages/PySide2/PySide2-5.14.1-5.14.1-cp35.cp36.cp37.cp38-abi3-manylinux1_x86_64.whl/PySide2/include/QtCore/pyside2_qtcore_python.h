...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 412,
    ...
    SBK_QFILEDEVICE_MEMORYMAPFLAGS_IDX                       = 86,
    SBK_QFILEINFO_IDX                                        = 88,
    SBK_QFILESELECTOR_IDX                                    = 89,
    SBK_QFILESYSTEMWATCHER_IDX                               = 90,
    SBK_QFINALSTATE_IDX                                      = 91,
    SBK_QGENERICARGUMENT_IDX                                 = 139,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 140,
    SBK_QHISTORYSTATE_IDX                                    = 141,
    SBK_QHISTORYSTATE_HISTORYTYPE_IDX                        = 142,
    SBK_QIODEVICE_IDX                                        = 143,
    SBK_QIODEVICE_OPENMODEFLAG_IDX                           = 144,
    SBK_QFLAGS_QIODEVICE_OPENMODEFLAG_IDX                    = 103,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 145,
    SBK_QITEMSELECTION_IDX                                   = 146,
    SBK_QLIST_QITEMSELECTIONRANGE_IDX                        = 146,
    SBK_QITEMSELECTIONMODEL_IDX                              = 147,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 148,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 104,
    SBK_QITEMSELECTIONRANGE_IDX                              = 149,
    SBK_QJSONARRAY_IDX                                       = 150,
    SBK_QJSONDOCUMENT_IDX                                    = 151,
    SBK_QJSONDOCUMENT_DATAVALIDATION_IDX                     = 152,
    ...
    SBK_QLIBRARYINFO_IDX                                     = 158,
    SBK_QLIBRARYINFO_LIBRARYLOCATION_IDX                     = 159,
    SBK_QLINE_IDX                                            = 160,
    SBK_QLINEF_IDX                                           = 161,
    SBK_QLINEF_INTERSECTTYPE_IDX                             = 162,
    SBK_QLOCALE_IDX                                          = 163,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 168,
    SBK_QLOCALE_SCRIPT_IDX                                   = 415,
    SBK_QLOCALE_COUNTRY_IDX                                  = 164,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 169,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 167,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 170,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 106,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 166,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 413,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 165,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 105,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 414,
    SBK_QLOCKFILE_IDX                                        = 171,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 172,
    SBK_QMARGINS_IDX                                         = 173,
    SBK_QMARGINSF_IDX                                        = 174,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 175,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 176,
    SBK_QMETACLASSINFO_IDX                                   = 177,
    SBK_QMETAENUM_IDX                                        = 178,
    SBK_QMETAMETHOD_IDX                                      = 179,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 180,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 181,
    SBK_QMETAOBJECT_IDX                                      = 182,
    SBK_QMETAOBJECT_CALL_IDX                                 = 183,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 184,
    SBK_QMETAPROPERTY_IDX                                    = 185,
    SBK_QMIMEDATA_IDX                                        = 186,
    SBK_QMIMEDATABASE_IDX                                    = 187,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 188,
    SBK_QMIMETYPE_IDX                                        = 189,
    SBK_QMODELINDEX_IDX                                      = 190,
    SBK_QMUTEX_IDX                                           = 191,
    SBK_QMUTEX_RECURSIONMODE_IDX                             = 192,
    SBK_QMUTEXLOCKER_IDX                                     = 193,
    SBK_QOBJECT_IDX                                          = 194,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 195,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 196,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 197,
    SBK_QPAUSEANIMATION_IDX                                  = 198,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 199,
    SBK_QPLUGINLOADER_IDX                                    = 200,
    SBK_QPOINT_IDX                                           = 201,
    SBK_QPOINTF_IDX                                          = 202,
    SBK_QPROCESS_IDX                                         = 203,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 208,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 209,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 206,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 207,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 205,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 204,
    SBK_QPROCESSENVIRONMENT_IDX                              = 210,
    SBK_QPROPERTYANIMATION_IDX                               = 211,
    SBK_QRANDOMGENERATOR_IDX                                 = 212,
    SBK_QRANDOMGENERATOR64_IDX                               = 213,
    SBK_QREADLOCKER_IDX                                      = 214,
    SBK_QREADWRITELOCK_IDX                                   = 215,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 216,
    SBK_QRECT_IDX                                            = 217,
    SBK_QRECTF_IDX                                           = 218,
    SBK_QRECURSIVEMUTEX_IDX                                  = 219,
    SBK_QREGEXP_IDX                                          = 220,
    SBK_QREGEXP_PATTERNSYNTAX_IDX                            = 222,
    SBK_QREGEXP_CARETMODE_IDX                                = 221,
    SBK_QREGULAREXPRESSION_IDX                               = 223,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 226,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 108,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 225,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 224,
    ...
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 109,
    SBK_QSTATE_IDX                                           = 251,
    SBK_QSTATE_CHILDMODE_IDX                                 = 252,
    SBK_QSTATE_RESTOREPOLICY_IDX                             = 253,
    SBK_QSTATEMACHINE_IDX                                    = 254,
    SBK_QSTATEMACHINE_EVENTPRIORITY_IDX                      = 256,
    SBK_QSTATEMACHINE_ERROR_IDX                              = 255,
    SBK_QSTATEMACHINE_SIGNALEVENT_IDX                        = 257,
    SBK_QSTATEMACHINE_WRAPPEDEVENT_IDX                       = 258,
    SBK_QSTORAGEINFO_IDX                                     = 259,
    SBK_QSTRINGLISTMODEL_IDX                                 = 260,
    SBK_QSYSINFO_IDX                                         = 261,
    SBK_QSYSINFO_SIZES_IDX                                   = 263,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 262,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 264,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 265,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 266,
    SBK_QTEMPORARYDIR_IDX                                    = 267,
    SBK_QTEMPORARYFILE_IDX                                   = 268,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 269,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 271,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 270,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 110,
    SBK_QTEXTCODEC_IDX                                       = 272,
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 273,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 111,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 274,
    SBK_QTEXTDECODER_IDX                                     = 275,
    SBK_QTEXTENCODER_IDX                                     = 276,
    SBK_QTEXTSTREAM_IDX                                      = 277,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 280,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 278,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 281,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 279,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 112,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 282,
    SBK_QTHREAD_IDX                                          = 283,
    SBK_QTHREAD_PRIORITY_IDX                                 = 284,
    SBK_QTHREADPOOL_IDX                                      = 285,
    SBK_QTIME_IDX                                            = 286,
    SBK_QTIMELINE_IDX                                        = 287,
    SBK_QTIMELINE_STATE_IDX                                  = 290,
    SBK_QTIMELINE_DIRECTION_IDX                              = 289,
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 288,
    SBK_QTIMEZONE_IDX                                        = 291,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 294,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 292,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 293,
    SBK_QTIMER_IDX                                           = 295,
    SBK_QTIMEREVENT_IDX                                      = 296,
    SBK_QTRANSLATOR_IDX                                      = 297,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 298,
    SBK_QURL_IDX                                             = 299,
    SBK_QURL_PARSINGMODE_IDX                                 = 301,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 302,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 300,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 113,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 303,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 115,
    SBK_QURLQUERY_IDX                                        = 304,
    SBK_QUUID_IDX                                            = 305,
    SBK_QUUID_VARIANT_IDX                                    = 307,
    SBK_QUUID_VERSION_IDX                                    = 308,
    SBK_QUUID_STRINGFORMAT_IDX                               = 306,
    SBK_QVARIANTANIMATION_IDX                                = 309,
    SBK_QVERSIONNUMBER_IDX                                   = 310,
    SBK_QWAITCONDITION_IDX                                   = 311,
    SBK_QWRITELOCKER_IDX                                     = 312,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 313,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 314,
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 314,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 315,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 316,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 317,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 318,
    SBK_QXMLSTREAMREADER_IDX                                 = 319,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 322,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 321,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 320,
    SBK_QXMLSTREAMWRITER_IDX                                 = 323,
    SBK_QtCoreQT_IDX                                         = 324,
    SBK_QT_GLOBALCOLOR_IDX                                   = 358,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 369,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 127,
    SBK_QT_MODIFIER_IDX                                      = 373,
    SBK_QT_MOUSEBUTTON_IDX                                   = 374,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 129,
    SBK_QT_ORIENTATION_IDX                                   = 379,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 131,
    SBK_QT_FOCUSPOLICY_IDX                                   = 353,
    ...
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 327,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 361,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 123,
    SBK_QT_BGMODE_IDX                                        = 332,
    SBK_QT_KEY_IDX                                           = 368,
    SBK_QT_ARROWTYPE_IDX                                     = 329,
    SBK_QT_PENSTYLE_IDX                                      = 382,
    SBK_QT_PENCAPSTYLE_IDX                                   = 380,
    SBK_QT_PENJOINSTYLE_IDX                                  = 381,
    SBK_QT_BRUSHSTYLE_IDX                                    = 333,
    SBK_QT_SIZEMODE_IDX                                      = 388,
    SBK_QT_UIEFFECT_IDX                                      = 404,
    SBK_QT_CURSORSHAPE_IDX                                   = 342,
    SBK_QT_TEXTFORMAT_IDX                                    = 394,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 330,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 345,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 118,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 346,
    SBK_QT_TOOLBARAREA_IDX                                   = 399,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 135,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 400,
    SBK_QT_DATEFORMAT_IDX                                    = 343,
    SBK_QT_TIMESPEC_IDX                                      = 397,
    SBK_QT_DAYOFWEEK_IDX                                     = 344,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 384,
    SBK_QT_CASESENSITIVITY_IDX                               = 334,
    SBK_QT_CORNER_IDX                                        = 341,
    SBK_QT_EDGE_IDX                                          = 348,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 120,
    SBK_QT_CONNECTIONTYPE_IDX                                = 338,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 386,
    SBK_QT_FILLRULE_IDX                                      = 351,
    SBK_QT_MASKMODE_IDX                                      = 371,
    SBK_QT_CLIPOPERATION_IDX                                 = 337,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 366,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 367,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 403,
    SBK_QT_AXIS_IDX                                          = 331,
    SBK_QT_FOCUSREASON_IDX                                   = 354,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 339,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 363,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 125,
    SBK_QT_INPUTMETHODHINT_IDX                               = 362,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 124,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 349,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 401,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 370,
    SBK_QT_ANCHORPOINT_IDX                                   = 326,
    SBK_QT_FINDCHILDOPTION_IDX                               = 352,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 121,
    SBK_QT_DROPACTION_IDX                                    = 347,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 119,
    SBK_QT_CHECKSTATE_IDX                                    = 335,
    SBK_QT_ITEMDATAROLE_IDX                                  = 364,
    SBK_QT_ITEMFLAG_IDX                                      = 365,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 126,
    SBK_QT_MATCHFLAG_IDX                                     = 372,
    ...
    SBK_QT_EVENTPRIORITY_IDX                                 = 350,
    SBK_QT_SIZEHINT_IDX                                      = 387,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 407,
    SBK_QT_COORDINATESYSTEM_IDX                              = 340,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 402,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 136,
    SBK_QT_GESTURESTATE_IDX                                  = 356,
    SBK_QT_GESTURETYPE_IDX                                   = 357,
    SBK_QT_GESTUREFLAG_IDX                                   = 355,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 122,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 377,
    SBK_QT_NAVIGATIONMODE_IDX                                = 378,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 416,
    SBK_QT_TIMERTYPE_IDX                                     = 398,
    SBK_QT_SCROLLPHASE_IDX                                   = 385,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 376,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 375,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 130,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 336,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 359,
    SBK_QCBORKNOWNTAGS_IDX                                   = 30,
    SBK_QCBORSIMPLETYPE_IDX                                  = 33,
    SBK_QTMSGTYPE_IDX                                        = 411,
    SBK_QtCore_IDX_COUNT                                     = 417
};
