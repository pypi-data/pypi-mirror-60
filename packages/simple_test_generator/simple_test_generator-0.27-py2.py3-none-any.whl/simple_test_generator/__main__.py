...
from simple_test_generator.main import save_example_scripts
...
def call_user_function(mod, fn: str):
    try:
        ...
        logger.error(e)
        logger.error(
            f'Error calling function {fn}. Does it exist in {mod} and is it a no-arg function? Otherwise, set one with PYTESTGEN_FUNCTION.'
        )
        sys.exit(1)
...
def main():
    ...
    from simple_test_generator import Recorder, user_function
