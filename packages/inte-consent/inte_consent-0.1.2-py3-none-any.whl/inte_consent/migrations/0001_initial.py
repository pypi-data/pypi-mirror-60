    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[['lg', 'Luganda'], ['ry', 'Runyakitara'], ['en', 'English']], help_text='The language used for the consent process will also be used during data collection.', max_length=25, verbose_name='Language of consent')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_identifier', 'first_name', 'dob', 'initials', 'version'], name='inte_consen_subject_0c8579_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='subjectconsent',
            unique_together={('first_name', 'dob', 'initials', 'version'), ('subject_identifier', 'screening_identifier'), ('subject_identifier', 'version')},
        ),
    ]
