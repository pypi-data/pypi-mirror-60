...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v1.5.0-alpha.1580301557+g81a6ad0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v1.5.0-alpha.1580301557+g81a6ad0`
                """)
            else:
                raise
