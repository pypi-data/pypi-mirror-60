...
def EfficientNet(width_coefficient,
    ...
    efficientnet.add_module('stem',Conv2d_Block((3,3),round_filters(32),strides=2,use_bias=False,auto_pad=True,padding_mode=PaddingMode.zero,normalization='batch',activation='swish',name='stem'))
    b = 0
    ...
    for (i, args) in enumerate(DEFAULT_BLOCKS_ARGS):
        ...
        for j in range(round_repeats(args.pop('repeats'))):
            ...
            b += 1
    efficientnet.add_module('top_conv', Conv2d_Block((1, 1), round_filters(1280), strides=1, use_bias=False, auto_pad=True,  padding_mode=PaddingMode.zero, normalization='batch', activation='swish', name='top_conv'))
...
def EfficientNetB0(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('1bxnoDerzoNfiZZLft4ocD3DAgx4v6aTN',dirname,'efficientnet-b0.pth')
...
def EfficientNetB1(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('1F3BtnAjmDz4G9RS9Q0hqU_K7WWXCni1G',dirname,'efficientnet-b1.pth')
...
def EfficientNetB2(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('1PjqhB7WJasF_hqOwYtSBNSXSGBY-cRLU',dirname,'efficientnet-b2.pth')
...
def EfficientNetB3(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('11tMxdYdFfaEREwnESO4cwjtcoEB42zB_',dirname,'efficientnet-b3.pth')
...
def EfficientNetB4(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('1X4ZOBR_ETRHZJeffJHvCmWTTy9_aW8SP',dirname,'efficientnet-b4.pth')
...
def EfficientNetB5(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('17iTD12G9oW3jYAui84MKtdY4gjd9vpgG',dirname,'efficientnet-b5.pth')
...
def EfficientNetB6(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('1XJrKmcmMObN_nnjP2Z-YH_BQ3img58qF',dirname,'efficientnet-b6.pth')
...
def EfficientNetB7(include_top=True,
    ...
    if input_shape is not None and len(input_shape)==3:
        ...
        input_shape=(3, 528, 528)
    effb7 =EfficientNet(1.8, 2.6, 528, 0.5, model_name='efficientnet-b7',include_top=include_top,num_classes=classes)
    if pretrained==True:
        download_file_from_google_drive('1M2DfvsNPRCWSo_CeXnUCQOR46rvOrhLl',dirname,'efficientnet-b7.pth')
