...
def VGG11(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('1PV9-AwgD1v-JxDRzduOjjGduIR7MDhPW',dirname,'vgg11.pth')
...
def VGG13(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('1wx67gmQ8eHWXs2mhJmNl-t-cFNw7dJ7O',dirname,'vgg13.pth')
...
def VGG16(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('1uXiH5MSy1rvxrHjW4uB9E2BHMM8b0Fwr',dirname,'vgg16.pth')
...
def VGG19(include_top=True,
    ...
    if pretrained==True:
        download_file_from_google_drive('1nqQJLYMzeiUX9hji39-rrBUG42YyjhYg',dirname,'vgg19.pth')
