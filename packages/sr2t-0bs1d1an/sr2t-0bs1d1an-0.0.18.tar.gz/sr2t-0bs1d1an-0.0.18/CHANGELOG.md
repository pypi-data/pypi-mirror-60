...
- Fixed a bug that omitted every first item in each tab of the Critical, High, Medium, Low, Info tabs.
Fixed a bug that messed up the TLS, X509 and HTTP tabs.
...
- Ho ho ho, added arguments to specify your own custom Nessus YAML files for auto classifications, and the Nessus TLS, X.509, and HTTP tables.
