  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'lsst_dd_rtd_theme/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'lsst_dd_rtd_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'lsst_dd_rtd_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      ...
      fonts: ["lsst_dd_rtd_theme/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['lsst_dd_rtd_theme/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
