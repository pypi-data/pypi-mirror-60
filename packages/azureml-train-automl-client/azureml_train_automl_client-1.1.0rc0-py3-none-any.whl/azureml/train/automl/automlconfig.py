...
class AutoMLConfig(object):
    ...
    :param featurization:
        ...
        https://docs.microsoft.com/azure/machine-learning/how-to-create-portal-experiments#advanced-preprocessing-options
    ...
    def __init__(self,
        ...
        # default value is overriden by deprecated preprocess
