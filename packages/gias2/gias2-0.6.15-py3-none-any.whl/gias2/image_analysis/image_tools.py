...
def series_affines(stack, default_patient_position='FFS', invertz=False):
    ...
    index2CoordA12 = index2CoordA[1, 2].copy()
    print(index2CoordA12)
    index2CoordA21 = index2CoordA[2, 1].copy()
    print(index2CoordA21)
    index2CoordA[1, 2] = index2CoordA21
    index2CoordA[2, 1] = index2CoordA12
    print('post diag flip')
    print(index2CoordA)
...
class Scan:
    ...
    def reorder_slices_by_location(self, order, use_slice_location):
        ...
        print('ding1 {}'.format(self.index2CoordA))

        if flipped:
            self.flip_affine_z()

        print('ding2 {}'.format(self.index2CoordA))
