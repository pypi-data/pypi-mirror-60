...
def paramsTest(trainingImage, P1, P2, windowSize, dMax, nSamples, nTrees, minSamplesSplit, haarMode, windowSizeVar=None, repeats=1):
    ...
    for nSamples in nSamplesList:
        for nTrees in nTreesList:
            for minSamplesSplit in minSamplesSplitList:
                ...
                logStr = '%(nS)5i, %(nT)5i, %(minSS)5i, %(err)8.6f, %(std)8.6f\n'%{'nS':nSamples, 'nT':nTrees, 'minSS':minSamplesSplit, 'err':err, 'std':errstd}
                print(logStr)
