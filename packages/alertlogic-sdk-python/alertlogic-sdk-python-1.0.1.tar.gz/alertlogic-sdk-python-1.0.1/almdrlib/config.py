...
class Config():
    ...
    ALERTLOGIC_CONFIG - Location of the configuration file. If not specified, ~/.almdrlib/credentials is used
    ALERTLOGIC_PROFILE - Profile to be used. If not specified [default] section is used
    ...
    def __init__(self, access_key_id=None, secret_key=None, account_id=None,
        ...
        logger.debug(f"Initializing configuration using '{self._config_file}' configuration file")
        ...
        self._global_endpoint = global_endpoint or os.environ.get('ALERTLOGIC_ENDPOINT')
        self._residency = residency or os.environ.get('ALERTLOGIC_RESIDENCY')
        self._account_id = account_id or os.environ.get('ALERTLOGIC_ACCOUNT_ID')
        self._profile = profile or os.environ.get('ALERTLOGIC_PROFILE') or almdrlib.constants.DEFAULT_PROFILE
        ...
        logger.debug(f"Finished configuraiton initialization. access_key_id={self._access_key_id}, account_id={account_id}, global_endpoint={self._global_endpoint}")
    ...
    def _initialize_defaults(self):
        self._global_endpoint = self._global_endpoint or almdrlib.constants.DEFAULT_GLOBAL_ENDPOINT
        self._residency = self._residency or almdrlib.constants.DEFAULT_RESIDENCY
    ...
    def _initialize_config(self):
        ...
        self._residency = self._residency or self._get_config_option('residency', almdrlib.constants.DEFAULT_RESIDENCY)
