...
EBAY_APP_CONFIG_PATH = "ebay/data/ebay-config.json"
EBAY_APP_CONFIG_PATH_YAML = "ebay/data/ebay-config.yaml"
...
ETSY_APP_CONFIG = {
    "app_name": "ZonesmartDev",
    "api_key": "4py6vo5t9n7udunv9a58j09u",
    "secret": "q4ebr76pef",
}
