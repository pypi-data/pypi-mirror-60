    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=15, null=True, unique=True, verbose_name='Мобильный номер')),
                ('username', models.CharField(blank=True, max_length=50, null=True, verbose_name='Юзернейм')),
                ...
                ('ready', models.BooleanField(default=False, verbose_name='Профиль достаточно заполнен')),
