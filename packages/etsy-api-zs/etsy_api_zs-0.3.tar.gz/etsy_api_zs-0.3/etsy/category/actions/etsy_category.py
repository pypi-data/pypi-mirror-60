...
class GetEtsyCategoryTreeVersion(EtsyAction):
    """
    Docs:
    ...
    api_method = "getSellerTaxonomyVersion"
...
class GetEtsyCategories(EtsyAction):
    """
    Docs:
...
class GetEtsyCategoryAspects(EtsyAction):
    """
    Docs:
    https://www.etsy.com/developers/documentation/reference/taxonomynodeproperty#method_gettaxonomynodeproperties
    """

    api_method = "getTaxonomyNodeProperties"
    params = ["taxonomy_id"]

    def get_params(self, taxonomy_id, **kwargs):
        kwargs["taxonomy_id"] = int(taxonomy_id)
