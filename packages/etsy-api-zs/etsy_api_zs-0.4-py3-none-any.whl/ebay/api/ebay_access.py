...
from ebay_oauth.credentialutil import credentialutil
...
class EbayAPIAccess(MarketplaceAPIAccess):
    ...
    def credentials(self):
        if not getattr(self, "credentials_", None):
            credentialutil.load(settings.EBAY_APP_CONFIG_PATH)
            self.credentials_ = credentialutil.get_credentials(self.oauth_env)
