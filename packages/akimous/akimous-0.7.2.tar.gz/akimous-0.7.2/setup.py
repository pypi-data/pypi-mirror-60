...
['akimous',
 ...
 'akimous.modeling.temp.keras.tests',
 'akimous.modeling.temp.keras.tests.docs',
 'akimous.modeling.temp.keras.tests.integration_tests',
 'akimous.modeling.temp.keras.tests.integration_tests.preprocessing',
 'akimous.modeling.temp.keras.tests.keras',
 'akimous.modeling.temp.keras.tests.keras.backend',
 'akimous.modeling.temp.keras.tests.keras.callbacks',
 'akimous.modeling.temp.keras.tests.keras.datasets',
 'akimous.modeling.temp.keras.tests.keras.engine',
 'akimous.modeling.temp.keras.tests.keras.layers',
 'akimous.modeling.temp.keras.tests.keras.legacy',
 'akimous.modeling.temp.keras.tests.keras.utils',
 'akimous.modeling.temp.keras.tests.keras.wrappers',
 'akimous.resources',
...
package_data = \
{'': ['*'],
 'akimous.modeling.temp.keras': ['.git/*',
                                 '.git/hooks/*',
                                 '.git/info/*',
                                 '.git/logs/*',
                                 '.git/logs/refs/heads/*',
