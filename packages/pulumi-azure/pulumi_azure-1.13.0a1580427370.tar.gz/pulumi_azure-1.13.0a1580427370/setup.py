...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.13.0-alpha.1580427370+ga9ebb0a5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.13.0-alpha.1580427370+ga9ebb0a5`
                """)
            else:
                raise
