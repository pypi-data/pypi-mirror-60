...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.12.0-alpha.1580153754+g91bd52df'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.12.0-alpha.1580153754+g91bd52df`
                """)
            else:
                raise
