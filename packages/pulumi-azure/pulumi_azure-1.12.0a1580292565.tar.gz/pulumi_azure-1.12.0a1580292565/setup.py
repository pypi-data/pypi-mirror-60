...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.12.0-alpha.1580292565+gb4d94f1e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.12.0-alpha.1580292565+gb4d94f1e`
                """)
            else:
                raise
