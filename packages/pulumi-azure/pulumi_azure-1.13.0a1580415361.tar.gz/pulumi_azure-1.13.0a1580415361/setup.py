...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.13.0-alpha.1580415361+gef7bfcf8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.13.0-alpha.1580415361+gef7bfcf8`
                """)
            else:
                raise
