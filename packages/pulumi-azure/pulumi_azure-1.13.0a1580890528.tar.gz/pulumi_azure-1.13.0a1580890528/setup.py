...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.13.0-alpha.1580890528+gd49c7cbe'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.13.0-alpha.1580890528+gd49c7cbe`
                """)
            else:
                raise
