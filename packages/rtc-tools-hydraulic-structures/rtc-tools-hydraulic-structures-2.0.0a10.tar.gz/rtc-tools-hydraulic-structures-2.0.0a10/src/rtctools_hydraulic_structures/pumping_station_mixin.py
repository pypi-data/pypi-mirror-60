...
class PumpStatusGoal(Goal):
    ...
    def __init__(self, optimization_problem, pump, minimum_on=None, minimum_off=None,
                 initial_status=True, horizon_status=False):
        ...
        if total_size > 0:
            ...
            if self.size == 1:
                self.target_min = self.target_min[0]
                self.target_max = self.target_max[0]
    ...
    def _psmixin_pump_initial_status_constraints(self, pump: Pump, minimum_on=0, minimum_off=0):
        ...
        if minimum_on > 0.0:
            if hist_on > 0.0 and minimum_on > hist_on:
                ...
                initial_constraints.append((lambda o: o.state_vector(status_sym)[1:max_ind],
                                            np.ones(max_ind - 1),
        ...
        if minimum_on > 0.0:
            ...
            for i in range(1, num_tsteps):
                ...
                horizon_constraints.append(
                    (lambda o: (ca.sum1(o.state_vector(status_sym)[cur_status_inds])
        ...
        if minimum_off > 0.0:
            ...
            for i in range(1, num_tsteps):
                ...
                if len(cur_status_inds) <= 1:
                    ...
                    continue
                horizon_constraints.append(
                    (lambda o: (ca.sum1(1 - o.state_vector(status_sym)[cur_status_inds])
