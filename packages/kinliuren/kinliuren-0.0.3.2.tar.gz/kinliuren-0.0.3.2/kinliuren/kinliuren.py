        ...
        if dayganzhi_yy == "陽":
            try:
                ...
                if find_sike_relations(jieqi, daygangzhi, hourgangzhi)[6] == "反吟八專":
                    ...
                    chuchuan = ["昴星", "虎視", [earth_n_sky_list(jieqi, hourgangzhi).get("酉"), earth_n_sky_list(jieqi, hourgangzhi).get(daygangzhi[1]), earth_n_sky_list(jieqi, hourgangzhi).get(earth_n_sky_list(jieqi, hourgangzhi).get(earth_n_sky_list(jieqi, hourgangzhi).get("酉")))]]
                    return chuchuan
        elif dayganzhi_yy == "陰":
            try:
                if len(res[0]) >= 1:
                ...
                if find_sike_relations(jieqi, daygangzhi, hourgangzhi)[6] == "反吟八專":
                    ...
                    chuchuan = ["昴星","冬蛇掩目", [earth_n_sky_list(jieqi, hourgangzhi).get("酉"), earth_n_sky_list(jieqi, hourgangzhi).get(daygangzhi[1]), earth_n_sky_list(jieqi, hourgangzhi).get(multi_key_dict_get(ganlivezhi, daygangzhi[0]))]]
                    return chuchuan
    else:
        chuchuan = "不適用，或試他法"  
        return chuchuan
...
#print(earth_n_sky_list("立春", "己酉").get("酉"))
#print(find_sike_relations("冬至","乙未", "甲申"))
#print(liuren("立春", "丁丑", "己酉") )
