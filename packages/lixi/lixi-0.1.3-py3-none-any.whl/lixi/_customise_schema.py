...
def execute_customisation_instructions(schema_etree, instructions, outputname=None):
    ...
    Args:
        schema_etree (:obj:`lxml.etree`, required): LIXI schema provided as Pythpn Etree.
        instructions (:obj:`str`, required): Customization instructions provided as a string. Defaults to None.
        outputname (:obj:`str`, optional): Custom schema name used in namespace. Defaults to None.
