...
if DEBUG:
    ALLOWED_HOSTS = ["127.0.0.1", "192.168.1.21", "192.168.1.71"]
else:
...
SOCIALACCOUNT_PROVIDERS = {
    "google": {
        ...
        "ALL": {
            "client_id": "634363448143-681karaevriuhh8d5vgjbjmkaemfbeeb.apps.googleusercontent.com",
            "secret": "GzS-PC3Fer4hcDQpa3BPisma",
            "key": "",
        }
    }
}
