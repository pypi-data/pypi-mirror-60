...
from tensorflow_probability.python.bijectors._numpy.kumaraswamy_cdf import Kumaraswamy
...
from tensorflow_probability.python.bijectors._numpy.weibull_cdf import Weibull
