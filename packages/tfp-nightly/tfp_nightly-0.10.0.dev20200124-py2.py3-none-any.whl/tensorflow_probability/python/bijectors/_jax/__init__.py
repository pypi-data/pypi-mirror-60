...
from tensorflow_probability.python.bijectors._jax.kumaraswamy_cdf import Kumaraswamy
...
from tensorflow_probability.python.bijectors._jax.weibull_cdf import Weibull
