...
def test_push_signal():
    ...
    pull_df = spy.pull(push_df, start='2019-01-01', end='2019-01-05', grid=None)
    ...
    with pytest.raises(ValueError,
        ...
        spy.pull(push_df, start='2019-01-01', end='2019-01-05', grid=None, invalid_values_as=None)

    pull_df = spy.pull(push_df, start='2019-01-01', end='2019-01-05', grid=None, invalid_values_as='INVALID')
    ...
    pull_df = spy.pull(push_df, start='2019-01-01', end='2019-01-05', grid=None, invalid_values_as=-999)
