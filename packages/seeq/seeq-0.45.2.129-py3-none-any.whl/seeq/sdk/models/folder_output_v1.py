...
class FolderOutputV1(object):
    ...
    def created_at(self):
        ...
        The ISO 8601 date of when the folder or workbook was created (YYYY-MM-DDThh:mm:ss.sssssssss±hh:mm)
    ...
    def marked_as_favorite(self):
        ...
        Flag indicating whether this folder or workbook has been marked as a favorite by the current user
    ...
    def owner(self):
        ...
        The owner of this folder or workbook
    ...
    def parent_folder_id(self):
        ...
        The ID of the parent folder which this folder or workbook is a subfolder of
    ...
    def updated_at(self):
        ...
        The ISO 8601 date of when the folder or workbook was updated (YYYY-MM-DDThh:mm:ss.sssssssss±hh:mm)
