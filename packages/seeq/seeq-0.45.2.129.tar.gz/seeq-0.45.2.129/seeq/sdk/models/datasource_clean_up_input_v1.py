...
class DatasourceCleanUpInputV1(object):
    ...
    def __init__(self, item_type_filter=None, sync_token=None):
        """
    ...
    def item_type_filter(self):
        ...
        List of item types on which cleanup will be done. When no filter is specified (empty or null list), all types of items will enter the clean-up process
