...
class ItemAncillaryOutputV1(object):
    ...
    def __init__(self, data_id=None, datasource_class=None, datasource_id=None, description=None, effective_permissions=None, href=None, id=None, is_archived=False, is_redacted=False, items=None, name=None, scoped_to=None, status_message=None, type=None):
        """
