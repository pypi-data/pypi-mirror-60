...
class SeeqItemSelect(ipywidgets.VBox):
    def __init__(
        ...
        item_datasource_name : str
            A default value for the item datasource name
        ...
        show_help : bool, default False
            ...
            top of the widget.
        kwargs
            keyword arguments passed through to the VBox super class
    ...
    def _on_search_click(self, b):
        if _login.client is None or not hasattr(_login.client, 'auth_token') or not _login.client.auth_token:
            ...
            return
        self._result_box.options = ['Searching Seeq...']
        self._result_box.disabled = True
