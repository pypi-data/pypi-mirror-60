...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  epslobpcgsetblocksize_(EPS eps,PetscInt *bs, int *__ierr){
*__ierr = EPSLOBPCGSetBlockSize(
	(EPS)PetscToPointer((eps) ),*bs);
}
SLEPC_EXTERN void PETSC_STDCALL  epslobpcggetblocksize_(EPS eps,PetscInt *bs, int *__ierr){
*__ierr = EPSLOBPCGGetBlockSize(
	(EPS)PetscToPointer((eps) ),bs);
}
SLEPC_EXTERN void PETSC_STDCALL  epslobpcgsetrestart_(EPS eps,PetscReal *restart, int *__ierr){
*__ierr = EPSLOBPCGSetRestart(
	(EPS)PetscToPointer((eps) ),*restart);
}
SLEPC_EXTERN void PETSC_STDCALL  epslobpcggetrestart_(EPS eps,PetscReal *restart, int *__ierr){
*__ierr = EPSLOBPCGGetRestart(
	(EPS)PetscToPointer((eps) ),restart);
}
SLEPC_EXTERN void PETSC_STDCALL  epslobpcgsetlocking_(EPS eps,PetscBool *lock, int *__ierr){
*__ierr = EPSLOBPCGSetLocking(
	(EPS)PetscToPointer((eps) ),*lock);
}
SLEPC_EXTERN void PETSC_STDCALL  epslobpcggetlocking_(EPS eps,PetscBool *lock, int *__ierr){
