...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  epsarnoldisetdelayed_(EPS eps,PetscBool *delayed, int *__ierr){
*__ierr = EPSArnoldiSetDelayed(
	(EPS)PetscToPointer((eps) ),*delayed);
}
SLEPC_EXTERN void PETSC_STDCALL  epsarnoldigetdelayed_(EPS eps,PetscBool *delayed, int *__ierr){
