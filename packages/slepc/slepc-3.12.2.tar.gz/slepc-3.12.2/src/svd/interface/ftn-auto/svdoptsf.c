...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  svdsetimplicittranspose_(SVD svd,PetscBool *impl, int *__ierr){
*__ierr = SVDSetImplicitTranspose(
	(SVD)PetscToPointer((svd) ),*impl);
}
SLEPC_EXTERN void PETSC_STDCALL  svdgetimplicittranspose_(SVD svd,PetscBool *impl, int *__ierr){
*__ierr = SVDGetImplicitTranspose(
	(SVD)PetscToPointer((svd) ),impl);
}
SLEPC_EXTERN void PETSC_STDCALL  svdsettolerances_(SVD svd,PetscReal *tol,PetscInt *maxits, int *__ierr){
*__ierr = SVDSetTolerances(
	(SVD)PetscToPointer((svd) ),*tol,*maxits);
}
SLEPC_EXTERN void PETSC_STDCALL  svdsetdimensions_(SVD svd,PetscInt *nsv,PetscInt *ncv,PetscInt *mpd, int *__ierr){
*__ierr = SVDSetDimensions(
	(SVD)PetscToPointer((svd) ),*nsv,*ncv,*mpd);
}
SLEPC_EXTERN void PETSC_STDCALL  svdsetwhichsingulartriplets_(SVD svd,SVDWhich *which, int *__ierr){
*__ierr = SVDSetWhichSingularTriplets(
	(SVD)PetscToPointer((svd) ),*which);
}
SLEPC_EXTERN void PETSC_STDCALL  svdgetwhichsingulartriplets_(SVD svd,SVDWhich *which, int *__ierr){
*__ierr = SVDGetWhichSingularTriplets(
	(SVD)PetscToPointer((svd) ),which);
}
SLEPC_EXTERN void PETSC_STDCALL  svdsetconvergencetest_(SVD svd,SVDConv *conv, int *__ierr){
*__ierr = SVDSetConvergenceTest(
	(SVD)PetscToPointer((svd) ),*conv);
}
SLEPC_EXTERN void PETSC_STDCALL  svdgetconvergencetest_(SVD svd,SVDConv *conv, int *__ierr){
*__ierr = SVDGetConvergenceTest(
	(SVD)PetscToPointer((svd) ),conv);
}
SLEPC_EXTERN void PETSC_STDCALL  svdsetstoppingtest_(SVD svd,SVDStop *stop, int *__ierr){
*__ierr = SVDSetStoppingTest(
	(SVD)PetscToPointer((svd) ),*stop);
}
SLEPC_EXTERN void PETSC_STDCALL  svdgetstoppingtest_(SVD svd,SVDStop *stop, int *__ierr){
*__ierr = SVDGetStoppingTest(
	(SVD)PetscToPointer((svd) ),stop);
}
SLEPC_EXTERN void PETSC_STDCALL  svdsetfromoptions_(SVD svd, int *__ierr){
*__ierr = SVDSetFromOptions(
	(SVD)PetscToPointer((svd) ));
}
SLEPC_EXTERN void PETSC_STDCALL  svdsettrackall_(SVD svd,PetscBool *trackall, int *__ierr){
*__ierr = SVDSetTrackAll(
	(SVD)PetscToPointer((svd) ),*trackall);
}
SLEPC_EXTERN void PETSC_STDCALL  svdgettrackall_(SVD svd,PetscBool *trackall, int *__ierr){
