...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  svdtrlanczossetoneside_(SVD svd,PetscBool *oneside, int *__ierr){
*__ierr = SVDTRLanczosSetOneSide(
	(SVD)PetscToPointer((svd) ),*oneside);
}
SLEPC_EXTERN void PETSC_STDCALL  svdtrlanczosgetoneside_(SVD svd,PetscBool *oneside, int *__ierr){
