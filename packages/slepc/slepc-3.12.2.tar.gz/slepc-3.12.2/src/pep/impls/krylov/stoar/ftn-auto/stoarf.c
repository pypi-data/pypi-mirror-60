...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  pepstoarsetlocking_(PEP pep,PetscBool *lock, int *__ierr){
*__ierr = PEPSTOARSetLocking(
	(PEP)PetscToPointer((pep) ),*lock);
}
SLEPC_EXTERN void PETSC_STDCALL  pepstoargetlocking_(PEP pep,PetscBool *lock, int *__ierr){
*__ierr = PEPSTOARGetLocking(
	(PEP)PetscToPointer((pep) ),lock);
}
SLEPC_EXTERN void PETSC_STDCALL  pepstoarsetdetectzeros_(PEP pep,PetscBool *detect, int *__ierr){
*__ierr = PEPSTOARSetDetectZeros(
	(PEP)PetscToPointer((pep) ),*detect);
}
SLEPC_EXTERN void PETSC_STDCALL  pepstoargetdetectzeros_(PEP pep,PetscBool *detect, int *__ierr){
*__ierr = PEPSTOARGetDetectZeros(
	(PEP)PetscToPointer((pep) ),detect);
}
SLEPC_EXTERN void PETSC_STDCALL  pepstoarsetlinearization_(PEP pep,PetscReal *alpha,PetscReal *beta, int *__ierr){
*__ierr = PEPSTOARSetLinearization(
	(PEP)PetscToPointer((pep) ),*alpha,*beta);
}
SLEPC_EXTERN void PETSC_STDCALL  pepstoargetlinearization_(PEP pep,PetscReal *alpha,PetscReal *beta, int *__ierr){
*__ierr = PEPSTOARGetLinearization(
	(PEP)PetscToPointer((pep) ),alpha,beta);
}
SLEPC_EXTERN void PETSC_STDCALL  pepstoarsetdimensions_(PEP pep,PetscInt *nev,PetscInt *ncv,PetscInt *mpd, int *__ierr){
*__ierr = PEPSTOARSetDimensions(
	(PEP)PetscToPointer((pep) ),*nev,*ncv,*mpd);
}
SLEPC_EXTERN void PETSC_STDCALL  pepstoargetdimensions_(PEP pep,PetscInt *nev,PetscInt *ncv,PetscInt *mpd, int *__ierr){
*__ierr = PEPSTOARGetDimensions(
	(PEP)PetscToPointer((pep) ),nev,ncv,mpd);
}
SLEPC_EXTERN void PETSC_STDCALL  pepstoarsetcheckeigenvaluetype_(PEP pep,PetscBool *checket, int *__ierr){
*__ierr = PEPSTOARSetCheckEigenvalueType(
	(PEP)PetscToPointer((pep) ),*checket);
}
SLEPC_EXTERN void PETSC_STDCALL  pepstoargetcheckeigenvaluetype_(PEP pep,PetscBool *checket, int *__ierr){
