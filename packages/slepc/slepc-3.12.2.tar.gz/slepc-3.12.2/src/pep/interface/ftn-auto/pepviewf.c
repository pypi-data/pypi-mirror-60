...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  pepreasonviewfromoptions_(PEP pep, int *__ierr){
*__ierr = PEPReasonViewFromOptions(
	(PEP)PetscToPointer((pep) ));
}
SLEPC_EXTERN void PETSC_STDCALL  peperrorviewfromoptions_(PEP pep, int *__ierr){
*__ierr = PEPErrorViewFromOptions(
	(PEP)PetscToPointer((pep) ));
}
SLEPC_EXTERN void PETSC_STDCALL  pepvaluesviewfromoptions_(PEP pep, int *__ierr){
*__ierr = PEPValuesViewFromOptions(
	(PEP)PetscToPointer((pep) ));
}
SLEPC_EXTERN void PETSC_STDCALL  pepvectorsviewfromoptions_(PEP pep, int *__ierr){
