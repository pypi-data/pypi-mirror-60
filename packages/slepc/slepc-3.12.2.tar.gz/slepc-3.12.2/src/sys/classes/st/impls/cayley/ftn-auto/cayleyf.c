...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  stcayleysetantishift_(ST st,PetscScalar *nu, int *__ierr){
*__ierr = STCayleySetAntishift(
	(ST)PetscToPointer((st) ),*nu);
}
SLEPC_EXTERN void PETSC_STDCALL  stcayleygetantishift_(ST st,PetscScalar *nu, int *__ierr){
