...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  bvbiorthogonalizecolumn_(BV V,BV W,PetscInt *j, int *__ierr){
*__ierr = BVBiorthogonalizeColumn(
	(BV)PetscToPointer((V) ),
	(BV)PetscToPointer((W) ),*j);
}
SLEPC_EXTERN void PETSC_STDCALL  bvbiorthonormalizecolumn_(BV V,BV W,PetscInt *j,PetscReal *delta, int *__ierr){
