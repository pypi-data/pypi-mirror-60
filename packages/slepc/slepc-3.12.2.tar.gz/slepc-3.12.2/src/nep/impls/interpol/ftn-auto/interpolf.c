...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  nepinterpolsetinterpolation_(NEP nep,PetscReal *tol,PetscInt *deg, int *__ierr){
*__ierr = NEPInterpolSetInterpolation(
	(NEP)PetscToPointer((nep) ),*tol,*deg);
}
SLEPC_EXTERN void PETSC_STDCALL  nepinterpolgetinterpolation_(NEP nep,PetscReal *tol,PetscInt *deg, int *__ierr){
*__ierr = NEPInterpolGetInterpolation(
	(NEP)PetscToPointer((nep) ),tol,deg);
}
SLEPC_EXTERN void PETSC_STDCALL  nepinterpolsetpep_(NEP nep,PEP pep, int *__ierr){
*__ierr = NEPInterpolSetPEP(
	(NEP)PetscToPointer((nep) ),
	(PEP)PetscToPointer((pep) ));
}
SLEPC_EXTERN void PETSC_STDCALL  nepinterpolgetpep_(NEP nep,PEP *pep, int *__ierr){
