...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  nepnleigssetrestart_(NEP nep,PetscReal *keep, int *__ierr){
*__ierr = NEPNLEIGSSetRestart(
	(NEP)PetscToPointer((nep) ),*keep);
}
SLEPC_EXTERN void PETSC_STDCALL  nepnleigsgetrestart_(NEP nep,PetscReal *keep, int *__ierr){
*__ierr = NEPNLEIGSGetRestart(
	(NEP)PetscToPointer((nep) ),keep);
}
SLEPC_EXTERN void PETSC_STDCALL  nepnleigssetlocking_(NEP nep,PetscBool *lock, int *__ierr){
*__ierr = NEPNLEIGSSetLocking(
	(NEP)PetscToPointer((nep) ),*lock);
}
SLEPC_EXTERN void PETSC_STDCALL  nepnleigsgetlocking_(NEP nep,PetscBool *lock, int *__ierr){
*__ierr = NEPNLEIGSGetLocking(
	(NEP)PetscToPointer((nep) ),lock);
}
SLEPC_EXTERN void PETSC_STDCALL  nepnleigssetinterpolation_(NEP nep,PetscReal *tol,PetscInt *degree, int *__ierr){
*__ierr = NEPNLEIGSSetInterpolation(
	(NEP)PetscToPointer((nep) ),*tol,*degree);
}
SLEPC_EXTERN void PETSC_STDCALL  nepnleigsgetinterpolation_(NEP nep,PetscReal *tol,PetscInt *degree, int *__ierr){
*__ierr = NEPNLEIGSGetInterpolation(
	(NEP)PetscToPointer((nep) ),tol,degree);
}
SLEPC_EXTERN void PETSC_STDCALL  nepnleigssetrkshifts_(NEP nep,PetscInt *ns,PetscScalar shifts[], int *__ierr){
*__ierr = NEPNLEIGSSetRKShifts(
	(NEP)PetscToPointer((nep) ),*ns,shifts);
}
SLEPC_EXTERN void PETSC_STDCALL  nepnleigssetfullbasis_(NEP nep,PetscBool *fullbasis, int *__ierr){
*__ierr = NEPNLEIGSSetFullBasis(
	(NEP)PetscToPointer((nep) ),*fullbasis);
}
SLEPC_EXTERN void PETSC_STDCALL  nepnleigsgetfullbasis_(NEP nep,PetscBool *fullbasis, int *__ierr){
