...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  nepriisetmaximumiterations_(NEP nep,PetscInt *its, int *__ierr){
*__ierr = NEPRIISetMaximumIterations(
	(NEP)PetscToPointer((nep) ),*its);
}
SLEPC_EXTERN void PETSC_STDCALL  nepriigetmaximumiterations_(NEP nep,PetscInt *its, int *__ierr){
*__ierr = NEPRIIGetMaximumIterations(
	(NEP)PetscToPointer((nep) ),its);
}
SLEPC_EXTERN void PETSC_STDCALL  nepriisetlagpreconditioner_(NEP nep,PetscInt *lag, int *__ierr){
*__ierr = NEPRIISetLagPreconditioner(
	(NEP)PetscToPointer((nep) ),*lag);
}
SLEPC_EXTERN void PETSC_STDCALL  nepriigetlagpreconditioner_(NEP nep,PetscInt *lag, int *__ierr){
*__ierr = NEPRIIGetLagPreconditioner(
	(NEP)PetscToPointer((nep) ),lag);
}
SLEPC_EXTERN void PETSC_STDCALL  nepriisetconstcorrectiontol_(NEP nep,PetscBool *cct, int *__ierr){
*__ierr = NEPRIISetConstCorrectionTol(
	(NEP)PetscToPointer((nep) ),*cct);
}
SLEPC_EXTERN void PETSC_STDCALL  nepriigetconstcorrectiontol_(NEP nep,PetscBool *cct, int *__ierr){
*__ierr = NEPRIIGetConstCorrectionTol(
	(NEP)PetscToPointer((nep) ),cct);
}
SLEPC_EXTERN void PETSC_STDCALL  nepriisetksp_(NEP nep,KSP ksp, int *__ierr){
*__ierr = NEPRIISetKSP(
	(NEP)PetscToPointer((nep) ),
	(KSP)PetscToPointer((ksp) ));
}
SLEPC_EXTERN void PETSC_STDCALL  nepriigetksp_(NEP nep,KSP *ksp, int *__ierr){
*__ierr = NEPRIIGetKSP(
