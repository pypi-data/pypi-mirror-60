...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  epsblopexsetblocksize_(EPS eps,PetscInt *bs, int *__ierr){
*__ierr = EPSBLOPEXSetBlockSize(
	(EPS)PetscToPointer((eps) ),*bs);
}
SLEPC_EXTERN void PETSC_STDCALL  epsblopexgetblocksize_(EPS eps,PetscInt *bs, int *__ierr){
