...
SLEPC_EXTERN void PETSC_STDCALL  epsblzpackgetblocksize_(EPS eps,PetscInt *bs, int *__ierr){
...
SLEPC_EXTERN void PETSC_STDCALL  epsblzpackgetnsteps_(EPS eps,PetscInt *nsteps, int *__ierr){
