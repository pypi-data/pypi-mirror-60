...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  epsreasonviewfromoptions_(EPS eps, int *__ierr){
*__ierr = EPSReasonViewFromOptions(
	(EPS)PetscToPointer((eps) ));
}
SLEPC_EXTERN void PETSC_STDCALL  epserrorviewfromoptions_(EPS eps, int *__ierr){
*__ierr = EPSErrorViewFromOptions(
	(EPS)PetscToPointer((eps) ));
}
SLEPC_EXTERN void PETSC_STDCALL  epsvaluesviewfromoptions_(EPS eps, int *__ierr){
*__ierr = EPSValuesViewFromOptions(
	(EPS)PetscToPointer((eps) ));
}
SLEPC_EXTERN void PETSC_STDCALL  epsvectorsviewfromoptions_(EPS eps, int *__ierr){
