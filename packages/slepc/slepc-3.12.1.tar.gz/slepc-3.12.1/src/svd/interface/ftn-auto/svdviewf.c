...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  svdreasonviewfromoptions_(SVD svd, int *__ierr){
*__ierr = SVDReasonViewFromOptions(
	(SVD)PetscToPointer((svd) ));
}
SLEPC_EXTERN void PETSC_STDCALL  svderrorviewfromoptions_(SVD svd, int *__ierr){
*__ierr = SVDErrorViewFromOptions(
	(SVD)PetscToPointer((svd) ));
}
SLEPC_EXTERN void PETSC_STDCALL  svdvaluesviewfromoptions_(SVD svd, int *__ierr){
*__ierr = SVDValuesViewFromOptions(
	(SVD)PetscToPointer((svd) ));
}
SLEPC_EXTERN void PETSC_STDCALL  svdvectorsviewfromoptions_(SVD svd, int *__ierr){
