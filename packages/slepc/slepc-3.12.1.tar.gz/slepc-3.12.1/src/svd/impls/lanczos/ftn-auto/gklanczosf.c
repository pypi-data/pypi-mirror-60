...
extern "C" {
#endif
SLEPC_EXTERN void PETSC_STDCALL  svdlanczossetoneside_(SVD svd,PetscBool *oneside, int *__ierr){
*__ierr = SVDLanczosSetOneSide(
	(SVD)PetscToPointer((svd) ),*oneside);
}
SLEPC_EXTERN void PETSC_STDCALL  svdlanczosgetoneside_(SVD svd,PetscBool *oneside, int *__ierr){
