...
class TrainingPipelineSchema(object):
    ...
    def __init__(self, config_file_path=None, created_at=None, created_by=None, id=None, last_run_at=None, model_id=None, name=None, object='trainingPipeline', password=None, pipeline_name=None, ref=None, secret_names=None, source=None, updated_at=None, uri=None, username=None, **kwargs):  # noqa: E501
    ...
    @classmethod
    def from_response(cls, config_file_path=None, created_at=None, created_by=None, id=None, last_run_at=None, model_id=None, name=None, object='trainingPipeline', password=None, pipeline_name=None, ref=None, secret_names=None, source=None, updated_at=None, uri=None, username=None, **kwargs):  # noqa: E501
