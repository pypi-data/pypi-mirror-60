...
def bacteria():
    ...
    return parse('bacteria.csv.gz').set_index('scientific_name')


def virus():
    """Return a pandas dataframe of viral annotations."""
    return parse('viruses.csv.gz').set_index('scientific_name')


def eukaryote():
    """Return a pandas dataframe of eukaryotic annotations."""
    return parse('eukaryota.csv.gz').set_index('scientific_name')
