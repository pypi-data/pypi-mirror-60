...
try:
    with io.open(os.path.join(here, "docs", "README.md"), encoding="utf-8") as readme_file:
        readme = readme_file.read()

    with io.open(os.path.join(here, "docs", "HISTORY.md"), encoding="utf-8") as history_file:
