...
class Messages(object):
    ...
    def send(self, message, send_async=False, ip_pool=None, send_at=None, **kwargs):
        ...
        Raises:
           ...
           Error: A general Mandrill error has occurred
        """
        _params = {'message': message, 'async': _async_param(send_async, kwargs), 'ip_pool': ip_pool, 'send_at': send_at}
        return self.master.call('messages/send', _params)

    def send_template(self, template_name, template_content, message, send_async=False, ip_pool=None, send_at=None, **kwargs):
        ...
        Raises:
           ...
           Error: A general Mandrill error has occurred
        """
        _params = {'template_name': template_name, 'template_content': template_content, 'message': message, 'async': _async_param(send_async, kwargs), 'ip_pool': ip_pool, 'send_at': send_at}
    ...
    def send_raw(self, raw_message, from_email=None, from_name=None, to=None, send_async=False, ip_pool=None, send_at=None, return_path_domain=None, **kwargs):
        ...
        Raises:
           ...
           Error: A general Mandrill error has occurred
        """
        _params = {'raw_message': raw_message, 'from_email': from_email, 'from_name': from_name, 'to': to, 'async': _async_param(send_async, kwargs), 'ip_pool': ip_pool, 'send_at': send_at, 'return_path_domain': return_path_domain}
...
def _async_param(send_async, kwargs):
    if 'async' in kwargs:
        from warnings import warn
        warn(
            'The async parameter is deprecated and will be removed in '
            'a future release. Please use the send_async paramter instead.',
            DeprecationWarning,
            stacklevel=3)
        return kwargs['async']
    return send_async
