...
# python setup.py build_sphinx
# updates documentation at http://packages.python.org/affo-user-service/
try:
...
with open("affo_user_service/__init__.py", "rb") as f:
...
setup(
    name="affo-user-service",
    version=version,
    description="",
    long_description=long_description,
    long_description_content_type="text/x-rst",
    url="https://github.com/affoio/affo-user-service",
    ...
    entry_points={"console_scripts": ["affo-user-service = affo_user_service.cli:manager.run"]},
)
