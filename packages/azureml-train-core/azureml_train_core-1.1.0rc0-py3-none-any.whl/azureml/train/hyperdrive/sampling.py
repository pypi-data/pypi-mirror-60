...
class RandomParameterSampling(HyperParameterSampling):
    ...
    .. remarks::
        ...
        <https://docs.microsoft.com/azure/machine-learning/service/how-to-tune-hyperparameters#define-search-space>`__.
    ...
    def _bayesian_quniform_validator(quniform_definition):
        ...
        for item in choice_values:
            if type(item) not in [int]:
                return False, "Expected quniform arguments to be int. Got {}".format(type(item))
