...
#     # default is to not replace contact info from parsed data but can be changed.
#     attachments = []
#     attachment_id = upload_resume_to_candidate_profile(candidate_id, file)
#     attachments.append(attachment_id)
#     parse_result = import_resume_from_attachment(
#         candidate_id,
#         attachment_id,
#         replace_contact_info=replace_contact_info,
#         update_education=update_education,
#         update_skills=update_skills
#     )
#     if with_copy:
