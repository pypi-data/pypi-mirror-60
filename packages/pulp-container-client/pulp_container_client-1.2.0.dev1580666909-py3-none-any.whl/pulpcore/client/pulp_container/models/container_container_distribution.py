...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, pulp_href=None, content_guard=None, base_path=None, name=None, pulp_created=None, repository_version=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
