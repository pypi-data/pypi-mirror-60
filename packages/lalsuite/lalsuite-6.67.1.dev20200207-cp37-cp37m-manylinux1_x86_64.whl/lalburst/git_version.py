...
id = "0c926ce9bea93a51f64b894f6ebb9591067a5cf2"
date = "2020-02-6 21:11:45 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "0c926ce9bea93a51f64b894f6ebb9591067a5cf2":
        return
    msg = "Program id (0c926ce9bea93a51f64b894f6ebb9591067a5cf2) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
