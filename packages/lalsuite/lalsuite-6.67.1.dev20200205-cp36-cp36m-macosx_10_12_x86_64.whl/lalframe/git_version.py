...
id = "a1803006e4c754c9a947e3e2fb7ce2d58193e630"
date = "2020-02-4 14:46:05 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "a1803006e4c754c9a947e3e2fb7ce2d58193e630":
        return
    msg = "Program id (a1803006e4c754c9a947e3e2fb7ce2d58193e630) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
