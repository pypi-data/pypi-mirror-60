...
id = "516948f470010b378bde6f6b051c8feecdea2d62"
date = "2020-01-31 18:22:12 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "516948f470010b378bde6f6b051c8feecdea2d62":
        return
    msg = "Program id (516948f470010b378bde6f6b051c8feecdea2d62) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
