...
id = "cac7e583e874c558c5e4bece3e05d1efc751491d"
date = "2020-01-22 13:46:36 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "cac7e583e874c558c5e4bece3e05d1efc751491d":
        return
    msg = "Program id (cac7e583e874c558c5e4bece3e05d1efc751491d) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
