...
from exonum_client_cis import ExonumClient
from exonum_client_cis.api import ServiceApi
from exonum_client_cis.module_manager import ModuleManager
...
class Supervisor:
    ...
    def initialize(self) -> None:
        ...
        self._service_module = ModuleManager.import_service_module_by_full_name(self._supervisor_artifact_name, "service")
    ...
    def _post_to_supervisor(self, endpoint: str, message: bytes, private: bool = True) -> List[str]:
        ...
        for client in self._clients:
            service_api = ServiceApi("supervisor", client.hostname, client.private_api_port, client.schema)
            response = service_api.post_service(endpoint, data)
