...
DEFAULT_CONFIG_PATH = os.path.join(util.FLYWHEEL_USER_HOME, '.config/flywheel/cli.cfg')
CLI_LOG_PATH = os.path.join(util.FLYWHEEL_USER_HOME, '.cache/flywheel/logs/cli.log')
