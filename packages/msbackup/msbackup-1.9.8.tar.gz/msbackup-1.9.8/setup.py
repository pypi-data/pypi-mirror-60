...
setup(
    ...
    version=read(here, 'src', 'msbackup', 'VERSION'),

    description='Generic backup utility.',
    long_description=read(here, 'README.rst'),

    # The project's main home page.
    url='https://dev.mousesoft.site/redmine/projects/msbackup',

    # Author details
    author='Aleksei Badiaev',
    author_email='aleksei.badiaev@mousesoft.site',
