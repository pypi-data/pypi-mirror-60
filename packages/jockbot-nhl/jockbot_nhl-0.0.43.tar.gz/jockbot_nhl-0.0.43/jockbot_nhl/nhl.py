...
class NHL:
    ...
    def get_team_info(self, team_id=None, team_name=None):
        ...
        if team_id not in [87, 88, 89, 90, 7460, 7461]:
...
class NHLTeam(NHL):
    ...
    def __init__(self, team=None):
        ...
        self.conference = self.info['conference'].get('name', 'all-star')
        self.division = self.info['division'].get('name', 'all-star')
    ...
    def get_all_games(self):
        return _parse_team_games(self.get_team_schedule(team_id=self.id))
