...
class TestNHL(unittest.TestCase):
    ...
    def test_nhl(self):
        wildcard = self.league.wildcard_standings
        ...
        self.assertTrue(isinstance(wildcard, dict), 'No Wildcard Standings')
        self.assertTrue(list(wildcard.keys()) == ['Eastern', 'Western'], 'Wildcard Standings Incorrect')
