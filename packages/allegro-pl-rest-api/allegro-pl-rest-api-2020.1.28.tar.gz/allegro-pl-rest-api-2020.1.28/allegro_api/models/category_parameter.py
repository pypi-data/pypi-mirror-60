...
class CategoryParameter(object):
    ...
    discriminator_value_class_map = {
        'FloatCategoryParameter': 'FloatCategoryParameter',
        'IntegerCategoryParameter': 'IntegerCategoryParameter',
        'DictionaryCategoryParameter': 'DictionaryCategoryParameter',
        'StringCategoryParameter': 'StringCategoryParameter'
    }

    def __init__(self, id=None, name=None, type=None, required=None, unit=None, options=None, local_vars_configuration=None):  # noqa: E501
    ...
    def type(self):
        ...
        The type of the parameter. Other fields in this structure may appear based on the type of the parameter.  # noqa: E501
    ...
    def required(self):
        ...
        Indicates whether the value of this parameter must be set in an offer. Offers without required parameters set cannot be published.  # noqa: E501
