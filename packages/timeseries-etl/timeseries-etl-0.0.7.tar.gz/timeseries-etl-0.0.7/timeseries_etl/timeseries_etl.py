...
if __name__ == "__main__":
    ...
    list_of_dfs_pred = Parallel(n_jobs=num_cores)(
        delayed(ts_etl.build_df_for_item)(predictor, args.p_horizon, args.period, from_date) for predictor in inputs_pred)
    if args.target:
        list_of_dfs_targ = Parallel(n_jobs=num_cores)(
            delayed(ts_etl.build_df_for_item)(predictor, args.t_horizon, args.period, from_date) for predictor in inputs_targ)
