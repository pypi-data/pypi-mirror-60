...
class StructuralTyping(type):
    ...
    #
    #     # else:
    #     #     def the_init(self, *args, **kwargs ):
    #     #         print('the_init')
    #     #         pass
    #
    #     # ns['__init__'] = the_init
    #     x = type.__new__(mcs, name, base, ns)
    #     reg = x.__new__
    #
    #     def __new__(cls, *args, **kwargs):
    #         print('creating instance')
    #         return reg(cls, *args, **kwargs)
    #
    #     x.__new__ = __new__
    #     print(name, '\n', base, '\n', ns)
    #
    ...
    #     #     print('inside init', name, base, type(self))
    #     #     previous(self, *args, **kwargs)
    #     # x.__init__ = my_init
    #     if False:
    #         try:
    #             from zuper_ipcl.conv_caching import make_serialization_key2
    #         except:
    #             pass
    #         else:
    #             n = make_serialization_key2(x)
    #             print(f'{n} {name} {type(x)}')
    #     return x
...
def make_type_(
    ...
    orig2 = tuple(
        replace_typevars(x, bindings=new_bindings, symbols=symbols) for x in clsi.orig
    )
