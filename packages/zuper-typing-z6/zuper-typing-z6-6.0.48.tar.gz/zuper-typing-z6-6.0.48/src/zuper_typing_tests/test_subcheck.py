...
from zuper_typing.my_dict import make_list, make_set, MyBytes
...
if PYTHON_36:
    ...
    def test_subcheck_literal_02_b():
        U = make_Literal(1, 2)
        assert_not(U, List[int])


def test_corner_cases40():
    res = can_be_used_as2(int, Number)
    assert res, res


def test_corner_cases41():
    res = can_be_used_as2(Number, int)
    assert not res, res


def test_corner_cases42():
    res = can_be_used_as2(float, Number)
    assert res, res


def test_corner_cases43():
    res = can_be_used_as2(Number, float)
    assert not res, res


def test_corner_cases44():
    res = can_be_used_as2(bool, Number)
    assert res, res


def test_corner_cases45():
    res = can_be_used_as2(Number, bool)
    assert not res, res


def test_corner_cases46():
    res = can_be_used_as2(MyBytes, bytes)
    assert res, res


def test_corner_cases47():
    res = can_be_used_as2(bytes, MyBytes)
    assert not res, res
