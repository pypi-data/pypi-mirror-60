...
def create_callbacks(model, training_model, prediction_model, validation_generator, args, comet_experiment):
...
def parse_args(args):
    ...
    parser.add_argument('--save-path',    help='Path to store images during callback (defaults to \'./snapshots\')', default='./snapshots')    
