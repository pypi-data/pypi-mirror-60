...
def pa(arg1):
    ...
    if not (("---" in arg1) == True):
        ...
        print(c.Fore.RED, c.Style.BRIGHT, """
        Error 001, no text given!
        Use --- to mark text behind.""", c.Style.RESET_ALL)
        text = False
    else:
        text = True

    #search for f
    if ("f" in arg1) == True and text == True:
        #po s= position
        pos = arg1.find("f")
    ...
    if ("b" in arg1) == True and text == True:
        #pos = position
        pos = arg1.find("b")
        #poscc = positioncharactercolor
        poscc = arg1[pos + 1]
    ...
    if ("s" in arg1) == True and text == True:
        #pos = position
        pos = arg1.find("s")
