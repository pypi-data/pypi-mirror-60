# -*- coding: utf-8 -*-
#
# PyQEntangle documentation build configuration file, created by
...
project = u'PyQEntangle'
copyright = u'2016, Kwan-Yuet Ho'
...
htmlhelp_basename = 'PyQEntangledoc'
...
latex_documents = [
  (master_doc, 'PyQEntangle.tex', u'PyQEntangle Documentation',
...
man_pages = [
    (master_doc, 'pyqentangle', u'PyQEntangle Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'PyQEntangle', u'PyQEntangle Documentation',
   author, 'PyQEntangle', 'One line description of project.',
   'Miscellaneous'),
]
