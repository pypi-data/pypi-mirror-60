    ...
    def printRegMap(self, width):
        ...
        while bit > 0:
            ...
            if field:
                ...
                if contlen > 0:
                    divField = "\n<div class=\"field\" style=\"margin-right:-"+ str(((fieldlen-1) * 100)) +"%\" >\n<a data-tt data-tt-lbl=\""+tt_lbl+"\" data-tt-msg=\""+tt_msg+"\">" +field.name+ "["+str(field.bitCount -1) +":"+ str(field.bitCount - contlen)+ "]</a></div>"
                else:
                ...
                if contlen > 0:
                    divField = "<div class=\"field\" style=\"margin-right:-"+ str(((contlen-1) * 100)) +"%\" ><a data-tt data-tt-lbl=\""+tt_lbl+"\" data-tt-msg=\""+tt_msg+"\">" +field.name+"["+str(contlen -1) +":0]</a></div>"
                    ret += "\n</tr><tr><td id=\"" +self.name + "_bit_" + str(bit - (fieldlen + 1)) +"\" class=\"bit first\" >"+ divField+"</td>"
