...
def _assertions(data,yvar,xvar,intercept,backend,roll):
...
def rolling_multiple(data,yvar,xvar,roll,intercept=True,residuals=False,backend='loky'):
    ...
    residuals: bool
        Whether or not to include residuals in the output dataframe.
    ...
    _assertions(data,yvar,xvar,intercept,backend,roll)
