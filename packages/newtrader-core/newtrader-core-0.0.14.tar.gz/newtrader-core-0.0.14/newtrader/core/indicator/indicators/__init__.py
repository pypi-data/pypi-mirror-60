...
for indicator in __all__:
    module = importlib.import_module('.' + indicator, 'newtrader.core.indicator.indicators')
    if hasattr(module, 'export'):
        iClass = module.export
        setattr(sys.modules['newtrader.core.indicator'], iClass.__name__, iClass)
        classes[iClass.__name__] = iClass
