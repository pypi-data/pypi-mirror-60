...
that belong to the clubs that you are either the responsible (thus possibly created by you) or
that you have been :ref:`associated <club-users association management>` with.
