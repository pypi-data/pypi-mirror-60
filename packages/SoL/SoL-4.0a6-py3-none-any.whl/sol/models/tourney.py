...
class Tourney(GloballyUnique, Base):
    ...
    idhostingclub = Column(
        ...
        info=dict(label=N_('Hosting club ID'),
                  hint=N_('ID of the club hosting the tournament.')))
    ...
    couplings = Column(
        ...
        info=dict(label=N_(u'Pairings'),
                  ...
                  dictionary=dict(all=N_('All possible matches'),
                                  ...
                                  staggered=N_('Staggered ranking order'))))
    """Kind of pairing method used to build next round. It may be `all`, `serial`, `dazed` or
    `staggered`."""
    ...
    delaycompatriotpairing = Column(
        ...
        nullable=False,
        default=False,
        info=dict(label=N_('Delay compatriots pairing'),
                  hint=N_('Whether the system should try to postpone the pairing of players'
    ...
    def serialize(self, serializer):
        ...
        if self.idhostingclub:
            simple['hostingclub'] = serializer.addRating(self.hosting_club)
        if self.idrating:
