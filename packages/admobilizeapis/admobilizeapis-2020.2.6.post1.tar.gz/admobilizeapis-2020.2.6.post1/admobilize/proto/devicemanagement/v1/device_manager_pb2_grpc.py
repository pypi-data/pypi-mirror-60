...
class DeviceManagerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.MoveDevice = channel.unary_unary(
        '/admobilize.devicemanagement.v1.DeviceManager/MoveDevice',
        request_serializer=admobilize_dot_devicemanagement_dot_v1_dot_device__manager__pb2.MoveDeviceRequest.SerializeToString,
        response_deserializer=admobilize_dot_devicemanagement_dot_v1_dot_resources__pb2.Project.FromString,
        )
    ...
    self.VerifyDeviceToken = channel.unary_unary(
        '/admobilize.devicemanagement.v1.DeviceManager/VerifyDeviceToken',
        request_serializer=admobilize_dot_devicemanagement_dot_v1_dot_device__manager__pb2.VerifyDeviceTokenRequest.SerializeToString,
        response_deserializer=admobilize_dot_devicemanagement_dot_v1_dot_resources__pb2.Device.FromString,
        )
...
def add_DeviceManagerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'MoveDevice': grpc.unary_unary_rpc_method_handler(
          servicer.MoveDevice,
          request_deserializer=admobilize_dot_devicemanagement_dot_v1_dot_device__manager__pb2.MoveDeviceRequest.FromString,
          response_serializer=admobilize_dot_devicemanagement_dot_v1_dot_resources__pb2.Project.SerializeToString,
      ),
      ...
      'VerifyDeviceToken': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=admobilize_dot_devicemanagement_dot_v1_dot_device__manager__pb2.VerifyDeviceTokenRequest.FromString,
          response_serializer=admobilize_dot_devicemanagement_dot_v1_dot_resources__pb2.Device.SerializeToString,
      ),
  }
