...
using ka_unit = typename frc::ElevatorFeedforward<Distance>::ka_unit;
    ...
    py::class_<frc::ElevatorFeedforward<Distance>, std::shared_ptr<frc::ElevatorFeedforward<Distance>>>
    ...
    cls_ElevatorFeedforward
      ...
      py::arg("kS"), py::arg("kG"), py::arg("kV"), py::arg("kA")=units::unit_t<ka_unit> ( 0 ), release_gil(),
      ...
      py::arg("velocity"), py::arg("acceleration")=units::unit_t<Acceleration> ( 0 ), release_gil(),
      ...
      py::arg("maxVoltage"), py::arg("acceleration"), release_gil(),
      ...
      py::arg("maxVoltage"), py::arg("velocity"), release_gil(),
