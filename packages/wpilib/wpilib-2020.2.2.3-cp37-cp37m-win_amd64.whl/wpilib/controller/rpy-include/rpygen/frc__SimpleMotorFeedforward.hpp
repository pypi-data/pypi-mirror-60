...
using ka_unit = typename frc::SimpleMotorFeedforward<Distance>::ka_unit;
    ...
    py::class_<frc::SimpleMotorFeedforward<Distance>, std::shared_ptr<frc::SimpleMotorFeedforward<Distance>>>
    ...
    cls_SimpleMotorFeedforward
      ...
      py::arg("kS"), py::arg("kV"), py::arg("kA")=units::unit_t<ka_unit> ( 0 ), release_gil(),
