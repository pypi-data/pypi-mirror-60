...
class DateTimeTests(unittest.TestCase):
    ...
    def testYearsDiff(self):
        ...
        b = DateTime(2015, 1, 1)
        df = RelativeDateTimeDiff(a, b)
        self.assertEquals(df.years, -1)
        self.assertEquals(df.months, 0)
        self.assertEquals(df.days, 0)
        self.assertEquals(df.hours, 0)
        self.assertEquals(df.minutes, 0)
        self.assertEquals(df.seconds, 0)
    ...
    def testMonthsDiff(self):
        ...
        b = DateTime(2015, 2, 1)
        df = RelativeDateTimeDiff(a, b)
        self.assertEquals(df.years, 0)
        self.assertEquals(df.months, -1)
        self.assertEquals(df.days, 0)
        self.assertEquals(df.hours, 0)
        self.assertEquals(df.minutes, 0)
        self.assertEquals(df.seconds, 0)
    ...
    def testMinutesDiff(self):
        ...
        self.assertEquals(df.days, 0)
        self.assertEquals(df.hours, 0)
        self.assertEquals(df.minutes, -1)
        self.assertEquals(df.seconds, 0)
        df = RelativeDateTimeDiff(b, a)
        self.assertEquals(df.years, 0)
        self.assertEquals(df.months, 0)
    ...
    def testSecondsDiff(self):
        ...
        self.assertEquals(df.hours, 0)
        self.assertEquals(df.minutes, 0)
        self.assertEquals(df.seconds, -1)
        df = RelativeDateTimeDiff(b, a)
        self.assertEquals(df.years, 0)
        self.assertEquals(df.months, 0)
        self.assertEquals(df.days, 0)
