...
def projectileMotionEq(find=False, angleUnit="radians", printEq=False, g=scipy.constants.g, **kwargs):
    """variables: 
    ...
    try:
        kwargs["alpha0"] = radians(kwargs["alpha0"]) if angleUnit=="degrees" else kwargs["alpha0"]
    except:
        pass
    ...
    solution = solveEqs(eq, find, printEq=printEq, **kwargs)
    # if printEq:
    #     print("\n")
    #     print("Equations"), printEquations(eq), print("\n")
    #     print("Solutions"), printEquations(solution), print("\n")
...
# projectileMotionEq(find="x", g=9.81, angleUnit="degrees", printEq=True, alpha0=45, t=16)
