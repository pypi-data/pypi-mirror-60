...
requirements = ["requests>=2.10.0", "pyyaml>=3.0.0", "semantic_version>=2.5.0", "cachetools>=3.0.0"]
dev_requirements = ["boto3", "pytest", "pytest-cov", "black", "pylint", "wb-parameter-handler", "requests-mock"]
