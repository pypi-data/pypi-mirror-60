...
class VIPCipher:
    ...
    def encrypt(self, raw):
        ...
        try:
            ...
            raise (exceptions.EncryptionException("An error occured while trying to encrypt your data. See "
    ...
    def decrypt(self, enc):
        ...
        try:
            ...
            raise (
                exceptions.EncryptionException("An error occured while trying to decrypt your data. See documentation "
